...
module "journalbeat" {
  ...
  journalbeat_svc_binds     = "--bind elasticsearch:automate-ha-elasticsearch-copy.default"
...
module "metricbeat" {
  ...
  metricbeat_svc_binds      = "--bind elasticsearch:automate-ha-elasticsearch-copy.default"
...
module "kibana" {
  ...
  kibana_svc_binds          = "--bind elasticsearch:automate-ha-elasticsearch-copy.default"
  private_ips               = var.private_ips
  source                    = "../kibana"
  ssh_key_file              = var.ssh_key_file
  ssh_user                  = var.ssh_user
...
module "curator" {
  ...
  curator_svc_binds         = "--bind elasticsearch:automate-ha-elasticsearch-copy.default"
  private_ips               = var.private_ips
  source                    = "../curator"
  ssh_key_file              = var.ssh_key_file
  ssh_user                  = var.ssh_user
