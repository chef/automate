...
output "chef_server_performance_test_single_local_inplace_upgrade_ssh_port" {
  value = "${module.chef_server_performance_test_single_local_inplace_upgrade.ssh_port}"
}
