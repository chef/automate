...
def get_latest(channel, origin, name)
  ...
  pinned_hab_components = {
    "hab"          => { "origin" => "core", "name" => "hab",          "version" => "0.82.0", "release" => "20190605214032"},
    "hab-sup"      => { "origin" => "core", "name" => "hab-sup",      "version" => "0.82.0", "release" => "20190605220053"},
    "hab-launcher" => { "origin" => "core", "name" => "hab-launcher", "version" => "11300",   "release" => "20190605211433"}
  }
