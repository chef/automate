...
def get_latest(channel, origin, name)
  ...
  pinned_hab_components = {
    "hab"          => { "origin" => "core", "name" => "hab",          "version" => "0.83.0", "release" => "20190712231625"},
    "hab-sup"      => { "origin" => "core", "name" => "hab-sup",      "version" => "0.83.0", "release" => "20190712234724"},
    "hab-launcher" => { "origin" => "core", "name" => "hab-launcher", "version" => "11639",   "release" => "20190712225107"}
  }
