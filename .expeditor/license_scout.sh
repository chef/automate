...
log_section_start "Installing Go 1.18"
hab pkg install --force --binlink core/go/1.18 && rm -rf /hab/cache && mkdir -p "$GOPATH/src" "$GOPATH/bin"
go version
log "Finished Installing Go 1.18"
