...
log_section_start "Installing Go 1.18.3"
hab pkg install --force --binlink jayvikramsharma/go/1.18.3 && rm -rf /hab/cache && mkdir -p "$GOPATH/src" "$GOPATH/bin"
go version
log "Finished Installing Go 1.18.3"
