...
log_section_start "Installing Go 1.22.4"
hab pkg install --force --binlink core/go22/1.22.4 && rm -rf /hab/cache && mkdir -p "$GOPATH/src" "$GOPATH/bin"
go version
log "Finished Installing Go 1.22.4"
