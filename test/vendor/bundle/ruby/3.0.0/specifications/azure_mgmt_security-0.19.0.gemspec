# -*- encoding: utf-8 -*-
# stub: azure_mgmt_security 0.19.0 ruby lib

Gem::Specification.new do |s|
  s.name = "azure_mgmt_security".freeze
  s.version = "0.19.0"

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "bug_tracker_uri" => "https://github.com/Azure/azure-sdk-for-ruby/issues", "changelog_uri" => "https://github.com/Azure/azure-sdk-for-ruby/blob/master/ChangeLog.md", "documentation_uri" => "https://azure.microsoft.com/en-us/develop/ruby/", "homepage_uri" => "https://aka.ms/azure-sdk-for-ruby", "source_code_uri" => "https://github.com/Azure/azure-sdk-for-ruby/tree/master/management/azure_mgmt_security" } if s.respond_to? :metadata=
  s.require_paths = ["lib".freeze]
  s.authors = ["Microsoft Corporation".freeze]
  s.date = "2020-11-02"
  s.description = "Microsoft Azure Security Management Client Library for Ruby".freeze
  ...
  s.summary = "Official Ruby client library to consume Microsoft Azure Security Management services.".freeze
