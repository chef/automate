...
Note: This step is completed.
      Chef Software, Inc Organization is already present and automate repository is added under this organization.
...
#Confguring Automate with SonarCloud.
...
By default Sonarcloud quality gate is set as Sonarway. So, Sonarcloud will analyze master bracnch and PR's according to the properties set in Sonarway quality gate.
...
Sonarway is by default Quality profle, you can  extend these profiles according to your rulesets.
