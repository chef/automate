...
control 'iam-custom-access-1' do
  ...
  describe 'custom role access' do
    before(:all) do
      ...
      create_policy_resp = automate_api_request({
    ...
    describe 'team manager user' do
      ...
      it 'can get the team in their project' do
        ...
        expect(
          automate_api_request({
            endpoint: "/apis/iam/v2/teams/#{PROJECT_1_TEAM_ID}",
            user: TEAM_MANAGER
          }).http_status
        ).to eq 200
      end
      ...
      it 'cannot view a team outside their project' do
        expect(
          automate_api_request({
            endpoint: "/apis/iam/v2/teams/#{PROJECT_2_TEAM_ID}",
            user: TEAM_MANAGER
          }).http_status
