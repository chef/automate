...
func policyAuthz_v2Rego() (*asset, error) {
	...
	info := bindataFileInfo{name: "policy/authz_v2.rego", size: 2223, mode: os.FileMode(420), modTime: time.Unix(1557754702, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func policyCommonRego() (*asset, error) {
	...
	info := bindataFileInfo{name: "policy/common.rego", size: 2009, mode: os.FileMode(420), modTime: time.Unix(1557754702, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func policyIntrospection_v2Rego() (*asset, error) {
	...
	info := bindataFileInfo{name: "policy/introspection_v2.rego", size: 1590, mode: os.FileMode(420), modTime: time.Unix(1557731321, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
