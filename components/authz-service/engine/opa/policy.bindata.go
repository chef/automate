...
// policy/common.rego (2.172kB)
// policy/introspection.rego (866B)
// policy/introspection_v2.rego (1.551kB)
...
func policyAuthz_v2Rego() (*asset, error) {
	...
	info := bindataFileInfo{name: "policy/authz_v2.rego", size: 2766, mode: os.FileMode(0644), modTime: time.Unix(1557188453, 0)}
...
func policyCommonRego() (*asset, error) {
	...
	info := bindataFileInfo{name: "policy/common.rego", size: 2172, mode: os.FileMode(0644), modTime: time.Unix(1557188453, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0xbb, 0x22, 0x19, 0x54, 0x6e, 0xd7, 0x7, 0xf2, 0xd8, 0xe3, 0x37, 0x3, 0x77, 0x6f, 0x37, 0xd2, 0x3f, 0x29, 0xfc, 0xc9, 0xd6, 0x40, 0x66, 0x3e, 0xd7, 0xbf, 0xb6, 0xb8, 0x3e, 0xc9, 0xce, 0x70}}
	return a, nil
}
...
func policyIntrospection_v2Rego() (*asset, error) {
	...
	info := bindataFileInfo{name: "policy/introspection_v2.rego", size: 1551, mode: os.FileMode(0644), modTime: time.Unix(1557188453, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x59, 0xb, 0x7, 0xac, 0x79, 0x4f, 0x48, 0x76, 0xa3, 0xec, 0x70, 0x69, 0xe0, 0x74, 0x4a, 0xe1, 0x9c, 0x55, 0x61, 0xd1, 0xe5, 0xf6, 0x62, 0x44, 0xee, 0xaa, 0x6a, 0xe5, 0xfe, 0xcb, 0xa7, 0x8d}}
	return a, nil
}
