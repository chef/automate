...
const _AUTOMATE_HA_PKG_PG_LDR_CHK = "automate/ha/pgleaderchk"
const AUTOMATE_HA_PKG_PG = "automate-ha-postgresql"
const _AUTOMATE_HA_PKG_PG = "automate/ha/postgresql"
const AUTOMATE_HA_PKG_HA_PROXY = "automate-ha-haproxy"
const _AUTOMATE_HA_PKG_HA_PROXY = "automate/ha/haproxy"
const AUTOMATE_HA_PKG_JOURNALBEAT = "automate-ha-journalbeat"
const _AUTOMATE_HA_PKG_JOURNALBEAT = "automate/ha/journalbeat"
const AUTOMATE_HA_PKG_METRICBEAT = "automate-ha-metricbeat"
const _AUTOMATE_HA_PKG_METRICBEAT = "automate/ha/metricbeat"
const AUTOMATE_HA_PKG_KIBANA = "automate-ha-kibana"
const _AUTOMATE_HA_PKG_KIBANA = "automate/ha/kibana"
const AUTOMATE_HA_ES = "automate-ha-elasticsearch"
const _AUTOMATE_HA_ES = "automate/ha/elasticsearch"
const AUTOMATE_HA_ES_CAR = "automate-ha-elasticsidecar"
const _AUTOMATE_HA_ES_CAR = "automate/ha/elasticsidecar"
const AUTOMATE_HA_CURATOR = "automate-ha-curator"
const _AUTOMATE_HA_CURATOR = "automate/ha/curator"
