...
object_storage do
  ...
  {{ if .ObjectStorage.Config.GoogleServiceAccountJSON }} type "{{ .ObjectStorage.Config.GoogleServiceAccountJSON.Type }}" {{else}} # type "{{ .ObjectStorage.Config.GoogleServiceAccountJSON.Type }}"
  {{ if .ObjectStorage.Config.GoogleServiceAccountJSON }} project_id "{{ .ObjectStorage.Config.GoogleServiceAccountJSON.ProjectID }}" {{else}} # project_id "{{ .ObjectStorage.Config.GoogleServiceAccountJSON.ProjectID }}"
  {{ if .ObjectStorage.Config.GoogleServiceAccountJSON }} private_key_id "{{ .ObjectStorage.Config.GoogleServiceAccountJSON.PrivateKeyID }}" {{else}} # private_key_id "{{ .ObjectStorage.Config.GoogleServiceAccountJSON.PrivateKeyID }}"
  {{ if .ObjectStorage.Config.GoogleServiceAccountJSON }} private_key "{{ .ObjectStorage.Config.GoogleServiceAccountJSON.PrivateKey }}" {{else}} # private_key "{{ .ObjectStorage.Config.GoogleServiceAccountJSON.PrivateKey }}"
  {{ if .ObjectStorage.Config.GoogleServiceAccountJSON }} client_email "{{ .ObjectStorage.Config.GoogleServiceAccountJSON.ClientEmail }}" {{else}} # client_email "{{ .ObjectStorage.Config.GoogleServiceAccountJSON.ClientEmail }}"
  {{ if .ObjectStorage.Config.GoogleServiceAccountJSON }} client_id "{{ .ObjectStorage.Config.GoogleServiceAccountJSON.ClientID }}" {{else}} # client_id "{{ .ObjectStorage.Config.GoogleServiceAccountJSON.ClientID }}"
  {{ if .ObjectStorage.Config.GoogleServiceAccountJSON }} auth_uri "{{ .ObjectStorage.Config.GoogleServiceAccountJSON.AuthURI }}" {{else}} # auth_uri "{{ .ObjectStorage.Config.GoogleServiceAccountJSON.AuthURI }}"
  {{ if .ObjectStorage.Config.GoogleServiceAccountJSON }} token_uri "{{ .ObjectStorage.Config.GoogleServiceAccountJSON.TokenURI }}" {{else}} # token_uri "{{ .ObjectStorage.Config.GoogleServiceAccountJSON.TokenURI }}"
