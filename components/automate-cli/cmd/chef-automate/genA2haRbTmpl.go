...
aws do
  ...
  automate_root_ebs_volume_iops "{{ .Aws.Config.AutomateRootEbsVolumeIops }}"
  automate_root_ebs_volume_size "{{ .Aws.Config.AutomateRootEbsVolumeSize }}"
  automate_root_ebs_volume_type "{{ .Aws.Config.AutomateRootEbsVolumeType }}"
  ...
  chef_root_ebs_volume_iops "{{ .Aws.Config.ChefRootEbsVolumeIops }}"
  chef_root_ebs_volume_size "{{ .Aws.Config.ChefRootEbsVolumeSize }}"
  chef_root_ebs_volume_type "{{ .Aws.Config.ChefRootEbsVolumeType }}"
  ...
  opensearch_root_ebs_volume_iops "{{ .Aws.Config.OpensearchRootEbsVolumeIops }}"
  opensearch_root_ebs_volume_size "{{ .Aws.Config.OpensearchRootEbsVolumeSize }}"
  opensearch_root_ebs_volume_type "{{ .Aws.Config.OpensearchRootEbsVolumeType }}"
  ...
  postgresql_root_ebs_volume_iops "{{ .Aws.Config.PostgresqlRootEbsVolumeIops }}"
  postgresql_root_ebs_volume_size "{{ .Aws.Config.PostgresqlRootEbsVolumeSize }}"
  postgresql_root_ebs_volume_type "{{ .Aws.Config.PostgresqlRootEbsVolumeType }}"
