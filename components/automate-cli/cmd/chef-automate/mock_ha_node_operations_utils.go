...
type MockNodeUtilsImpl struct {
	...
	restartPgNodesFunc                           func(leaderNode NodeIpHealth, pgIps []IP, infra *AutomateHAInfraDetails, statusSummary StatusSummary) error
}
...
func (mnu *MockNodeUtilsImpl) restartPgNodes(leaderNode NodeIpHealth, pgIps []IP, infra *AutomateHAInfraDetails, statusSummary StatusSummary) error {
