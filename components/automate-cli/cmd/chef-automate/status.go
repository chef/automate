...
func newStatusCmd() *cobra.Command {
	...
	statusCmd.PersistentFlags().BoolVarP(&statusCmdFlag.automate, "automate", "a", false, "Shows status from Automate node(HA)")
	statusCmd.PersistentFlags().SetAnnotation("automate", docs.Compatibility, []string{docs.CompatiblewithHA})
	statusCmd.PersistentFlags().BoolVarP(&statusCmdFlag.chefServer, "chef_server", "c", false, "Shows status from Chef-server node(HA)")
	statusCmd.PersistentFlags().SetAnnotation("chef_server", docs.Compatibility, []string{docs.CompatiblewithHA})
	statusCmd.PersistentFlags().BoolVarP(&statusCmdFlag.postgresql, "postgresql", "p", false, "Shows status from PostgresQL node")
	statusCmd.PersistentFlags().SetAnnotation("postgresql", docs.Compatibility, []string{docs.CompatiblewithHA})
	statusCmd.PersistentFlags().BoolVarP(&statusCmdFlag.opensearch, "opensearch", "o", false, "Shows status from OpenSearch node")
