...
func deleteNodeHACmd() *cobra.Command {
	...
	deleteNodeHACmd.PersistentFlags().BoolVarP(&addDeleteNodeHACmdFlags.removeUnreachableNode, "remove-unreachable-node", "y", false, "remove unreachable nodes from cluster")
