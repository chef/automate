...
const (
	...
	EXTERNAL_PG_CONNECTION_RESOLUTION_MSG = "Ensure that the PostgreSQL configuration provided is correct. Review security group or firewall settings as well on the infrastructure"
