...
func TestGetS3ConnectionSuccess(t *testing.T) {
	...
	assert.Contains(t, services.ErrorMsg, "Machine is not able to connect with GCP using the provided credentials")
	assert.Equal(t, services.ResolutionMsg, "Provide the correct GCP credentials")
}
