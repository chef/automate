...
func (*ProjectUpdateStatusReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_compliance_f40b82a0a0070f9c, []int{0}
}
...
type ProjectUpdateStatusResp struct {
	...
	EstimatedTimeCompelete *timestamp.Timestamp `protobuf:"bytes,2,opt,name=estimated_time_compelete,json=estimatedTimeCompelete,proto3" json:"estimated_time_compelete,omitempty"`
...
func (*ProjectUpdateStatusResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_compliance_f40b82a0a0070f9c, []int{1}
}
...
func init() {
	proto.RegisterFile("components/compliance-service/ingest/ingest/compliance.proto", fileDescriptor_compliance_f40b82a0a0070f9c)
}

var fileDescriptor_compliance_f40b82a0a0070f9c = []byte{
	// 447 bytes of a gzipped FileDescriptorProto
	,
}
