...
func (*ProjectUpdateStatusReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_compliance_7a06d04bd0417a97, []int{0}
}
...
func (*ProjectUpdateStatusResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_compliance_7a06d04bd0417a97, []int{1}
}
...
func init() {
	proto.RegisterFile("components/compliance-service/ingest/ingest/compliance.proto", fileDescriptor_compliance_7a06d04bd0417a97)
}

var fileDescriptor_compliance_7a06d04bd0417a97 = []byte{
