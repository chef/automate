...
// internal helper method to get profile meta information for report 8
//func (backend *ES2Backend) getProfilesMissingMetadata(profileIDs []string) (*stats.ProfileSummary, error) {
//	client, err := backend.ES2Client()
//
//	if err != nil {
//		return nil, errors.Wrap(err, "getProfilesMissingMetadata, cannot connect to ElasticSearch")
//	}
//	esIndex := CompProfilesIndex
//
//	idsQuery := elastic.NewIdsQuery(mappings.DocType)
...
//	source, err := searchSource.Source()
//	if err != nil {
//		return nil, errors.Wrap(err, "getProfilesMissingMetadata unable to get Source")
//	}
//
//	LogQueryPartMin(esIndex, source, "getProfilesMissingMetadata query searchSource")
//
//	searchResult, err := client.Search().
//		SearchSource(searchSource).
//		Index(esIndex).
...
//	}
//
//	LogQueryPartMin(esIndex, searchResult, "getProfilesMissingMetadata - search results")
//
...
//	}
//
//	return nil, errorutils.ProcessNotFound(nil, profileIDs)
//}
