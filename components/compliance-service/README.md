...
We are using https://github.com/golang-migrate/migrate/v4 for migration. It happens in-code, triggered from the `dao/pgdb/db.go`. The code for the migration bits is in `lib/db/migrator`.
