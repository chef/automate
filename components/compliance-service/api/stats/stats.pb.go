...
type Stats struct {
	NodesCnt int32 `protobuf:"varint,1,opt,name=nodes_cnt,json=nodesCnt,proto3" json:"nodes_cnt,omitempty"`
	...
	Nodes                int64    `protobuf:"varint,2,opt,name=nodes,proto3" json:"nodes,omitempty"` // Deprecated: Do not use.
	Platforms            int32    `protobuf:"varint,3,opt,name=platforms,proto3" json:"platforms,omitempty"`
	Environments         int32    `protobuf:"varint,4,opt,name=environments,proto3" json:"environments,omitempty"`
	Profiles             int32    `protobuf:"varint,5,opt,name=profiles,proto3" json:"profiles,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_aba325b5e49cc7cf = []byte{
	...
	,
}
