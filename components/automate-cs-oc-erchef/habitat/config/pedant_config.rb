...
chef_server "https://localhost:10200"
...
# LB.
#
internal_server "https://localhost:10203"
...
superuser_key  '{{pkg.svc_data_path}}/pivotal.pem'
webui_key '{{pkg.svc_data_path}}/webui_priv.pem'
...
ssl_client_cert OpenSSL::X509::Certificate.new(File.read(File.join("{{pkg.svc_config_path}}", "service.crt")))
