  ...
  class ConfigGenerator
    ...
    SETTING_COMMENT = {
      ...
      aws: {
        ...
        lb_access_logs: "If lb_access logs is true then elb logs will be enabled and new s3 bucket will be created as name of lb_logs. Please find it after provision in your aws console",
        s3_bucketName_for_logs: "The name of s3 bucket to be created for moving Lb logs, by default name will be lb_logs"
