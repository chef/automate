  ...
  class ConfigGenerator
    ...
    SETTING_COMMENT = {
      ...
      aws: {
        ...
        lb_access_logs: "If lb_access logs is true then provide your s3 bucket name in next field s3_bucket_name_lb_access otherwise make it false",
        s3_bucket_name_lb_access: "If lb_access logs is true then uncomment s3_bucket_name_lb_access and provide your s3 bucket name here otherwise make it lb_access_logs false and comment s3_bucket_name_lb_access this filed",
        ...
        automate_lb_certificate_arn: "AWS Certificate is specific to the region and AWS account this is being deployed to.s3_bucket_name_lb_access",
