...
func initTables(db *gorp.DbMap) {
	...
	db.AddTableWithName(node{}, "nodes").SetKeys(false, "id")
	db.AddTableWithName(NodeTag{}, "nodes_tags")
	db.AddTableWithName(NodeSecret{}, "nodes_secrets")
	db.AddTableWithName(nodeManager{}, "node_managers").SetKeys(false, "id")
}
