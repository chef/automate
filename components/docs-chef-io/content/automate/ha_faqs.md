...
### What are different types of backup available for deployment on a GCP platform?
- Google Cloud Storage(GCS) and File System(FS) type backup are supported for deployment on GCP platform
