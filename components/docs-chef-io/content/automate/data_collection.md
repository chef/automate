...
{{< note >}} Multiple Chef Infra Servers can send data to a single Chef Automate server. This configuration is not needed if your Chef Server is installed by Automate{{< /note >}}
...
Refer [Automate HA]({{< relref "ha.md" >}})
