...
- A running [ServiceNow](https://www.servicenow.com/) instance.* A running [ServiceNow](https://www.servicenow.com/) instance. The supported ServiceNow versions are **Vancouver**, **Washington DC**, **Xanadu** and **Yokohama**.
- The ServiceNow instance is reachable on port 443.
- The ServiceNow instance should be compatible with **Vancouver**, **Washington DC**, **Xanadu** and **Yokohama** versions.
