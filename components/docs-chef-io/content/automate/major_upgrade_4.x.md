...
- **Update non-SAN certificates:** If you are planning to move 4.7.x or above and your setup is using non-SAN based public certificates, [update](/automate/upgrade_san_certificates) them with SAN certificates. This step is not applicable if you are planning to upgrade to a version 4.5.177 or below. 
