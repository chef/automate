...
- **Update non-SAN certificates:** If your setup is using non-SAN based public certificates, [update](/automate/upgrade_san_certificates) them with SAN certificates. 
