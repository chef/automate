...
The backup command stores the configuration data in timestamp-based directory and the reporting data in the `automate-elasticsearch-data` directory.
Both these directories are in the configured backup directory.
