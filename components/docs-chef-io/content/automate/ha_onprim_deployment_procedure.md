...
- If you have done certification rotation, in that case you have to run the command certificate rotation command again to rotate the certificate for the newly added node.
