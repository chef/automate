...
-   In the case of AWS-managed and Customer-managed Opensearch & PostgresQL services, `backup_config` as `file_system` is not supported. In such case, make sure to follow [On-Premise Deployment using Object Storage](/automate/ha_backup_restore_object_storage/)
