...
@Component({
  ...
  templateUrl: './reset-node-key.component.html',
  styleUrls: ['./reset-node-key.component.scss']
})

export class ResetNodeKeyComponent implements OnInit, OnDestroy {
  ...
  copyKey(newKey) {
    const copyText = newKey.firstChild.textContent;
