...
export class ApiTokenEffects {
  ...
  getToken$ = createEffect(() => {
    return this.actions$.pipe(ofType<GetToken>(ApiTokenActionTypes.GET),
  ...
  updateToken$ = createEffect(() => {
    return this.actions$.pipe(ofType<UpdateToken>(ApiTokenActionTypes.UPDATE),
  ...
  createToken$ = createEffect(() => {
    return this.actions$.pipe(ofType<CreateToken>(ApiTokenActionTypes.CREATE),
  ...
  toggleToken$ = createEffect(() => {
    return this.actions$.pipe(ofType<ToggleTokenActive>(ApiTokenActionTypes.TOGGLE),
  ...
  deleteToken$ = createEffect(() => {
    return this.actions$.pipe(ofType<DeleteToken>(ApiTokenActionTypes.DELETE),
