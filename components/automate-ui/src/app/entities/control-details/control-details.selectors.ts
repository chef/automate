...
import { ControlDetailEntityState, controlDetailEntityAdapter } from './control-details.reducer';

export const ControlDetailsState =
  createFeatureSelector<ControlDetailEntityState>('controlDetails');
export const {
