...
describe('ProfileComponent', () => {
  ...
  describe('local user', () => {
    ...
    describe('sign out link', () => {
      ...
      it('logs out', () => {
        ...
        expect(chefSessionService.logout).toHaveBeenCalledWith('/', false, true);
      });
    });
  ...
  describe('non-local user', () => {
    const nonLocalChefSessionService = new MockChefSessionService();
    nonLocalChefSessionService.isLocalUser = false;
    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [
          RouterTestingModule,
