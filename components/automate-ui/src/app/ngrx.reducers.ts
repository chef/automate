...
import * as ssoConfigEntity from './entities/sso-config/sso-config.reducer';
...
export interface NgrxStateAtom {
  ...
  sso: ssoConfigEntity.SsoConfigEntityState;
...
export const defaultInitialState = {
  ...
  ssos: ssoConfigEntity.SsoConfigEntityInitialState,
...
export const ngrxReducers = {
  ...
  ssoConfig: ssoConfigEntity.ssoConfigEntityReducer,
