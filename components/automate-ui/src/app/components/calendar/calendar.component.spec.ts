...
describe('CalendarComponent', () => {
  ...
  let calendarDateEl: DebugElement;
  ...
  describe('header', () => {
    ...
    it('displays the correct month when set via its full name', () => {
      component.month = 'March';
      fixture.detectChanges();
      expect(headerEl.nativeElement.textContent).toContain('March');
    });

    it('displays the correct month when set via its ordinal', () => {
      component.month = 3;
      fixture.detectChanges();
      expect(headerEl.nativeElement.textContent).toContain('April');
    });

    it('displays the correct month when set via its abbreviation', () => {
      component.month = 'jun';
      fixture.detectChanges();
