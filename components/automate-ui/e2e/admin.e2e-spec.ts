  ...
  describe('IAM v2', () => {
    describe('API Token list', () => {
      ...
      it('displays the returned token info', () => {
        ...
        const id = $('chef-table chef-tbody chef-tr:nth-child(1) chef-td:nth-child(2)');
        expect(id.getText()).toBe('admin-token');

        const date = $('chef-table chef-tbody chef-tr:nth-child(1) chef-td:nth-child(3)');
        expect(date.getText()).not.toBeNull();

        const status = $('chef-table chef-tbody chef-tr:nth-child(1) chef-td:nth-child(4)');
