...
const file_server_proto_rawDesc = "" +
	"\n" +
	"\fserver.proto\x12\rnotifications\x1a\x13notifications.proto\x1a\vrules.proto\x1a\fhealth.proto2\xd4\x04\n" +
	"\rNotifications\x127\n" +
	"\x06Notify\x12\x14.notifications.Event\x1a\x17.notifications.Response\x12>\n" +
	"\aAddRule\x12\x13.notifications.Rule\x1a\x1e.notifications.RuleAddResponse\x12N\n" +
	"\n" +
	"DeleteRule\x12\x1d.notifications.RuleIdentifier\x1a!.notifications.RuleDeleteResponse\x12D\n" +
	"\n" +
	"UpdateRule\x12\x13.notifications.Rule\x1a!.notifications.RuleUpdateResponse\x12H\n" +
	"\aGetRule\x12\x1d.notifications.RuleIdentifier\x1a\x1e.notifications.RuleGetResponse\x12B\n" +
	"\tListRules\x12\x14.notifications.Empty\x1a\x1f.notifications.RuleListResponse\x12\\\n" +
	"\x0fValidateWebhook\x12#.notifications.URLValidationRequest\x1a$.notifications.URLValidationResponse\x12H\n" +
	"\aVersion\x12\x1d.notifications.VersionRequest\x1a\x1e.notifications.VersionResponseB\aZ\x05.;apib\x06proto3"
