	...
	if m.ForObjectNotAvailable && objectName == "r1.json" {
		...
		if m.ForCSVExporter {
			...
			assert.Equal(m.T, []string{"Node Name", "End Time", "Platform Name", "Platform Release",
				...
				lines[0])
			assert.Equal(m.T, []string{"TestNode", "2021-11-17T10:53:52Z", "test_platform", "1.0",
			...
			assert.Equal(m.T, `[{"id":"r1","node_id":"nodeID","node_name":"TestNode","profiles":[{"name":"r1p1","title":"r1p1","full":"r1p1, v","sha256":"r1p1","controls":[{"id":"r1p1c1","title":"r1p1c1","tags":"{\"cci\":[\"CCI-000048\"],\"documentable\":false,\"gtitle\":\"TitleVal\",\"hashhash\":{\"bad.one\":[6]},\"our_criticality\":8,\"satisfies\":[\"SRG-00006\",\"SRG-00007\"],\"scope\":\"apalache\",\"stig_id\":\"RHEL-07-010050\",\"web\":null}","string_tags":{"cci":{"values":["CCI-000048"]},"gtitle":{"values":["TitleVal"]},"satisfies":{"values":["SRG-00006","SRG-00007"]},"scope":{"values":["apalache"]},"stig_id":{"values":["RHEL-07-010050"]},"web":{}},"waived_str":"no"},{"id":"r1p1c2","title":"r1p1c2","tags":"{}","waived_str":"no"}]},{"name":"r1p2","title":"r1p2","full":"r1p2, v","sha256":"r1p2","controls":[{"id":"r1p2c1","title":"r1p2c1","tags":"{}","waived_str":"no"},{"id":"r1p2c2","title":"r1p2c2","tags":"{}","waived_str":"no"}]}]},{"id":"r2","node_id":"nodeID","node_name":"TestNode","profiles":[{"name":"r2p1","title":"r2p1","full":"r2p1, v","sha256":"r2p1","controls":[{"id":"r2p1c1","title":"r2p1c1","tags":"{}","waived_str":"no"},{"id":"r2p1c2","title":"r2p1c2","tags":"{}","waived_str":"no"}]},{"name":"r2p2","title":"r2p2","full":"r2p2, v","sha256":"r2p2","controls":[{"id":"r2p2c1","title":"r2p2c1","tags":"{}","waived_str":"no"},{"id":"r2p2c2","title":"r2p2c2","tags":"{}","waived_str":"no"}]}]}]
`, string(bytes))
		}
...
func (m mockObjStore) GetObject(ctx context.Context, bucketName, objectName string, opts minio.GetObjectOptions) (io.Reader, error) {
	...
	if objectName == "r1.json" {
		if m.ForCSVExporter {
			...
			json = `{"profiles":[{"name":"r1p1","title":"r1p1","sha256":"r1p1","controls":[{"id":"r1p1c1","title":"r1p1c1","tags":{"cci":["CCI-000048"],"documentable":false,"gtitle":"TitleVal","hashhash":{"bad.one":[6]},"our_criticality":8,"satisfies":["SRG-00006","SRG-00007"],"scope":"apalache","stig_id":"RHEL-07-010050","web":null}},{"id":"r1p1c2","title":"r1p1c2"}]},{"name":"r1p2","title":"r1p2","sha256":"r1p2","controls":[{"id":"r1p2c1","title":"r1p2c1"},{"id":"r1p2c2","title":"r1p2c2"}]}],"report_uuid":"r1","node_uuid":"nodeID","node_name":"TestNode"}`
		}
...
func (m mockObjStore) GetBucketLifecycle(ctx context.Context, bucketName string) (*lifecycle.Configuration, error) {
	...
	if m.ForGetBucketLifeCycleFail {
		return nil, fmt.Errorf("error in getting the bucket lifecycle configurations")
	}
	return nil, nil
}
