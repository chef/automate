...
% Commenting out as this fails import this hrl
% -include("ssh.hrl").
...
decode_ssh_file(Pem, Password) ->
    ...
    %%% TODO Create an upstream change to OTP with this fix
    %%% Adding case here to decode a Private Key into an RSA record
