...
all_but_dialyzer_and_eunit: .concrete/DEV_MODE compile $(ALL_HOOK)
...
LOCAL_EBINS = $(wildcard apps/*/ebin)
ifeq ($(strip $(DIALYZER_DEPS)),)
dialyzer: $(BASE_PLT)
	@$(DIALYZER) $(DIALYZER_OPTS) -r $(LOCAL_EBINS)
else
dialyzer: $(BASE_PLT) $(DEPS_PLT)
	@$(DIALYZER) $(DIALYZER_OPTS) --plts $(BASE_PLT) $(DEPS_PLT) -r $(LOCAL_EBINS)
...
rel: relclean all_but_dialyzer_and_eunit $(RELX) enterprise_ctl
	@$(RELX) -c $(RELX_CONFIG) -o $(RELX_OUTPUT_DIR) $(RELX_OPTS)

lean_rel: relclean .concrete/DEV_MODE compile $(RELX) enterprise_ctl
	@$(RELX) -c $(RELX_CONFIG) -o $(RELX_OUTPUT_DIR) $(RELX_OPTS)
...
.PHONY: all all_but_dialyzer compile eunit test dialyzer clean allclean relclean distclean doc tags get-rebar enterprise_ctl rel devrel lean_rel
