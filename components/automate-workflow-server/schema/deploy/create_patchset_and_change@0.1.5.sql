...
BEGIN
  ...
  ELSE
    ...
    INSERT INTO changes(id, pipeline_id, feature_branch)
    VALUES (uuid_generate_v4(), v_pipeline_id, p_feature_branch_name)
    RETURNING changes.*
    INTO v_change;
  ...
  INSERT INTO patchsets(change_id, sequence_number, submitter_id, status, sha)
  VALUES (v_change.id, v_patchset_number, v_submitter_id, 'open', p_sha)
  RETURNING patchsets.*
  INTO v_patchset;
