...
BEGIN
  ...
  ELSE
    ...
    INSERT INTO changes(id, pipeline_id, feature_branch, latest_patchset_status, latest_patchset, submitted_by, submitted_at)
    VALUES (uuid_generate_v4(), v_pipeline_id, p_feature_branch_name, 'open', v_patchset_number, p_submitter_name, v_patchset_timestamp)
    RETURNING changes.*
    INTO v_change;
