...
require you to remake your policies if using IAM v1, as the [subjects]({{< relref "iam-v1-overview.md#structure" >}}) of those
policies will be incorrectly labeled as `ldap`.
