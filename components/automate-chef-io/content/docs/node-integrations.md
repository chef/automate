...
![Chef Automate Instance Credentials](/images/docs/instance-credentials.png)
...
![Chef Automate Create AWS-EC2 Manager No Creds](/images/docs/create-aws-ec2-mgr-no-creds.png)
...
![Chef Automate Create AWS-EC2 Scan Job](/images/docs/create-aws-ec2-scanjob.png)
...
![Chef Automate Create Azure-VM Scan Job](/images/docs/create-azure-vm-scanjob.png)
...
![Chef Automate Create Azure-API Manager](/images/docs/create-azure-vm-mgr.png)
...
![Chef Automate Create GCP-API Scan Job](/images/docs/add-gcp-api-scanjob.png)
