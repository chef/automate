...
Chef Automate supports using SAML to authenticate users and applying permissions to SAML groups, see either [IAM v1 overview]({{< relref "iam-v1-overview.md" >}}) or [IAM v2 overview]({{< relref "iam-v2-overview.md" >}}).
