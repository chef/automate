...
func TestUserOrgAssociation(t *testing.T) {
	...
	tests := []struct {
		...
		//{name: "Test members.json and admins.json are not present"},
		//{name: "Test members.json and admins.json are empty files"}
