...
func MigrationError(err error, s *migrations.MigrationServer, ctx context.Context, migrationId, serviceId string, totalSucceeded, totalSkipped, totalFailed int64) {
	s.Service.Migration.FailedMigration(ctx, migrationId, serviceId, err.Error(), totalSucceeded, totalSkipped, totalFailed)
}

func MigrationSuccess(s *migrations.MigrationServer, ctx context.Context, migrationId, serviceId string, totalSucceeded, totalSkipped, totalFailed int64) {
	s.Service.Migration.CompleteMigration(ctx, migrationId, serviceId, totalSucceeded, totalSkipped, totalFailed)
}
