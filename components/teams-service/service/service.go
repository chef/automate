...
func NewPostgresService(l logger.Logger, connFactory *secureconn.Factory, migrationsConfig migration.Config,
	...
	authzV2PoliciesClient authz_v2.PoliciesClient, authzV2AuthorizationClient authz_v2.AuthorizationClient,
	authzV2ProjectsClient authz_v2.ProjectsClient) (*Service, error) {
	...
	p, err := postgres.New(l, migrationsConfig, dataMigrationsConfig,
		resp.Version.Major == authz_v2.Version_V2, authzV2AuthorizationClient, authzV2ProjectsClient)
	if err != nil {
		return nil, err
	}
