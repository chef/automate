...
ALTER TABLE teams_users_associations ADD COLUMN team_db_id SERIAL;
ALTER TABLE teams_users_associations DROP CONSTRAINT teams_users_associations_pkey;
ALTER TABLE teams_users_associations DROP CONSTRAINT teams_users_associations_team_id_fkey;
...
ALTER TABLE teams ADD COLUMN db_id SERIAL PRIMARY KEY;

-- set the team_db_id fields in the assoc table
UPDATE teams_users_associations SET team_db_id=db_id FROM teams WHERE teams.id=team_id;
ALTER TABLE teams_users_associations DROP COLUMN team_id;
