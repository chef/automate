...
func (*PolicyInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_164305090f6cf29a, []int{0}
}
...
func init() {
	proto.RegisterFile("components/automate-grpc/protoc-gen-policy/iam/policy.proto", fileDescriptor_164305090f6cf29a)
}

var fileDescriptor_164305090f6cf29a = []byte{
