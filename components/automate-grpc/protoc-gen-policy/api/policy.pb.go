...
func (*PolicyInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_83ebe4a6476563e2, []int{0}
}
...
func init() {
	proto.RegisterFile("components/automate-grpc/protoc-gen-policy/api/policy.proto", fileDescriptor_83ebe4a6476563e2)
}

var fileDescriptor_83ebe4a6476563e2 = []byte{
