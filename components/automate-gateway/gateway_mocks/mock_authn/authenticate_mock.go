...
// Source: ../../../api/interservice/authn/authenticate.pb.go

// Package mock_authn is a generated GoMock package.
package mock_authn
...
func (m *MockAuthenticationClient) Authenticate(ctx context.Context, in *authn.AuthenticateRequest, opts ...grpc.CallOption) (*authn.AuthenticateResponse, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(*authn.AuthenticateResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Authenticate mocks base method
func (m *MockAuthenticationServer) Authenticate(arg0 context.Context, arg1 *authn.AuthenticateRequest) (*authn.AuthenticateResponse, error) {
	m.ctrl.T.Helper()
