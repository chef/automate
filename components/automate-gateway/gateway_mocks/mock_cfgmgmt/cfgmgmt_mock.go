...
// Source: ../../../api/interservice/cfgmgmt/service/cfgmgmt.pb.go

// Package mock_cfgmgmt is a generated GoMock package.
package mock_cfgmgmt
...
func (m *MockCfgMgmtClient) NodeExport(ctx context.Context, in *request.NodeExport, opts ...grpc.CallOption) (service.CfgMgmt_NodeExportClient, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(service.CfgMgmt_NodeExportClient)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// NodeExport mocks base method
func (m *MockCfgMgmtServer) NodeExport(arg0 *request.NodeExport, arg1 service.CfgMgmt_NodeExportServer) error {
	m.ctrl.T.Helper()
