...
package telemetry // import "github.com/chef/automate/components/automate-gateway/api/telemetry"
...
func (*TelemetryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_telemetry_74f56d2f730f1162, []int{0}
}
...
func (*TelemetryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_telemetry_74f56d2f730f1162, []int{1}
}
...
func init() {
	proto.RegisterFile("components/automate-gateway/api/telemetry/telemetry.proto", fileDescriptor_telemetry_74f56d2f730f1162)
}

var fileDescriptor_telemetry_74f56d2f730f1162 = []byte{
