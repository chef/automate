...
type TelemetryResponse struct {
	...
	TelemetrySourceId string `protobuf:"bytes,11,opt,name=telemetry_source_id,json=telemetrySourceId,proto3" json:"telemetry_source_id,omitempty"`
	TelemetryWriteKey string `protobuf:"bytes,12,opt,name=telemetry_write_key,json=telemetryWriteKey,proto3" json:"telemetry_write_key,omitempty"`
}
...
func (x *TelemetryResponse) GetTelemetrySourceId() string {
	if x != nil {
...
func (x *TelemetryResponse) GetTelemetryWriteKey() string {
	if x != nil {
		return x.TelemetryWriteKey
	}
	return ""
}
...
var file_automate_gateway_api_telemetry_telemetry_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x72, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x8f, 0x03, 0x0a, 0x11,
	...
	0x13, 0x74, 0x65, 0x6c, 0x65, 0x6d, 0x65, 0x74, 0x72, 0x79, 0x5f, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x5f, 0x69, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x74, 0x65, 0x6c, 0x65,
	0x6d, 0x65, 0x74, 0x72, 0x79, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x12, 0x2e, 0x0a,
	0x13, 0x74, 0x65, 0x6c, 0x65, 0x6d, 0x65, 0x74, 0x72, 0x79, 0x5f, 0x77, 0x72, 0x69, 0x74, 0x65,
	0x5f, 0x6b, 0x65, 0x79, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x74, 0x65, 0x6c, 0x65,
	0x6d, 0x65, 0x74, 0x72, 0x79, 0x57, 0x72, 0x69, 0x74, 0x65, 0x4b, 0x65, 0x79, 0x32, 0xdd, 0x01,
