...
func init() {
  ...
  "definitions": {
    ...
    "chef.automate.api.compliance.reporting.v1.LicenseUsageNodesReport": {
      "type": "object",
      "properties": {
        "id": {
          "type": "string",
        ...
        "platform": {
          ...
          "description": "The platform of the nodes making the report."
        },
        "end_time": {
          "type": "string",
          "format": "date-time",
    ...
    "chef.automate.api.compliance.reporting.v1.LicenseUsageNodesReports": {
      "type": "object",
      "properties": {
        "reports": {
          "type": "array",
          "items": {
            "$ref": "#/definitions/chef.automate.api.compliance.reporting.v1.LicenseUsageNodesReport"
          },
      ...
      "title": "LicenseUsageNodesReports used for LicenseUsageNodes call"
    },
