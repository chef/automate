...
func init() {
	policyv2.MapMethodTo("/chef.automate.api.iam.v2beta.Teams/GetTeams", "iam:teams", "iam:teams:list", "GET", "/iam/v2beta/teams", func(unexpandedResource string, input interface{}) string {
