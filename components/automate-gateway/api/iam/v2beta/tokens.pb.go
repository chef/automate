...
func init() {
	proto.RegisterFile("components/automate-gateway/api/iam/v2beta/tokens.proto", fileDescriptor_tokens_4b5fd0e04b660627)
}

var fileDescriptor_tokens_4b5fd0e04b660627 = []byte{
