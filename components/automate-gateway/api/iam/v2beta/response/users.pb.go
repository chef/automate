...
func (*CreateUserResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_users_31d8577dcab40766, []int{0}
}
...
func (*ListUsersResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_users_31d8577dcab40766, []int{1}
}
...
func (dst *ListUsersResp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListUsersResp.Merge(dst, src)
}
...
func (*DeleteUserResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_users_31d8577dcab40766, []int{2}
}
...
func (*GetUserResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_users_31d8577dcab40766, []int{3}
}
...
func (*UpdateUserResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_users_31d8577dcab40766, []int{4}
}
...
func (*UpdateSelfResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_users_31d8577dcab40766, []int{5}
}
...
func init() {
	proto.RegisterFile("components/automate-gateway/api/iam/v2beta/response/users.proto", fileDescriptor_users_31d8577dcab40766)
}

var fileDescriptor_users_31d8577dcab40766 = []byte{
