...
func init() {
	proto.RegisterFile("components/automate-gateway/api/iam/v2beta/rules.proto", fileDescriptor_rules_c2c6383af14b6b60)
}

var fileDescriptor_rules_c2c6383af14b6b60 = []byte{
