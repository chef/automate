...
func (RuleType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_rules_c278fca504bcd4f1, []int{0}
}
...
func (ConditionAttribute) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_rules_c278fca504bcd4f1, []int{1}
}
...
func (ConditionOperator) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_rules_c278fca504bcd4f1, []int{2}
}
...
func init() {
	proto.RegisterFile("components/automate-gateway/api/iam/v2beta/common/rules.proto", fileDescriptor_rules_c278fca504bcd4f1)
}

var fileDescriptor_rules_c278fca504bcd4f1 = []byte{
