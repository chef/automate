...
func init() {
	...
	policy.MapMethodTo("/chef.automate.api.iam.v2.Policies/UpgradeToV2", "system:iam:upgrade_to_v2", "upgrade", "", "", func(unexpandedResource string, input interface{}) string {
		return unexpandedResource
	})
