...
func request_Tokens_CreateToken_1(ctx context.Context, marshaler runtime.Marshaler, client TokensClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.CreateTokenReq
	var metadata runtime.ServerMetadata
...
func local_request_Tokens_CreateToken_1(ctx context.Context, marshaler runtime.Marshaler, server TokensServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.CreateTokenReq
	var metadata runtime.ServerMetadata
...
func request_Tokens_GetToken_1(ctx context.Context, marshaler runtime.Marshaler, client TokensClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.GetTokenReq
	var metadata runtime.ServerMetadata
...
func local_request_Tokens_GetToken_1(ctx context.Context, marshaler runtime.Marshaler, server TokensServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.GetTokenReq
	var metadata runtime.ServerMetadata
...
func request_Tokens_UpdateToken_1(ctx context.Context, marshaler runtime.Marshaler, client TokensClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.UpdateTokenReq
	var metadata runtime.ServerMetadata
...
func local_request_Tokens_UpdateToken_1(ctx context.Context, marshaler runtime.Marshaler, server TokensServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.UpdateTokenReq
	var metadata runtime.ServerMetadata
...
func request_Tokens_DeleteToken_1(ctx context.Context, marshaler runtime.Marshaler, client TokensClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.DeleteTokenReq
	var metadata runtime.ServerMetadata
...
func local_request_Tokens_DeleteToken_1(ctx context.Context, marshaler runtime.Marshaler, server TokensServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.DeleteTokenReq
	var metadata runtime.ServerMetadata
...
func request_Tokens_ListTokens_1(ctx context.Context, marshaler runtime.Marshaler, client TokensClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.ListTokensReq
	var metadata runtime.ServerMetadata
...
func local_request_Tokens_ListTokens_1(ctx context.Context, marshaler runtime.Marshaler, server TokensServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.ListTokensReq
	var metadata runtime.ServerMetadata
...
func RegisterTokensHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TokensServer) error {
	...
	mux.Handle("POST", pattern_Tokens_CreateToken_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_Tokens_CreateToken_1(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_Tokens_CreateToken_1(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_Tokens_GetToken_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_Tokens_GetToken_1(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_Tokens_GetToken_1(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("PUT", pattern_Tokens_UpdateToken_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_Tokens_UpdateToken_1(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_Tokens_UpdateToken_1(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("DELETE", pattern_Tokens_DeleteToken_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_Tokens_DeleteToken_1(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_Tokens_DeleteToken_1(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_Tokens_ListTokens_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_Tokens_ListTokens_1(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_Tokens_ListTokens_1(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterTokensHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TokensClient) error {
	...
	mux.Handle("POST", pattern_Tokens_CreateToken_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Tokens_CreateToken_1(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_Tokens_GetToken_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Tokens_GetToken_1(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("PUT", pattern_Tokens_UpdateToken_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Tokens_UpdateToken_1(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("DELETE", pattern_Tokens_DeleteToken_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Tokens_DeleteToken_1(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_Tokens_ListTokens_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Tokens_ListTokens_1(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Tokens_CreateToken_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"iam", "v2", "tokens"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Tokens_CreateToken_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"iam", "v2beta", "tokens"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Tokens_GetToken_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"iam", "v2", "tokens", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Tokens_GetToken_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"iam", "v2beta", "tokens", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Tokens_UpdateToken_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"iam", "v2", "tokens", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Tokens_UpdateToken_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"iam", "v2beta", "tokens", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Tokens_DeleteToken_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"iam", "v2", "tokens", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Tokens_DeleteToken_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"iam", "v2beta", "tokens", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Tokens_ListTokens_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"iam", "v2", "tokens"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Tokens_ListTokens_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"iam", "v2beta", "tokens"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_Tokens_CreateToken_0 = runtime.ForwardResponseMessage

	forward_Tokens_CreateToken_1 = runtime.ForwardResponseMessage

	forward_Tokens_GetToken_0 = runtime.ForwardResponseMessage

	forward_Tokens_GetToken_1 = runtime.ForwardResponseMessage

	forward_Tokens_UpdateToken_0 = runtime.ForwardResponseMessage

	forward_Tokens_UpdateToken_1 = runtime.ForwardResponseMessage

	forward_Tokens_DeleteToken_0 = runtime.ForwardResponseMessage

	forward_Tokens_DeleteToken_1 = runtime.ForwardResponseMessage

	forward_Tokens_ListTokens_0 = runtime.ForwardResponseMessage

	forward_Tokens_ListTokens_1 = runtime.ForwardResponseMessage
)
