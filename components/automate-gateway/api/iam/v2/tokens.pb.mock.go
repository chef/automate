...
type TokensServerMock struct {
	...
	ResetAllTokenProjectsFunc func(context.Context, *request.ResetAllTokenProjectsReq) (*response.ResetAllTokenProjectsResp, error)
}
...
func (m *TokensServerMock) ResetAllTokenProjects(ctx context.Context, req *request.ResetAllTokenProjectsReq) (*response.ResetAllTokenProjectsResp, error) {
	if msg, ok := interface{}(req).(interface{ Validate() error }); m.validateRequests && ok {
		if err := msg.Validate(); err != nil {
			return nil, status.Error(codes.InvalidArgument, err.Error())
		}
	}
	if f := m.ResetAllTokenProjectsFunc; f != nil {
		return f(ctx, req)
	}
	return nil, status.Error(codes.Internal, "mock: 'ResetAllTokenProjects' not implemented")
}
...
func (m *TokensServerMock) Reset() {
	...
	m.ResetAllTokenProjectsFunc = nil
}
