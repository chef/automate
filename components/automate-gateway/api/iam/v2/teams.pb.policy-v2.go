...
func init() {
	...
	policyv2.MapMethodTo("/chef.automate.api.iam.v2beta.Teams/ResetAllTeamProjects", "iam:teams", "iam:teams:update", "", "", func(unexpandedResource string, input interface{}) string {
		return unexpandedResource
	})
}
