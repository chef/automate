...
func init() {
	policyv2.MapMethodTo("/chef.automate.api.iam.v2.Teams/GetVersion", "system:service:version", "system:serviceVersion:get", "GET", "/iam/v2/teams_version", func(unexpandedResource string, input interface{}) string {
	...
	policyv2.MapMethodTo("/chef.automate.api.iam.v2.Teams/GetTeam", "iam:teams:{id}", "iam:teams:get", "GET", "/iam/v2/teams/{id}", func(unexpandedResource string, input interface{}) string {
	...
	policyv2.MapMethodTo("/chef.automate.api.iam.v2.Teams/UpdateTeam", "iam:teams:{id}", "iam:teams:update", "PUT", "/iam/v2/teams/{id}", func(unexpandedResource string, input interface{}) string {
	...
	policyv2.MapMethodTo("/chef.automate.api.iam.v2.Teams/DeleteTeam", "iam:teams:{id}", "iam:teams:delete", "DELETE", "/iam/v2/teams/{id}", func(unexpandedResource string, input interface{}) string {
	...
	policyv2.MapMethodTo("/chef.automate.api.iam.v2.Teams/GetTeamMembership", "iam:teams:{id}:users", "iam:teamUsers:list", "GET", "/iam/v2/teams/{id}/users", func(unexpandedResource string, input interface{}) string {
	...
	policyv2.MapMethodTo("/chef.automate.api.iam.v2.Teams/AddTeamMembers", "iam:teams:{id}", "iam:teamUsers:create", "POST", "/iam/v2/teams/{id}/users:add", func(unexpandedResource string, input interface{}) string {
	...
	policyv2.MapMethodTo("/chef.automate.api.iam.v2.Teams/RemoveTeamMembers", "iam:teams:{id}", "iam:teamUsers:delete", "POST", "/iam/v2/teams/{id}/users:remove", func(unexpandedResource string, input interface{}) string {
