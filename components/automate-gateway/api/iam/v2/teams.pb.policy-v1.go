...
func init() {
	policy.MapMethodTo("/chef.automate.api.iam.v2.Teams/GetVersion", "service_info:version", "read", "GET", "/iam/v2/teams_version", func(unexpandedResource string, input interface{}) string {
	...
	policy.MapMethodTo("/chef.automate.api.iam.v2.Teams/GetTeamsForMember", "auth:users:{id}:teams", "read", "GET", "/iam/v2/users/{id}/teams", func(unexpandedResource string, input interface{}) string {
