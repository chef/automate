...
package legacy // import "github.com/chef/automate/components/automate-gateway/api/legacy"
...
func (*StatusResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_legacy_d48d5fc8292031ab, []int{0}
}
...
func init() {
	proto.RegisterFile("components/automate-gateway/api/legacy/legacy.proto", fileDescriptor_legacy_d48d5fc8292031ab)
}

var fileDescriptor_legacy_d48d5fc8292031ab = []byte{
