...
func init() {
	proto.RegisterFile("components/automate-gateway/api/authz/authz.proto", fileDescriptor_authz_c6efe11d91ac29b5)
}

var fileDescriptor_authz_c6efe11d91ac29b5 = []byte{
