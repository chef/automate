...
package gateway // import "github.com/chef/automate/components/automate-gateway/api/gateway"
...
func (*Version) Descriptor() ([]byte, []int) {
	return fileDescriptor_gateway_9bdac50fa066a2b5, []int{0}
}
...
func (*Health) Descriptor() ([]byte, []int) {
	return fileDescriptor_gateway_9bdac50fa066a2b5, []int{1}
}
...
func init() {
	proto.RegisterFile("components/automate-gateway/api/gateway/gateway.proto", fileDescriptor_gateway_9bdac50fa066a2b5)
}

var fileDescriptor_gateway_9bdac50fa066a2b5 = []byte{
