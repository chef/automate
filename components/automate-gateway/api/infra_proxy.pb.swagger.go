...
func init() {
  ...
  "paths": {
    ...
    "/api/v0/infra/servers/{server_id}/automateinfraserverorgs": {
      "post": {
        "operationId": "InfraProxy_GetAutomateInfraServerOrgs",
        "responses": {
          "200": {
            "description": "A successful response.",
            "schema": {
              "$ref": "#/definitions/chef.automate.api.infra_proxy.response.AutomateInfraServerOrgs"
            }
          },
          "default": {
            "description": "An unexpected error response",
        ...
        "parameters": [
          ...
          },
          {
            ...
            "required": true,
            "schema": {
              "$ref": "#/definitions/chef.automate.api.infra_proxy.request.AutomateInfraServerOrgs"
            }
          }
        ],
        "tags": [
  ...
  "definitions": {
    "chef.automate.api.infra_proxy.request.AutomateInfraServerOrgs": {
      "type": "object",
      "properties": {
        "server_id": {
          "type": "string",
        ...
        "webui_key": {
          "type": "string",
          "title": "Automate Infra Server Web UI key"
        }
      }
    },
    ...
    "chef.automate.api.infra_proxy.response.AutomateInfraServerOrg": {
      "type": "object",
      "properties": {
        "id": {
          "type": "string",
    ...
    "chef.automate.api.infra_proxy.response.AutomateInfraServerOrgs": {
      "type": "object",
      "properties": {
        "orgs": {
          "type": "array",
          "items": {
            "$ref": "#/definitions/chef.automate.api.infra_proxy.response.AutomateInfraServerOrg"
          },
