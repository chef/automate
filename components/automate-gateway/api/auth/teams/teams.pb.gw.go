...
import (
	...
	"github.com/chef/automate/components/automate-gateway/api/auth/teams/request"
...
func local_request_Teams_GetTeams_0(ctx context.Context, marshaler runtime.Marshaler, server TeamsServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.GetTeamsReq
	var metadata runtime.ServerMetadata
...
func request_Teams_GetUsers_0(ctx context.Context, marshaler runtime.Marshaler, client TeamsClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Teams_GetUsers_0(ctx context.Context, marshaler runtime.Marshaler, server TeamsServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.GetUsersReq
	var metadata runtime.ServerMetadata
...
func request_Teams_AddUsers_0(ctx context.Context, marshaler runtime.Marshaler, client TeamsClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.AddUsersReq
	var metadata runtime.ServerMetadata
...
func local_request_Teams_AddUsers_0(ctx context.Context, marshaler runtime.Marshaler, server TeamsServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.AddUsersReq
	var metadata runtime.ServerMetadata
...
func request_Teams_RemoveUsers_0(ctx context.Context, marshaler runtime.Marshaler, client TeamsClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.RemoveUsersReq
	var metadata runtime.ServerMetadata
...
func local_request_Teams_RemoveUsers_0(ctx context.Context, marshaler runtime.Marshaler, server TeamsServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.RemoveUsersReq
	var metadata runtime.ServerMetadata
...
func request_Teams_GetTeamsForUser_0(ctx context.Context, marshaler runtime.Marshaler, client TeamsClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.GetTeamsForUserReq
	var metadata runtime.ServerMetadata
	...
	msg, err := client.GetTeamsForUser(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_Teams_GetTeamsForUser_0(ctx context.Context, marshaler runtime.Marshaler, server TeamsServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.GetTeamsForUserReq
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetTeamsForUser(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterTeamsHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TeamsServer, opts []grpc.DialOption) error {
	...
	mux.Handle("GET", pattern_Teams_GetTeams_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Teams_GetTeams_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_Teams_GetUsers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req)
		...
		resp, md, err := local_request_Teams_GetUsers_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_Teams_GetUsers_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_Teams_AddUsers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req)
		...
		resp, md, err := local_request_Teams_AddUsers_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_Teams_AddUsers_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("PUT", pattern_Teams_RemoveUsers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req)
		...
		resp, md, err := local_request_Teams_RemoveUsers_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_Teams_RemoveUsers_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("GET", pattern_Teams_GetTeamsForUser_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req)
		...
		resp, md, err := local_request_Teams_GetTeamsForUser_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_Teams_GetTeamsForUser_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterTeamsHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TeamsClient) error {
	...
	mux.Handle("GET", pattern_Teams_GetUsers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Teams_GetUsers_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_Teams_AddUsers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Teams_AddUsers_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("PUT", pattern_Teams_RemoveUsers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Teams_RemoveUsers_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_Teams_GetTeamsForUser_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Teams_GetTeamsForUser_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Teams_GetVersion_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"auth", "teams", "version"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Teams_GetTeams_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"auth", "teams"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Teams_GetTeam_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"auth", "teams", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Teams_CreateTeam_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"auth", "teams"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Teams_UpdateTeam_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"auth", "teams", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Teams_DeleteTeam_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"auth", "teams", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Teams_GetUsers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"auth", "teams", "id", "users"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Teams_AddUsers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"auth", "teams", "id", "users"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Teams_RemoveUsers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"auth", "teams", "id", "users"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Teams_GetTeamsForUser_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"auth", "users", "id", "teams"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	...
	forward_Teams_GetUsers_0 = runtime.ForwardResponseMessage

	forward_Teams_AddUsers_0 = runtime.ForwardResponseMessage

	forward_Teams_RemoveUsers_0 = runtime.ForwardResponseMessage

	forward_Teams_GetTeamsForUser_0 = runtime.ForwardResponseMessage
)
