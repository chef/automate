...
func init() {
  ...
  "definitions": {
    ...
    "chef.automate.api.compliance.reporting.v1.ControlItem": {
      ...
      "properties": {
        ...
        "waived_str_counts": {
          "type": "array",
          "items": {
            "$ref": "#/definitions/chef.automate.api.compliance.reporting.v1.WaivedStrCounts"
          },
        ...
        "waiver_data": {
          ...
          "title": "If the control has been waived, this returns the waived details"
        }
      }
    },
    ...
    "chef.automate.api.compliance.reporting.v1.WaivedStrCounts": {
      "type": "object",
      "properties": {
        "waived_str": {
          "type": "string"
