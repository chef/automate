...
func init() {
  ...
  "paths": {
    ...
    "/api/v0/ingest/events/chef/insert_request": {
      "post": {
        "summary": "inserting dummy values in insert_request and insert_request_details tables",
        "operationId": "ChefIngester_InsertDummy",
        "responses": {
          "200": {
            "description": "A successful response.",
            "schema": {
              "$ref": "#/definitions/chef.automate.api.ingest.response.InsertRequestResponse"
            }
          },
          "default": {
            "description": "An unexpected error response.",
        ...
        "parameters": [
          {
            ...
            "required": true,
            "schema": {
              "$ref": "#/definitions/chef.automate.api.ingest.request.InsertRequest"
            }
          }
        ],
        "tags": [
    ...
    "/api/v0/ingest/events/chef/insert_request_details": {
      "post": {
        "operationId": "ChefIngester_InsertDummyDetails",
        "responses": {
          "200": {
            "description": "A successful response.",
            "schema": {
              "$ref": "#/definitions/chef.automate.api.ingest.response.InsertRequestDetailsResponse"
            }
          },
          "default": {
            "description": "An unexpected error response.",
        ...
        "parameters": [
          {
            ...
            "required": true,
            "schema": {
              "$ref": "#/definitions/chef.automate.api.ingest.request.InsertRequestDetails"
            }
          }
        ],
        "tags": [
  ...
  "definitions": {
    ...
    "chef.automate.api.ingest.request.InsertRequest": {
      "type": "object",
      "properties": {
        "request_id": {
          "type": "integer",
    ...
    "chef.automate.api.ingest.request.InsertRequestDetails": {
      "type": "object",
      "properties": {
        "id": {
          "type": "integer",
    ...
    "chef.automate.api.ingest.response.InsertRequestDetailsResponse": {
      "type": "object"
    },
    "chef.automate.api.ingest.response.InsertRequestResponse": {
      "type": "object"
    },
