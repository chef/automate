...
package license // import "github.com/chef/automate/components/automate-gateway/api/license"
...
func (*ApplyLicenseReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_license_75cdb5cf3a574077, []int{0}
}
...
func (dst *ApplyLicenseReq) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ApplyLicenseReq.Merge(dst, src)
}
...
func (*ApplyLicenseResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_license_75cdb5cf3a574077, []int{1}
}
...
func (dst *ApplyLicenseResp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ApplyLicenseResp.Merge(dst, src)
}
...
func (*GetStatusReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_license_75cdb5cf3a574077, []int{2}
}
...
func (dst *GetStatusReq) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetStatusReq.Merge(dst, src)
}
...
func (*GetStatusResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_license_75cdb5cf3a574077, []int{3}
}
...
func (dst *GetStatusResp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetStatusResp.Merge(dst, src)
}
...
func (*GetStatusResp_DateRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_license_75cdb5cf3a574077, []int{3, 0}
}
...
func (dst *GetStatusResp_DateRange) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetStatusResp_DateRange.Merge(dst, src)
}
...
func (*RequestLicenseReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_license_75cdb5cf3a574077, []int{4}
}
...
func (dst *RequestLicenseReq) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestLicenseReq.Merge(dst, src)
}
...
func (*RequestLicenseResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_license_75cdb5cf3a574077, []int{5}
}
...
func (dst *RequestLicenseResp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestLicenseResp.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("components/automate-gateway/api/license/license.proto", fileDescriptor_license_75cdb5cf3a574077)
}

var fileDescriptor_license_75cdb5cf3a574077 = []byte{
