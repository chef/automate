...
func init() {
  ...
  "paths": {
    ...
    "/compliance/profiles/read/{owner}/{name}/version/{version}": {
      "get": {
        "summary": "Read an installed profile",
        "description": "Read the details of an installed profile given the profile name, owner (Automate user associated with the profile), and version.\n\n\nAuthorization Action:\n` + "`" + `` + "`" + `` + "`" + `\ncompliance:profiles:get\n` + "`" + `` + "`" + `` + "`" + `",
        "operationId": "Read",
        "responses": {
          "200": {
            "description": "A successful response.",
  ...
  "definitions": {
    ...
    "chef.automate.api.compliance.profiles.v1.Result": {
      ...
      "properties": {
        ...
        "code_desc": {
          "type": "string",
          "description": "The code (test) that was executed."
        },
        "run_time": {
          "type": "number",
          "format": "float",
        ...
        "skip_message": {
          "type": "string",
          "description": "Reason why the test was skipped."
        }
      }
    },
    "chef.automate.api.compliance.profiles.v1.ResultSummary": {
      ...
      "properties": {
        ...
        "location": {
          "type": "string",
          "description": "Path of the profile that was checked."
        },
        "controls": {
          "type": "integer",
          "format": "int32",
