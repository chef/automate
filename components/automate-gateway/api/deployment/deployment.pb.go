...
package deployment // import "github.com/chef/automate/components/automate-gateway/api/deployment"
...
func (*Version) Descriptor() ([]byte, []int) {
	return fileDescriptor_deployment_47077e524d31445b, []int{0}
}
...
func (*ServiceVersionsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_deployment_47077e524d31445b, []int{1}
}
...
func (*ServiceVersionsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_deployment_47077e524d31445b, []int{2}
}
...
func (*ServiceVersion) Descriptor() ([]byte, []int) {
	return fileDescriptor_deployment_47077e524d31445b, []int{3}
}
...
func init() {
	proto.RegisterFile("components/automate-gateway/api/deployment/deployment.proto", fileDescriptor_deployment_47077e524d31445b)
}

var fileDescriptor_deployment_47077e524d31445b = []byte{
