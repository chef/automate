...
pkg_version="15.10.94"
pkg_deps=(
  core/coreutils/9.7/20250627130325
  ...
  #
  core/curl/8.18.0/20260306064608
  core/ruby3_1/3.1.6/20260306111218
  # WARNING: Version pin managed by .expeditor/update_chef_server.sh
  "${vendor_origin}/chef-server-nginx/15.10.94/20260414204737"
  "${vendor_origin}/chef-server-ctl/15.10.94/20260414204128"
)
