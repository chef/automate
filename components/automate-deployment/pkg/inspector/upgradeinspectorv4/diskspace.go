...
func (ds *DiskSpaceInspection) HasExitedWithError() bool {
	return ds.exitedWithError
}

func (ds *DiskSpaceInspection) SetExitedWithError(status bool) {
...
func (ds *DiskSpaceInspection) PrintExitMessage() error {
