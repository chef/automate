...
func TestDiskSpaceInspect(t *testing.T) {
	...
	expectedBeginOSDestChecking := "┤  [Checking]\t/home/ubuntu directory should have at least 5.5GB of free space"

	expectedPassHabChecking := "✔  [Passed]\t/hab directory should have at least 5.5GB of free space"
	expectedPassOSDestChecking := "✔  [Passed]\t/home/ubuntu directory should have at least 5.5GB of free space"
...
func TestDiskSpaceInspectHabFailed(t *testing.T) {
	...
	expectedResult := `✖  [Failed]	/hab directory should have at least 10.5GB of free space
 ⊖  [Skipped]	/home/ubuntu directory should have at least 5.5GB of free space
`
	// 	expectedEnsureMsg := `
