...
func dataBindsTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/binds.txt", size: 4186, mode: os.FileMode(420), modTime: time.Unix(1560432329, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func dataServicesJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/services.json", size: 2759, mode: os.FileMode(420), modTime: time.Unix(1560432722, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
