...
func dataBindsTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/binds.txt", size: 5015, mode: os.FileMode(420), modTime: time.Unix(1579638379, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
