...
func dataBindsTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/binds.txt", size: 4988, mode: os.FileMode(420), modTime: time.Unix(1574343790, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func dataInitConfigToml() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/init-config.toml", size: 1823, mode: os.FileMode(420), modTime: time.Unix(1554971552, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
