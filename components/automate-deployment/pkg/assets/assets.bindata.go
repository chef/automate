...
func dataBindsTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/binds.txt", size: 4483, mode: os.FileMode(420), modTime: time.Unix(1567152886, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
