...
automate-cs-nginx REQUIRED automate-cs-bookshelf automate-cs-oc-erchef automate-cs-ocid automate-es-gateway
...
license-control-service REQUIRED automate-pg-gateway cereal-service pg-sidecar-service
