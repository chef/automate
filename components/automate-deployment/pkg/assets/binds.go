...
ingest-service REQUIRED authz-service automate-es-gateway automate-pg-gateway cereal-service event-feed-service event-service nodemanager-service pg-sidecar-service
