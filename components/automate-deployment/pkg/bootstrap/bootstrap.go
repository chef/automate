...
func (b *compatBootstrapper) InstallAutomateBackendDeployment(ctx context.Context, m manifest.ReleaseManifest) error {
	return b.target.InstallAutomateBackendDeployment(ctx, m)
}
