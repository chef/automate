...
// BinlinkPackage provides a mock function with given fields: _a0, _a1, a2
...
// DeployDeploymentService provides a mock function with given fields: _a0, _a1, _a2, _a3
func (_m *MockTarget) DeployDeploymentService(_a0 context.Context, _a1 *dc.ConfigRequest, _a2 manifest.ReleaseManifest, _a3 cli.BodyWriter) error {
	ret := _m.Called(_a0, _a1, _a2, _a3)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *dc.ConfigRequest, manifest.ReleaseManifest, cli.BodyWriter) error); ok {
...
func (_m *MockTarget) InstallDeploymentService(_a0 context.Context, _a1 *dc.ConfigRequest, _a2 manifest.ReleaseManifest) error {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *dc.ConfigRequest, manifest.ReleaseManifest) error); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *MockTarget) SetupSupervisor(_a0 context.Context, _a1 *dc.ConfigRequest, _a2 manifest.ReleaseManifest, _a3 cli.FormatWriter) error {
	ret := _m.Called(_a0, _a1, _a2, _a3)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *dc.ConfigRequest, manifest.ReleaseManifest, cli.FormatWriter) error); ok {
		r0 = rf(_a0, _a1, _a2, _a3)
	} else {
		r0 = ret.Error(0)
	}
