...
import api "github.com/chef/automate/api/interservice/deployment"
...
func (_m *MockEventSender) Backup(backup api.DeployEvent_Backup) {
	_m.Called(backup)
}

// Deploy provides a mock function with given fields: status
func (_m *MockEventSender) Deploy(status api.DeployEvent_Status) {
	_m.Called(status)
}

// Phase provides a mock function with given fields: status, phaseID
func (_m *MockEventSender) Phase(status api.DeployEvent_Status, phaseID api.DeployEvent_PhaseID) {
	_m.Called(status, phaseID)
}

// PhaseStep provides a mock function with given fields: status, phaseID, stepName, errStr
func (_m *MockEventSender) PhaseStep(status api.DeployEvent_Status, phaseID api.DeployEvent_PhaseID, stepName string, errStr string) {
...
func (_m *MockEventSender) StreamTo(_a0 func(*api.DeployEvent) error) error {
	ret := _m.Called(_a0)

	var r0 error
	if rf, ok := ret.Get(0).(func(func(*api.DeployEvent) error) error); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Error(0)
	}
