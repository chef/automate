...
var RootCmd = &cobra.Command{
	Use:   "user-settings-service",
	Short: "Chef Automate User Settings Service",
}
...
func init() {
	...
	// global config
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.user-settings-service.toml)")
...
func initConfig() {
	viper.SetConfigName(".user-settings-service") // name of config file (without extension)
