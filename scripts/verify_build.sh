...
for component in "${changed_components[@]}"; do
    if [[ "$component" == "components/compliance-service" || "$component" == "components/automate-es-gateway" || "$component" == "components/automate-cs-nginx" || "$component" == "components/automate-minio" || "$component" == "components/automate-builder-memcached" || "$component" == "components/automate-builder-api" || "$component" == "components/automate-builder-api-proxy" || "$component" == "components/automate-backend-opensearch" || "$component" == "components/automate-backend-elasticsidecar" || "$component" == "components/automate-opensearch" || "$component" == "components/automate-ha-pgleaderchk" ]]; then
