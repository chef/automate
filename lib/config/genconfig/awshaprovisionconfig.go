...
const (
	...
	ENDPOINT_URL                       = "^(https?://(?:[a-zA-Z0-9-]+\\.)+[a-zA-Z]{2,}|https?://(?:[0-9]{1,3}\\.){3}[0-9]{1,3}:[0-9]{1,5})$"
	ENDPOINT_URL_SAMPLE                = "http://bucket-endpoint.com or https://bucket.endpoint.com or http://35.182.23.44:9000"
