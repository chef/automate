...
func (x *License) GetGenerationDate() *timestamp.Timestamp {
	if x != nil {
...
type Entitlement struct {
	...
	Start   *timestamp.Timestamp `protobuf:"bytes,22,opt,name=start,proto3" json:"start,omitempty"`    // date the entitlement becomes active
	End     *timestamp.Timestamp `protobuf:"bytes,23,opt,name=end,proto3" json:"end,omitempty"`        // last date the entitlement is active
}
...
func (x *Entitlement) GetStart() *timestamp.Timestamp {
	if x != nil {
		return x.Start
	}
	return nil
...
func (x *Entitlement) GetEnd() *timestamp.Timestamp {
	if x != nil {
		return x.End
	}
	return nil
