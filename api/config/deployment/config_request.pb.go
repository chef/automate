...
type ConfigRequest_V1_System_Service struct {
	...
	// Deprecated: Do not use.
	ListenAddress *wrappers.StringValue `protobuf:"bytes,1,opt,name=listen_address,json=listenAddress,proto3" json:"listen_address,omitempty" toml:"listen_address,omitempty" mapstructure:"listen_address,omitempty"` // The listen host is no longer setable(localhost only)
