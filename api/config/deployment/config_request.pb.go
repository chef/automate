...
const file_config_deployment_config_request_proto_rawDesc = "" +
	"\n" +
	"&config/deployment/config_request.proto\x12\x1fchef.automate.domain.deployment\x1a\x1aconfig/shared/global.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a?automate-grpc/protoc-gen-a2-config/api/a2conf/annotations.proto\"\xca\x17\n" +
	"\rConfigRequest\x12A\n" +
	"\x02v1\x18\x03 \x01(\v21.chef.automate.domain.deployment.ConfigRequest.V1R\x02v1\x1a\xd5\x16\n" +
	"\x02V1\x12J\n" +
	"\x03sys\x18\x01 \x01(\v28.chef.automate.domain.deployment.ConfigRequest.V1.SystemR\x03sys\x12K\n" +
	"\x03svc\x18\x02 \x01(\v29.chef.automate.domain.deployment.ConfigRequest.V1.ServiceR\x03svc\x1a\xf7\b\n" +
	"\x06System\x124\n" +
	"\x04mlsa\x18\x01 \x01(\v2 .chef.automate.infra.config.MlsaR\x04mlsa\x12Z\n" +
	"\aservice\x18\x02 \x01(\v2@.chef.automate.domain.deployment.ConfigRequest.V1.System.ServiceR\aservice\x12N\n" +
	"\x03log\x18\x03 \x01(\v2<.chef.automate.domain.deployment.ConfigRequest.V1.System.LogR\x03log\x12d\n" +
	"\vgather_logs\x18\x04 \x01(\v2C.chef.automate.domain.deployment.ConfigRequest.V1.System.GatherLogsR\n" +
	"gatherLogs\x12T\n" +
	"\x05proxy\x18\x05 \x01(\v2>.chef.automate.domain.deployment.ConfigRequest.V1.System.ProxyR\x05proxy\x12W\n" +
	"\x06backup\x18\x06 \x01(\v2?.chef.automate.domain.deployment.ConfigRequest.V1.System.BackupR\x06backup\x1a\x9b\x01\n" +
	"\aService\x12G\n" +
	"\x0elisten_address\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueB\x02\x18\x01R\rlistenAddress\x12G\n" +
	"\x04port\x18\x02 \x01(\v2\x1b.google.protobuf.Int32ValueB\x16\xc2\xf3\x18\x12\n" +
	"\aservice\x10\xb0O\x1a\x04grpcR\x04port\x1a9\n" +
	"\x03Log\x122\n" +
	"\x05level\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x05level\x1aK\n" +
	"\n" +
	"GatherLogs\x12=\n" +
	"\vstaging_dir\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\n" +
	"stagingDir\x1a\x98\x01\n" +
	"\x05Proxy\x12I\n" +
	"\x11connection_string\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x10connectionString\x12D\n" +
	"\x0fno_proxy_string\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\rnoProxyString\x1a\xb4\x01\n" +
	"\x06Backup\x12j\n" +
	"\n" +
	"filesystem\x18\x01 \x01(\v2J.chef.automate.domain.deployment.ConfigRequest.V1.System.Backup.FilesystemR\n" +
	"filesystem\x1a>\n" +
	"\n" +
	"Filesystem\x120\n" +
	"\x04path\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x04path\x1a\xd8\t\n" +
	"\aService\x120\n" +
	"\x04name\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x04name\x124\n" +
	"\x06origin\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x06origin\x126\n" +
	"\achannel\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\achannel\x12G\n" +
	"\x10upgrade_strategy\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueR\x0fupgradeStrategy\x12E\n" +
	"\x0fdeployment_type\x18\x05 \x01(\v2\x1c.google.protobuf.StringValueR\x0edeploymentType\x12E\n" +
	"\x0foverride_origin\x18\x06 \x01(\v2\x1c.google.protobuf.StringValueR\x0eoverrideOrigin\x12E\n" +
	"\x0fhartifacts_path\x18\a \x01(\v2\x1c.google.protobuf.StringValueR\x0ehartifactsPath\x12Z\n" +
	"\n" +
	"admin_user\x18\b \x01(\v2;.chef.automate.domain.deployment.ConfigRequest.V1.AdminUserR\tadminUser\x12P\n" +
	"\x15manifest_cache_expiry\x18\t \x01(\v2\x1c.google.protobuf.StringValueR\x13manifestCacheExpiry\x12K\n" +
	"\x12manifest_directory\x18\n" +
	" \x01(\v2\x1c.google.protobuf.StringValueR\x11manifestDirectory\x12H\n" +
	"\x12enable_chef_server\x18\v \x01(\v2\x1a.google.protobuf.BoolValueR\x10enableChefServer\x12h\n" +
	"#enable_deployment_order_stress_mode\x18\f \x01(\v2\x1a.google.protobuf.BoolValueR\x1fenableDeploymentOrderStressMode\x12R\n" +
	"\x17feature_flag_s3_backups\x18\x80\x04 \x01(\v2\x1a.google.protobuf.BoolValueR\x14featureFlagS3Backups\x12N\n" +
	"\x14package_cleanup_mode\x18\x0e \x01(\v2\x1c.google.protobuf.StringValueR\x12packageCleanupMode\x12N\n" +
	"\x15enable_dev_monitoring\x18\x0f \x01(\v2\x1a.google.protobuf.BoolValueR\x13enableDevMonitoring\x12\x1a\n" +
	"\bproducts\x18\x10 \x03(\tR\bproducts\x12P\n" +
	"\x06health\x18\x11 \x01(\v28.chef.automate.domain.deployment.ConfigRequest.V1.HealthR\x06health\x1au\n" +
	"\x06Health\x12O\n" +
	"\x15health_check_interval\x18\x01 \x01(\v2\x1b.google.protobuf.Int32ValueR\x13healthCheckInterval\x12\x1a\n" +
	"\bservices\x18\x02 \x03(\tR\bservices\x1a\xe9\x01\n" +
	"\tAdminUser\x126\n" +
	"\x05email\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueB\x02\x18\x01R\x05email\x128\n" +
	"\busername\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\busername\x120\n" +
	"\x04name\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueR\x04name\x128\n" +
	"\bpassword\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\bpassword:\x18\xc2\xf3\x18\x14\n" +
	"\x12deployment-serviceJ\x04\b\x01\x10\x03B0Z.github.com/chef/automate/api/config/deploymentb\x06proto3"

var (
	file_config_deployment_config_request_proto_rawDescOnce sync.Once
	file_config_deployment_config_request_proto_rawDescData []byte
)
...
func file_config_deployment_config_request_proto_rawDescGZIP() []byte {
	file_config_deployment_config_request_proto_rawDescOnce.Do(func() {
		file_config_deployment_config_request_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_config_deployment_config_request_proto_rawDesc), len(file_config_deployment_config_request_proto_rawDesc)))
	})
...
var file_config_deployment_config_request_proto_goTypes = []any{
...
func file_config_deployment_config_request_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_deployment_config_request_proto_rawDesc), len(file_config_deployment_config_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   0,
