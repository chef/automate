...
const file_config_deployment_automate_config_proto_rawDesc = "" +
	"\n" +
	"'config/deployment/automate_config.proto\x12\x1fchef.automate.domain.deployment\x1a(config/applications/config_request.proto\x1a!config/authn/config_request.proto\x1a!config/authz/config_request.proto\x1a*config/backup_gateway/config_request.proto\x1a#config/bifrost/config_request.proto\x1a%config/bookshelf/config_request.proto\x1a\"config/erchef/config_request.proto\x1a!config/event/config_request.proto\x1a#config/cfgmgmt/config_request.proto\x1a&config/compliance/config_request.proto\x1a\x1aconfig/shared/global.proto\x1a$config/cs_nginx/config_request.proto\x1a&config/deployment/config_request.proto\x1a\x1fconfig/dex/config_request.proto\x1a config/ocid/config_request.proto\x1a&config/opensearch/config_request.proto\x1a%config/esgateway/config_request.proto\x1a&config/es_sidecar/config_request.proto\x1a#config/gateway/config_request.proto\x1a\"config/ingest/config_request.proto\x1a'config/infra_proxy/config_request.proto\x1a\x1fconfig/cds/config_request.proto\x1a+config/license_control/config_request.proto\x1a)config/load_balancer/config_request.proto\x1a&config/local_user/config_request.proto\x1a'config/nodemanager/config_request.proto\x1a)config/notifications/config_request.proto\x1a&config/postgresql/config_request.proto\x1a&config/pg_gateway/config_request.proto\x1a&config/pg_sidecar/config_request.proto\x1a&config/prometheus/config_request.proto\x1a#config/secrets/config_request.proto\x1a#config/session/config_request.proto\x1a!config/teams/config_request.proto\x1a\x1econfig/ui/config_request.proto\x1a)config/event_gateway/config_request.proto\x1a%config/data_feed/config_request.proto\x1a&config/event_feed/config_request.proto\x1a\"config/cereal/config_request.proto\x1a'config/builder_api/config_request.proto\x1a-config/builder_api_proxy/config_request.proto\x1a!config/minio/config_request.proto\x1a-config/builder_memcached/config_request.proto\x1a'config/sample_data/config_request.proto\x1a)config/user_settings/config_request.proto\x1a)config/elasticsearch/config_request.proto\x1a*config/report_manager/config_request.proto\"\xe2\x1c\n" +
	"\x0eAutomateConfig\x12@\n" +
	"\x06global\x18\x13 \x01(\v2(.chef.automate.infra.config.GlobalConfigR\x06global\x12@\n" +
	"\x06auth_n\x18\x01 \x01(\v2).chef.automate.domain.authn.ConfigRequestR\x05authN\x12@\n" +
	"\x06auth_z\x18\x02 \x01(\v2).chef.automate.domain.authz.ConfigRequestR\x05authZ\x12U\n" +
	"\n" +
	"compliance\x18\n" +
	" \x01(\v25.chef.automate.domain.compliance.config.ConfigRequestR\n" +
	"compliance\x12L\n" +
	"\vconfig_mgmt\x18\x06 \x01(\v2+.chef.automate.domain.cfgmgmt.ConfigRequestR\n" +
	"configMgmt\x12N\n" +
	"\n" +
	"deployment\x18\x03 \x01(\v2..chef.automate.domain.deployment.ConfigRequestR\n" +
	"deployment\x129\n" +
	"\x03dex\x18\x04 \x01(\v2'.chef.automate.domain.dex.ConfigRequestR\x03dex\x12V\n" +
	"\relasticsearch\x18\a \x01(\v20.chef.automate.infra.elasticsearch.ConfigRequestR\relasticsearch\x12J\n" +
	"\tesgateway\x18\x1f \x01(\v2,.chef.automate.infra.esgateway.ConfigRequestR\tesgateway\x12L\n" +
	"\n" +
	"es_sidecar\x18\v \x01(\v2-.chef.automate.infra.es_sidecar.ConfigRequestR\tesSidecar\x12A\n" +
	"\agateway\x18\x05 \x01(\v2'.chef.automate.api.config.ConfigRequestR\agateway\x12B\n" +
	"\x06ingest\x18\r \x01(\v2*.chef.automate.domain.ingest.ConfigRequestR\x06ingest\x12U\n" +
	"\rload_balancer\x18\b \x01(\v20.chef.automate.infra.load_balancer.ConfigRequestR\floadBalancer\x12M\n" +
	"\n" +
	"local_user\x18\f \x01(\v2..chef.automate.domain.local_user.ConfigRequestR\tlocalUser\x12\\\n" +
	"\x0flicense_control\x18\x10 \x01(\v23.chef.automate.domain.license_control.ConfigRequestR\x0elicenseControl\x12W\n" +
	"\rnotifications\x18\x0e \x01(\v21.chef.automate.domain.notifications.ConfigRequestR\rnotifications\x12M\n" +
	"\n" +
	"postgresql\x18\x0f \x01(\v2-.chef.automate.infra.postgresql.ConfigRequestR\n" +
	"postgresql\x12E\n" +
	"\asession\x18\x11 \x01(\v2+.chef.automate.domain.session.ConfigRequestR\asession\x12?\n" +
	"\x05teams\x18\x12 \x01(\v2).chef.automate.domain.teams.ConfigRequestR\x05teams\x120\n" +
	"\x03u_i\x18\t \x01(\v2\x1f.chef.automate.ui.ConfigRequestR\x02uI\x12E\n" +
	"\asecrets\x18\x15 \x01(\v2+.chef.automate.domain.secrets.ConfigRequestR\asecrets\x12X\n" +
	"\x0ebackup_gateway\x18\x1d \x01(\v21.chef.automate.infra.backup_gateway.ConfigRequestR\rbackupGateway\x12L\n" +
	"\n" +
	"pg_sidecar\x18# \x01(\v2-.chef.automate.infra.pg_sidecar.ConfigRequestR\tpgSidecar\x12L\n" +
	"\n" +
	"pg_gateway\x18\" \x01(\v2-.chef.automate.infra.pg_gateway.ConfigRequestR\tpgGateway\x12T\n" +
	"\fapplications\x18$ \x01(\v20.chef.automate.domain.applications.ConfigRequestR\fapplications\x12K\n" +
	"\tbookshelf\x18\x16 \x01(\v2-.chef.automate.domain.bookshelf.ConfigRequestR\tbookshelf\x12E\n" +
	"\abifrost\x18\x17 \x01(\v2+.chef.automate.domain.bifrost.ConfigRequestR\abifrost\x12B\n" +
	"\x06erchef\x18\x18 \x01(\v2*.chef.automate.domain.erchef.ConfigRequestR\x06erchef\x12G\n" +
	"\bcs_nginx\x18\x19 \x01(\v2,.chef.automate.domain.cs_nginx.ConfigRequestR\acsNginx\x12N\n" +
	"\revent_service\x18\x1e \x01(\v2).chef.automate.domain.event.ConfigRequestR\feventService\x12Q\n" +
	"\vnodemanager\x18! \x01(\v2/.chef.automate.domain.nodemanager.ConfigRequestR\vnodemanager\x12V\n" +
	"\revent_gateway\x18% \x01(\v21.chef.automate.domain.event_gateway.ConfigRequestR\feventGateway\x12M\n" +
	"\n" +
	"prometheus\x18  \x01(\v2-.chef.automate.infra.prometheus.ConfigRequestR\n" +
	"prometheus\x12Y\n" +
	"\x11data_feed_service\x18& \x01(\v2-.chef.automate.domain.data_feed.ConfigRequestR\x0fdataFeedService\x12\\\n" +
	"\x12event_feed_service\x18' \x01(\v2..chef.automate.domain.event_feed.ConfigRequestR\x10eventFeedService\x12A\n" +
	"\x06cereal\x18( \x01(\v2).chef.automate.infra.cereal.ConfigRequestR\x06cereal\x12P\n" +
	"\vbuilder_api\x18) \x01(\v2/.chef.automate.domain.builder_api.ConfigRequestR\n" +
	"builderApi\x12a\n" +
	"\x11builder_api_proxy\x18* \x01(\v25.chef.automate.domain.builder_api_proxy.ConfigRequestR\x0fbuilderApiProxy\x12>\n" +
	"\x05minio\x18+ \x01(\v2(.chef.automate.infra.minio.ConfigRequestR\x05minio\x12a\n" +
	"\x11builder_memcached\x18, \x01(\v24.chef.automate.infra.builder_memcached.ConfigRequestR\x10builderMemcached\x12P\n" +
	"\vinfra_proxy\x18- \x01(\v2/.chef.automate.domain.infra_proxy.ConfigRequestR\n" +
	"infraProxy\x129\n" +
	"\x03cds\x18. \x01(\v2'.chef.automate.domain.cds.ConfigRequestR\x03cds\x12P\n" +
	"\vsample_data\x18/ \x01(\v2/.chef.automate.domain.sample_data.ConfigRequestR\n" +
	"sampleData\x12V\n" +
	"\ruser_settings\x180 \x01(\v21.chef.automate.domain.user_settings.ConfigRequestR\fuserSettings\x12M\n" +
	"\n" +
	"opensearch\x181 \x01(\v2-.chef.automate.infra.opensearch.ConfigRequestR\n" +
	"opensearch\x12Y\n" +
	"\x0ereport_manager\x182 \x01(\v22.chef.automate.domain.report_manager.ConfigRequestR\rreportManager\x12<\n" +
	"\x04ocid\x183 \x01(\v2(.chef.automate.domain.ocid.ConfigRequestR\x04ocidJ\x04\b\x1a\x10\x1bJ\x04\b\x14\x10\x15B0Z.github.com/chef/automate/api/config/deploymentb\x06proto3"

var (
	file_config_deployment_automate_config_proto_rawDescOnce sync.Once
	file_config_deployment_automate_config_proto_rawDescData []byte
)
...
func file_config_deployment_automate_config_proto_rawDescGZIP() []byte {
	file_config_deployment_automate_config_proto_rawDescOnce.Do(func() {
		file_config_deployment_automate_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_config_deployment_automate_config_proto_rawDesc), len(file_config_deployment_automate_config_proto_rawDesc)))
	})
...
func file_config_deployment_automate_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_deployment_automate_config_proto_rawDesc), len(file_config_deployment_automate_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
