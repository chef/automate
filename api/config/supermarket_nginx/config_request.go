...
func DefaultConfigRequest() *ConfigRequest {
	...
	c.V1.Sys.SupermarketNginx.SqlRetryCount = w.Int32(0)
	c.V1.Sys.SupermarketNginx.SqlRetryDelay = w.Int32(10)
	c.V1.Sys.SupermarketNginx.AbandonedUploadCleanupInterval = w.Int32(1140000)
	c.V1.Sys.SupermarketNginx.DeletedDataCleanupInterval = w.Int32(420000)
	c.V1.Sys.SupermarketNginx.StreamDownload = w.Bool(true)
