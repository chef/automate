...
type ConfigRequest_V1_System_Nginx_Http struct {
	...
	EnableCspHeader                *wrappers.BoolValue   `protobuf:"bytes,29,opt,name=enable_csp_header,json=enableCspHeader,proto3" json:"enable_csp_header,omitempty" toml:"enable_csp_header,omitempty" mapstructure:"enable_csp_header,omitempty"`
	// Auto-calculated
...
func (x *ConfigRequest_V1_System_Nginx_Http) GetEnableCspHeader() *wrappers.BoolValue {
	if x != nil {
