...
const file_config_shared_global_proto_rawDesc = "" +
	"\n" +
	"\x1aconfig/shared/global.proto\x12\x1achef.automate.infra.config\x1a?automate-grpc/protoc-gen-a2-config/api/a2conf/annotations.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x17config/shared/tls.proto\"L\n" +
	"\fGlobalConfig\x12.\n" +
	"\x02v1\x18\x01 \x01(\v2\x1e.chef.automate.infra.config.V1R\x02v1:\f\xc2\xf3\x18\b\n" +
	"\x06global\"\xa4\b\n" +
	"\x02V1\x120\n" +
	"\x04fqdn\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x04fqdn\x124\n" +
	"\x04mlsa\x18\x02 \x01(\v2 .chef.automate.infra.config.MlsaR\x04mlsa\x127\n" +
	"\x05proxy\x18\x03 \x01(\v2!.chef.automate.infra.config.ProxyR\x05proxy\x12=\n" +
	"\abackups\x18\x04 \x01(\v2#.chef.automate.infra.config.BackupsR\abackups\x121\n" +
	"\x03log\x18\x05 \x01(\v2\x1f.chef.automate.infra.config.LogR\x03log\x12@\n" +
	"\bexternal\x18\x06 \x01(\v2$.chef.automate.infra.config.ExternalR\bexternal\x12T\n" +
	"\ffrontend_tls\x18\a \x03(\v21.chef.automate.infra.config.FrontendTLSCredentialR\vfrontendTls\x12F\n" +
	"\n" +
	"disclosure\x18\b \x01(\v2&.chef.automate.infra.config.DisclosureR\n" +
	"disclosure\x12:\n" +
	"\x06banner\x18\t \x01(\v2\".chef.automate.infra.config.BannerR\x06banner\x12V\n" +
	"\x10session_settings\x18\n" +
	" \x01(\v2+.chef.automate.infra.config.SessionSettingsR\x0fsessionSettings\x127\n" +
	"\x03sys\x18\v \x01(\v2%.chef.automate.infra.config.V1.SystemR\x03sys\x128\n" +
	"\x03svc\x18\f \x01(\v2&.chef.automate.infra.config.V1.ServiceR\x03svc\x12S\n" +
	"\x0flarge_reporting\x18\r \x01(\v2*.chef.automate.infra.config.LargeReportingR\x0elargeReporting\x12G\n" +
	"\vchef_server\x18\x0e \x01(\v2&.chef.automate.infra.config.ChefServerR\n" +
	"chefServer\x1a{\n" +
	"\x06System\x12<\n" +
	"\x03tls\x18\x01 \x01(\v2*.chef.automate.infra.config.TLSCredentialsR\x03tls\x123\n" +
	"\x03ngx\x18\x02 \x01(\v2!.chef.automate.infra.config.NginxR\x03ngx\x1a\t\n" +
	"\aService\"u\n" +
	"\n" +
	"ChefServer\x120\n" +
	"\x04fqdn\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x04fqdn\x125\n" +
	"\aroot_ca\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x06rootCa\"\xd5>\n" +
	"\bExternal\x12X\n" +
	"\relasticsearch\x18\x01 \x01(\v22.chef.automate.infra.config.External.ElasticsearchR\relasticsearch\x12O\n" +
	"\n" +
	"postgresql\x18\x02 \x01(\v2/.chef.automate.infra.config.External.PostgresqlR\n" +
	"postgresql\x12I\n" +
	"\bautomate\x18\x03 \x01(\v2-.chef.automate.infra.config.External.AutomateR\bautomate\x12O\n" +
	"\n" +
	"opensearch\x18\x04 \x01(\v2/.chef.automate.infra.config.External.OpensearchR\n" +
	"opensearch\x12@\n" +
	"\x05minio\x18\x05 \x01(\v2*.chef.automate.infra.config.External.MinioR\x05minio\x1a\x93\x14\n" +
	"\rElasticsearch\x122\n" +
	"\x06enable\x18\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\x06enable\x122\n" +
	"\x05nodes\x18\x02 \x03(\v2\x1c.google.protobuf.StringValueR\x05nodes\x12Q\n" +
	"\x06backup\x18\x03 \x01(\v29.chef.automate.infra.config.External.Elasticsearch.BackupR\x06backup\x12U\n" +
	"\x04auth\x18\x04 \x01(\v2A.chef.automate.infra.config.External.Elasticsearch.AuthenticationR\x04auth\x12H\n" +
	"\x03ssl\x18\x05 \x01(\v26.chef.automate.infra.config.External.Elasticsearch.SSLR\x03ssl\x1a\x88\n" +
	"\n" +
	"\x06Backup\x122\n" +
	"\x06enable\x18\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\x06enable\x128\n" +
	"\blocation\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\blocation\x12T\n" +
	"\x02fs\x18\x03 \x01(\v2D.chef.automate.infra.config.External.Elasticsearch.Backup.FsSettingsR\x02fs\x12T\n" +
	"\x02s3\x18\x04 \x01(\v2D.chef.automate.infra.config.External.Elasticsearch.Backup.S3SettingsR\x02s3\x12W\n" +
	"\x03gcs\x18\x05 \x01(\v2E.chef.automate.infra.config.External.Elasticsearch.Backup.GCSSettingsR\x03gcs\x1a\xf8\x02\n" +
	"\n" +
	"FsSettings\x120\n" +
	"\x04path\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x04path\x12q\n" +
	"\bsettings\x18\x02 \x01(\v2U.chef.automate.infra.config.External.Elasticsearch.Backup.FsSettings.OptionalSettingsR\bsettings\x1a\xc4\x01\n" +
	"\x10OptionalSettings\x12X\n" +
	"\x1amax_snapshot_bytes_per_sec\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x16maxSnapshotBytesPerSec\x12V\n" +
	"\x19max_restore_bytes_per_sec\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x15maxRestoreBytesPerSec\x1a\x85\x02\n" +
	"\n" +
	"S3Settings\x124\n" +
	...
	"\tbase_path\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\bbasePath\x12P\n" +
	"\bsettings\x18\x04 \x01(\v24.chef.automate.infra.config.Backups.S3.ElasticsearchR\bsettings\x1a\x87\x02\n" +
	"\vGCSSettings\x124\n" +
	"\x06bucket\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x06bucket\x124\n" +
	"\x06client\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x06client\x129\n" +
	"\tbase_path\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\bbasePath\x12Q\n" +
	"\bsettings\x18\x04 \x01(\v25.chef.automate.infra.config.Backups.GCS.ElasticsearchR\bsettings\x1a\xd4\x05\n" +
	"\x0eAuthentication\x124\n" +
	"\x06scheme\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x06scheme\x12j\n" +
	"\n" +
	"basic_auth\x18\x02 \x01(\v2K.chef.automate.infra.config.External.Elasticsearch.Authentication.BasicAuthR\tbasicAuth\x12m\n" +
	"\x06aws_es\x18\x03 \x01(\v2V.chef.automate.infra.config.External.Elasticsearch.Authentication.AwsElasticsearchAuthR\x05awsEs\x1a\x92\x01\n" +
	"\tBasicAuth\x128\n" +
	"\busername\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\busername\x12K\n" +
	"\bpassword\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueB\x11\xca\xf3\x18\r\n" +
	"\ves_passwordR\bpassword\x1a\x9b\x02\n" +
	"\x14AwsElasticsearchAuth\x128\n" +
	"\busername\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\busername\x12O\n" +
	"\bpassword\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueB\x15\xca\xf3\x18\x11\n" +
	"\x0faws_es_passwordR\bpassword\x12;\n" +
	"\n" +
	"access_key\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\taccessKey\x12;\n" +
	"\n" +
	"secret_key\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueR\tsecretKey\x1a\xc3\x01\n" +
	"\x03SSL\x129\n" +
	"\troot_cert\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\brootCert\x12=\n" +
	"\vserver_name\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\n" +
	"serverName\x12B\n" +
	"\x0eroot_cert_file\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\frootCertFile\x1a\xe9\x13\n" +
	"\n" +
	"Opensearch\x122\n" +
	"\x06enable\x18\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\x06enable\x122\n" +
	"\x05nodes\x18\x02 \x03(\v2\x1c.google.protobuf.StringValueR\x05nodes\x12N\n" +
	"\x06backup\x18\x03 \x01(\v26.chef.automate.infra.config.External.Opensearch.BackupR\x06backup\x12R\n" +
	"\x04auth\x18\x04 \x01(\v2>.chef.automate.infra.config.External.Opensearch.AuthenticationR\x04auth\x12E\n" +
	"\x03ssl\x18\x05 \x01(\v23.chef.automate.infra.config.External.Opensearch.SSLR\x03ssl\x1a\xf6\t\n" +
	"\x06Backup\x122\n" +
	"\x06enable\x18\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\x06enable\x128\n" +
	"\blocation\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\blocation\x12Q\n" +
	"\x02fs\x18\x03 \x01(\v2A.chef.automate.infra.config.External.Opensearch.Backup.FsSettingsR\x02fs\x12Q\n" +
	"\x02s3\x18\x04 \x01(\v2A.chef.automate.infra.config.External.Opensearch.Backup.S3SettingsR\x02s3\x12T\n" +
	"\x03gcs\x18\x05 \x01(\v2B.chef.automate.infra.config.External.Opensearch.Backup.GCSSettingsR\x03gcs\x1a\xf5\x02\n" +
	"\n" +
	"FsSettings\x120\n" +
	"\x04path\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x04path\x12n\n" +
	"\bsettings\x18\x02 \x01(\v2R.chef.automate.infra.config.External.Opensearch.Backup.FsSettings.OptionalSettingsR\bsettings\x1a\xc4\x01\n" +
	"\x10OptionalSettings\x12X\n" +
	"\x1amax_snapshot_bytes_per_sec\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x16maxSnapshotBytesPerSec\x12V\n" +
	"\x19max_restore_bytes_per_sec\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x15maxRestoreBytesPerSec\x1a\x82\x02\n" +
	"\n" +
	"S3Settings\x124\n" +
	"\x06bucket\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x06bucket\x124\n" +
	"\x06client\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x06client\x129\n" +
	"\tbase_path\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\bbasePath\x12M\n" +
	"\bsettings\x18\x04 \x01(\v21.chef.automate.infra.config.Backups.S3.OpensearchR\bsettings\x1a\x84\x02\n" +
	"\vGCSSettings\x124\n" +
	"\x06bucket\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x06bucket\x124\n" +
	"\x06client\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x06client\x129\n" +
	"\tbase_path\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\bbasePath\x12N\n" +
	"\bsettings\x18\x04 \x01(\v22.chef.automate.infra.config.Backups.GCS.OpensearchR\bsettings\x1a\xc8\x05\n" +
	"\x0eAuthentication\x124\n" +
	"\x06scheme\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x06scheme\x12g\n" +
	"\n" +
	"basic_auth\x18\x02 \x01(\v2H.chef.automate.infra.config.External.Opensearch.Authentication.BasicAuthR\tbasicAuth\x12g\n" +
	"\x06aws_os\x18\x03 \x01(\v2P.chef.automate.infra.config.External.Opensearch.Authentication.AwsOpensearchAuthR\x05awsOs\x1a\x92\x01\n" +
	"\tBasicAuth\x128\n" +
	"\busername\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\busername\x12K\n" +
	"\bpassword\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueB\x11\xca\xf3\x18\r\n" +
	"\vos_passwordR\bpassword\x1a\x98\x02\n" +
	"\x11AwsOpensearchAuth\x128\n" +
	"\busername\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\busername\x12O\n" +
	"\bpassword\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueB\x15\xca\xf3\x18\x11\n" +
	"\x0faws_os_passwordR\bpassword\x12;\n" +
	"\n" +
	"access_key\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\taccessKey\x12;\n" +
	"\n" +
	"secret_key\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueR\tsecretKey\x1a\xc3\x01\n" +
	...
	"\vserver_name\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\n" +
	"serverName\x12B\n" +
	"\x0eroot_cert_file\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\frootCertFile\x1a\x83\x04\n" +
	"\x05Minio\x128\n" +
	"\bendpoint\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\bendpoint\x129\n" +
	"\troot_user\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\brootUser\x12[\n" +
	"\rroot_password\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueB\x18\xca\xf3\x18\x14\n" +
	"\x12lcr_minio_passwordR\frootPassword\x129\n" +
	"\n" +
	...
	"\x19concurrent_minio_requests\x18\a \x01(\v2\x1b.google.protobuf.Int32ValueR\x17concurrentMinioRequests\x1a\xb0\v\n" +
	"\n" +
	"Postgresql\x122\n" +
	"\x06enable\x18\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\x06enable\x122\n" +
	"\x05nodes\x18\x02 \x03(\v2\x1c.google.protobuf.StringValueR\x05nodes\x12N\n" +
	"\x06backup\x18\x03 \x01(\v26.chef.automate.infra.config.External.Postgresql.BackupR\x06backup\x12R\n" +
	"\x04auth\x18\x04 \x01(\v2>.chef.automate.infra.config.External.Postgresql.AuthenticationR\x04auth\x12E\n" +
	"\x03ssl\x18\x05 \x01(\v23.chef.automate.infra.config.External.Postgresql.SSLR\x03ssl\x1a<\n" +
	"\x06Backup\x122\n" +
	"\x06enable\x18\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\x06enable\x1a\x81\x06\n" +
	"\x0eAuthentication\x124\n" +
	"\x06scheme\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x06scheme\x12q\n" +
	"\bpassword\x18\x02 \x01(\v2U.chef.automate.infra.config.External.Postgresql.Authentication.PasswordAuthenticationR\bpassword\x1a\xc5\x04\n" +
	"\x16PasswordAuthentication\x12}\n" +
	"\tsuperuser\x18\x01 \x01(\v2_.chef.automate.infra.config.External.Postgresql.Authentication.PasswordAuthentication.SuperUserR\tsuperuser\x12t\n" +
	"\x06dbuser\x18\x02 \x01(\v2\\.chef.automate.infra.config.External.Postgresql.Authentication.PasswordAuthentication.DBUserR\x06dbuser\x1a\x9c\x01\n" +
	"\tSuperUser\x128\n" +
	"\busername\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\busername\x12U\n" +
	"\bpassword\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueB\x1b\xca\xf3\x18\x17\n" +
	"\x15pg_superuser_passwordR\bpassword\x1a\x96\x01\n" +
	"\x06DBUser\x128\n" +
	"\busername\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\busername\x12R\n" +
	"\bpassword\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueB\x18\xca\xf3\x18\x14\n" +
	"\x12pg_dbuser_passwordR\bpassword\x1a\x8c\x02\n" +
	"\x03SSL\x124\n" +
	"\x04mode\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueB\x02\x18\x01R\x04mode\x120\n" +
	"\x04cert\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x04cert\x12.\n" +
	"\x03key\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\x03key\x129\n" +
	"\troot_cert\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueR\brootCert\x122\n" +
	"\x06enable\x18\x05 \x01(\v2\x1a.google.protobuf.BoolValueR\x06enable\x1a\x84\x04\n" +
	"\bAutomate\x122\n" +
	"\x06enable\x18\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\x06enable\x120\n" +
	"\x04node\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x04node\x12P\n" +
	"\x04auth\x18\x03 \x01(\v2<.chef.automate.infra.config.External.Automate.AuthenticationR\x04auth\x12C\n" +
	"\x03ssl\x18\x04 \x01(\v21.chef.automate.infra.config.External.Automate.SSLR\x03ssl\x1az\n" +
	"\x0eAuthentication\x124\n" +
	"\x06scheme\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x06scheme\x122\n" +
	"\x05token\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x05token\x1a\x7f\n" +
	"\x03SSL\x129\n" +
	"\troot_cert\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\brootCert\x12=\n" +
	"\vserver_name\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\n" +
	"serverName\":\n" +
	"\x04Mlsa\x122\n" +
	"\x06accept\x18\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\x06accept\"\xf1\x01\n" +
	"\x05Proxy\x120\n" +
	"\x04host\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x04host\x12/\n" +
	"\x04port\x18\x02 \x01(\v2\x1b.google.protobuf.Int32ValueR\x04port\x120\n" +
	"\x04user\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\x04user\x128\n" +
	"\bpassword\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueR\bpassword\x12\x19\n" +
	"\bno_proxy\x18\x05 \x03(\tR\anoProxy\"\xb1%\n" +
	"\aBackups\x128\n" +
	"\blocation\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\blocation\x12N\n" +
	"\n" +
	"filesystem\x18\x02 \x01(\v2..chef.automate.infra.config.Backups.FilesystemR\n" +
	"filesystem\x126\n" +
	"\x02s3\x18\x04 \x01(\v2&.chef.automate.infra.config.Backups.S3R\x02s3\x129\n" +
	"\x03gcs\x18\x05 \x01(\v2'.chef.automate.infra.config.Backups.GCSR\x03gcs\x1a\xfa\x01\n" +
	"\n" +
	"Filesystem\x120\n" +
	"\x04path\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x04path\x12]\n" +
	"\x1des_max_snapshot_bytes_per_sec\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x18esMaxSnapshotBytesPerSec\x12[\n" +
	"\x1ces_max_restore_bytes_per_sec\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\x17esMaxRestoreBytesPerSec\x1a\xac\x15\n" +
	"\x02S3\x12W\n" +
	"\vcredentials\x18\x01 \x01(\v25.chef.automate.infra.config.Backups.S3.AWSCredentialsR\vcredentials\x12D\n" +
	"\x02es\x18\x02 \x01(\v24.chef.automate.infra.config.Backups.S3.ElasticsearchR\x02es\x12E\n" +
	"\x06bucket\x18\x03 \x01(\v2-.chef.automate.infra.config.Backups.S3.BucketR\x06bucket\x12<\n" +
	"\x03ssl\x18\x04 \x01(\v2*.chef.automate.infra.config.Backups.S3.SSLR\x03ssl\x12A\n" +
	"\x02os\x18\x05 \x01(\v21.chef.automate.infra.config.Backups.S3.OpensearchR\x02os\x1a\xcd\x01\n" +
	"\x0eAWSCredentials\x12;\n" +
	"\n" +
	"access_key\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\taccessKey\x12;\n" +
	"\n" +
	"secret_key\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\tsecretKey\x12A\n" +
	"\rsession_token\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\fsessionToken\x1a\xbd\a\n" +
	"\rElasticsearch\x126\n" +
	"\bcompress\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\bcompress\x12P\n" +
	"\x16server_side_encryption\x18\x03 \x01(\v2\x1a.google.protobuf.BoolValueR\x14serverSideEncryption\x12=\n" +
	"\vbuffer_size\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueR\n" +
	"bufferSize\x12;\n" +
	"\n" +
	"canned_acl\x18\x05 \x01(\v2\x1c.google.protobuf.StringValueR\tcannedAcl\x12A\n" +
	"\rstorage_class\x18\x06 \x01(\v2\x1c.google.protobuf.StringValueR\fstorageClass\x12X\n" +
	"\x1amax_snapshot_bytes_per_sec\x18\a \x01(\v2\x1c.google.protobuf.StringValueR\x16maxSnapshotBytesPerSec\x12V\n" +
	"\x19max_restore_bytes_per_sec\x18\b \x01(\v2\x1c.google.protobuf.StringValueR\x15maxRestoreBytesPerSec\x12;\n" +
	"\n" +
	"chunk_size\x18\t \x01(\v2\x1c.google.protobuf.StringValueR\tchunkSize\x12?\n" +
	"\fread_timeout\x18\n" +
	" \x01(\v2\x1c.google.protobuf.StringValueR\vreadTimeout\x12<\n" +
	"\vmax_retries\x18\v \x01(\v2\x1b.google.protobuf.Int32ValueR\n" +
	"maxRetries\x12L\n" +
	"\x14use_throttle_retries\x18\f \x01(\v2\x1a.google.protobuf.BoolValueR\x12useThrottleRetries\x128\n" +
	"\bprotocol\x18\r \x01(\v2\x1c.google.protobuf.StringValueR\bprotocol\x124\n" +
	"\x06region\x18\x0e \x01(\v2\x1c.google.protobuf.StringValueR\x06region\x127\n" +
	"\brole_arn\x18\x0f \x01(\v2\x1c.google.protobuf.StringValueR\aroleArn\x1a\xba\a\n" +
	"\n" +
	"Opensearch\x126\n" +
	"\bcompress\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\bcompress\x12P\n" +
	"\x16server_side_encryption\x18\x03 \x01(\v2\x1a.google.protobuf.BoolValueR\x14serverSideEncryption\x12=\n" +
	...
	"\bprotocol\x18\r \x01(\v2\x1c.google.protobuf.StringValueR\bprotocol\x124\n" +
	"\x06region\x18\x0e \x01(\v2\x1c.google.protobuf.StringValueR\x06region\x127\n" +
	"\brole_arn\x18\x0f \x01(\v2\x1c.google.protobuf.StringValueR\aroleArn\x1a\xaf\x01\n" +
	"\x06Bucket\x128\n" +
	"\bendpoint\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\bendpoint\x129\n" +
	"\tbase_path\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\bbasePath\x120\n" +
	"\x04name\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\x04name\x1a@\n" +
	"\x03SSL\x129\n" +
	"\troot_cert\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\brootCert\x1a\xf6\v\n" +
	"\x03GCS\x12X\n" +
	"\vcredentials\x18\x01 \x01(\v26.chef.automate.infra.config.Backups.GCS.GCPCredentialsR\vcredentials\x12E\n" +
	"\x02es\x18\x02 \x01(\v25.chef.automate.infra.config.Backups.GCS.ElasticsearchR\x02es\x12F\n" +
	"\x06bucket\x18\x03 \x01(\v2..chef.automate.infra.config.Backups.GCS.BucketR\x06bucket\x12B\n" +
	"\x02os\x18\x04 \x01(\v22.chef.automate.infra.config.Backups.GCS.OpensearchR\x02os\x1aB\n" +
	"\x0eGCPCredentials\x120\n" +
	"\x04json\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x04json\x1a\x83\x04\n" +
	"\rElasticsearch\x126\n" +
	"\bcompress\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\bcompress\x12E\n" +
	"\x10application_name\x18\x03 \x01(\v2\x1a.google.protobuf.BoolValueR\x0fapplicationName\x12X\n" +
	"\x1amax_snapshot_bytes_per_sec\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueR\x16maxSnapshotBytesPerSec\x12V\n" +
	"\x19max_restore_bytes_per_sec\x18\x05 \x01(\v2\x1c.google.protobuf.StringValueR\x15maxRestoreBytesPerSec\x12;\n" +
	"\n" +
	"chunk_size\x18\x06 \x01(\v2\x1c.google.protobuf.StringValueR\tchunkSize\x12?\n" +
	"\fread_timeout\x18\a \x01(\v2\x1c.google.protobuf.StringValueR\vreadTimeout\x12C\n" +
	"\x0fconnect_timeout\x18\b \x01(\v2\x1a.google.protobuf.BoolValueR\x0econnectTimeout\x1a\x80\x04\n" +
	"\n" +
	"Opensearch\x126\n" +
	"\bcompress\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\bcompress\x12E\n" +
	"\x10application_name\x18\x03 \x01(\v2\x1a.google.protobuf.BoolValueR\x0fapplicationName\x12X\n" +
	...
	"chunk_size\x18\x06 \x01(\v2\x1c.google.protobuf.StringValueR\tchunkSize\x12?\n" +
	"\fread_timeout\x18\a \x01(\v2\x1c.google.protobuf.StringValueR\vreadTimeout\x12C\n" +
	"\x0fconnect_timeout\x18\b \x01(\v2\x1a.google.protobuf.BoolValueR\x0econnectTimeout\x1au\n" +
	"\x06Bucket\x129\n" +
	"\tbase_path\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\bbasePath\x120\n" +
	"\x04name\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x04nameJ\x04\b\x01\x10\x02\"\x8f\x05\n" +
	"\x03Log\x122\n" +
	"\x05level\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x05level\x124\n" +
	"\x06format\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x06format\x12D\n" +
	"\x10redirect_sys_log\x18\x03 \x01(\v2\x1a.google.protobuf.BoolValueR\x0eredirectSysLog\x12Q\n" +
	"\x16redirect_log_file_path\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueR\x13redirectLogFilePath\x12N\n" +
	"\x15compress_rotated_logs\x18\x05 \x01(\v2\x1a.google.protobuf.BoolValueR\x13compressRotatedLogs\x12M\n" +
	"\x14max_size_rotate_logs\x18\x06 \x01(\v2\x1c.google.protobuf.StringValueR\x11maxSizeRotateLogs\x12R\n" +
	"\x17max_number_rotated_logs\x18\a \x01(\v2\x1b.google.protobuf.Int32ValueR\x14maxNumberRotatedLogs\x12K\n" +
	"\x13rate_limit_interval\x18\b \x01(\v2\x1b.google.protobuf.Int32ValueR\x11rateLimitInterval\x12E\n" +
	"\x10rate_limit_burst\x18\t \x01(\v2\x1b.google.protobuf.Int32ValueR\x0erateLimitBurst\"\x86\x01\n" +
	"\n" +
	"Disclosure\x12.\n" +
	"\x04show\x18\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\x04show\x12H\n" +
	"\x11message_file_path\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x0fmessageFilePath\"\xf6\x01\n" +
	"\x06Banner\x12.\n" +
	...
	"\n" +
	"text_color\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueR\ttextColor\"\xac\x01\n" +
	"\x0fSessionSettings\x12J\n" +
	"\x13enable_idle_timeout\x18\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\x11enableIdleTimeout\x12M\n" +
	"\x14idle_timeout_minutes\x18\x02 \x01(\v2\x1b.google.protobuf.Int32ValueR\x12idleTimeoutMinutes\"b\n" +
	"\x0eLargeReporting\x12P\n" +
	"\x16enable_large_reporting\x18\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\x14enableLargeReporting\"=\n" +
	"\x05Nginx\x124\n" +
	"\x04http\x18\x01 \x01(\v2 .chef.automate.infra.config.HttpR\x04http\"\xa1\x01\n" +
	"\x04Http\x12Q\n" +
	"\x17include_x_forwarded_for\x18\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\x14includeXForwardedFor\x12F\n" +
	"\x10x_xss_protection\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x0exXssProtectionB,Z*github.com/chef/automate/api/config/sharedb\x06proto3"

var (
	file_config_shared_global_proto_rawDescOnce sync.Once
	file_config_shared_global_proto_rawDescData []byte
)

func file_config_shared_global_proto_rawDescGZIP() []byte {
	file_config_shared_global_proto_rawDescOnce.Do(func() {
		file_config_shared_global_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_config_shared_global_proto_rawDesc), len(file_config_shared_global_proto_rawDesc)))
	})
...
func file_config_shared_global_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_shared_global_proto_rawDesc), len(file_config_shared_global_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   59,
			NumExtensions: 0,
			NumServices:   0,
