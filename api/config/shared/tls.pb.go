...
func (*TLSCredentials) Descriptor() ([]byte, []int) {
	return fileDescriptor_tls_75b33c48908df56e, []int{0}
}
...
func (dst *TLSCredentials) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TLSCredentials.Merge(dst, src)
}
...
func (*FrontendTLSCredential) Descriptor() ([]byte, []int) {
	return fileDescriptor_tls_75b33c48908df56e, []int{1}
}
...
func (dst *FrontendTLSCredential) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FrontendTLSCredential.Merge(dst, src)
}
...
func init() { proto.RegisterFile("api/config/shared/tls.proto", fileDescriptor_tls_75b33c48908df56e) }

var fileDescriptor_tls_75b33c48908df56e = []byte{
