...
type ConfigRequest_V1_System_PGConfig struct {
	...
	WalKeepSegments            *wrapperspb.Int32Value  `protobuf:"bytes,5,opt,name=wal_keep_segments,json=walKeepSegments,proto3" json:"wal_keep_segments,omitempty" toml:"wal_keep_segments,omitempty" mapstructure:"wal_keep_segments,omitempty"`
...
func (x *ConfigRequest_V1_System_PGConfig) GetWalKeepSegments() *wrapperspb.Int32Value {
	if x != nil {
