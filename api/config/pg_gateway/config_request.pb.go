...
type ConfigRequest_V1_System_Resolvers struct {
	...
	Nameservers             []*wrappers.StringValue `protobuf:"bytes,1,rep,name=nameservers,proto3" json:"nameservers,omitempty" toml:"nameservers,omitempty" mapstructure:"nameservers,omitempty"`
