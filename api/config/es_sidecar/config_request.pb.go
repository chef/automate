...
type ConfigRequest_V1_System_Backups_S3Settings struct {
	...
	EnableAwsAuth *wrappers.BoolValue                                                `protobuf:"bytes,5,opt,name=enable_aws_auth,json=enableAwsAuth,proto3" json:"enable_aws_auth,omitempty" toml:"enable_aws_auth,omitempty" mapstructure:"enable_aws_auth,omitempty"`
	...
	EsUrl         *wrappers.StringValue                                              `protobuf:"bytes,7,opt,name=es_url,json=esUrl,proto3" json:"es_url,omitempty" toml:"es_url,omitempty" mapstructure:"es_url,omitempty"`
}
