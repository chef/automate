...
type ConfigRequest_V1_Disclosure struct {
	...
	DisclosureMessage *wrappers.StringValue `protobuf:"bytes,2,opt,name=disclosure_message,json=disclosureMessage,proto3" json:"disclosure_message,omitempty" toml:"disclosure_message,omitempty" mapstructure:"disclosure_message,omitempty"`
}
...
func (x *ConfigRequest_V1_Disclosure) GetShow() *wrappers.BoolValue {
	if x != nil {
		return x.Show
	}
	return nil
...
func (x *ConfigRequest_V1_Disclosure) GetDisclosureMessage() *wrappers.StringValue {
	if x != nil {
