...
type ConfigRequest_V1_System_Service struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Deprecated: Marked as deprecated in config/applications/config_request.proto.
...
const file_config_applications_config_request_proto_rawDesc = "" +
	"\n" +
	"(config/applications/config_request.proto\x12!chef.automate.domain.applications\x1a\x1aconfig/shared/global.proto\x1a\x17config/shared/tls.proto\x1a?automate-grpc/protoc-gen-a2-config/api/a2conf/annotations.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\xa7\b\n" +
	"\rConfigRequest\x12C\n" +
	"\x02v1\x18\x03 \x01(\v23.chef.automate.domain.applications.ConfigRequest.V1R\x02v1\x1a\xb4\a\n" +
	"\x02V1\x12L\n" +
	"\x03sys\x18\x01 \x01(\v2:.chef.automate.domain.applications.ConfigRequest.V1.SystemR\x03sys\x1a\xdf\x06\n" +
	"\x06System\x124\n" +
	"\x04mlsa\x18\x01 \x01(\v2 .chef.automate.infra.config.MlsaR\x04mlsa\x12\\\n" +
	"\aservice\x18\x02 \x01(\v2B.chef.automate.domain.applications.ConfigRequest.V1.System.ServiceR\aservice\x12<\n" +
	"\x03tls\x18\x03 \x01(\v2*.chef.automate.infra.config.TLSCredentialsR\x03tls\x12P\n" +
	"\x03log\x18\x04 \x01(\v2>.chef.automate.domain.applications.ConfigRequest.V1.System.LogR\x03log\x12\\\n" +
	"\astorage\x18\x05 \x01(\v2B.chef.automate.domain.applications.ConfigRequest.V1.System.StorageR\astorage\x1a\xea\x01\n" +
	"\aService\x124\n" +
	...
	"\aservice\x10\x95O\x1a\x04grpcR\x04port\x12Z\n" +
	"\fmetrics_port\x18\x03 \x01(\v2\x1b.google.protobuf.Int32ValueB\x1a\xc2\xf3\x18\x16\n" +
	"\n" +
	"prometheus\x10\xa5\x9d\x01\x1a\x04httpR\vmetricsPortJ\x04\b\x04\x10\x05\x1ao\n" +
	"\x03Log\x124\n" +
	...
	"\x04user\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x04user:\x1a\xc2\xf3\x18\x16\n" +
	"\x14applications-serviceB2Z0github.com/chef/automate/api/config/applicationsb\x06proto3"

var (
	file_config_applications_config_request_proto_rawDescOnce sync.Once
	file_config_applications_config_request_proto_rawDescData []byte
)
...
func file_config_applications_config_request_proto_rawDescGZIP() []byte {
	file_config_applications_config_request_proto_rawDescOnce.Do(func() {
		file_config_applications_config_request_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_config_applications_config_request_proto_rawDesc), len(file_config_applications_config_request_proto_rawDesc)))
	})
...
var file_config_applications_config_request_proto_goTypes = []any{
...
func file_config_applications_config_request_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_applications_config_request_proto_rawDesc), len(file_config_applications_config_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
