...
func DefaultConfigRequest() *ConfigRequest {
	...
	c.V1.Sys.SupermarkekSidekiq.SqlRetryCount = w.Int32(0)
	c.V1.Sys.SupermarketSidekiq.SqlRetryDelay = w.Int32(10)
	c.V1.Sys.SupermarketSidekiq.AbandonedUploadCleanupInterval = w.Int32(1140000)
	c.V1.Sys.SupermarketSidekiq.DeletedDataCleanupInterval = w.Int32(420000)
	c.V1.Sys.SupermarketSidekiq.StreamDownload = w.Bool(true)
