...
const file_config_event_feed_config_request_proto_rawDesc = "" +
	"\n" +
	"&config/event_feed/config_request.proto\x12\x1fchef.automate.domain.event_feed\x1a\x1aconfig/shared/global.proto\x1a\x17config/shared/tls.proto\x1a?automate-grpc/protoc-gen-a2-config/api/a2conf/annotations.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\xe7\x06\n" +
	"\rConfigRequest\x12A\n" +
	"\x02v1\x18\x01 \x01(\v21.chef.automate.domain.event_feed.ConfigRequest.V1R\x02v1\x1a\xf8\x05\n" +
	"\x02V1\x12J\n" +
	"\x03sys\x18\x01 \x01(\v28.chef.automate.domain.event_feed.ConfigRequest.V1.SystemR\x03sys\x12K\n" +
	"\x03svc\x18\x02 \x01(\v29.chef.automate.domain.event_feed.ConfigRequest.V1.ServiceR\x03svc\x1a\xcd\x04\n" +
	"\x06System\x124\n" +
	...
	"\aservice\x18\x03 \x01(\v2@.chef.automate.domain.event_feed.ConfigRequest.V1.System.ServiceR\aservice\x12N\n" +
	"\x03log\x18\x04 \x01(\v2<.chef.automate.domain.event_feed.ConfigRequest.V1.System.LogR\x03log\x1a\xe7\x01\n" +
	"\aService\x124\n" +
	...
	"\aservice\x10\x96O\x1a\x04grpcR\x04port\x12]\n" +
	"\x1bpurge_event_feed_after_days\x18\x03 \x01(\v2\x1b.google.protobuf.Int32ValueB\x02\x18\x01R\x17purgeEventFeedAfterDays\x1a9\n" +
	"\x03Log\x122\n" +
	"\x05level\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x05level\x1a\t\n" +
	"\aService:\x18\xc2\xf3\x18\x14\n" +
	"\x12event-feed-serviceB0Z.github.com/chef/automate/api/config/event_feedb\x06proto3"

var (
	file_config_event_feed_config_request_proto_rawDescOnce sync.Once
	file_config_event_feed_config_request_proto_rawDescData []byte
)
...
func file_config_event_feed_config_request_proto_rawDescGZIP() []byte {
	file_config_event_feed_config_request_proto_rawDescOnce.Do(func() {
		file_config_event_feed_config_request_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_config_event_feed_config_request_proto_rawDesc), len(file_config_event_feed_config_request_proto_rawDesc)))
	})
...
func file_config_event_feed_config_request_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_event_feed_config_request_proto_rawDesc), len(file_config_event_feed_config_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
