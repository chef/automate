...
// 	protoc        v3.12.3
// source: config/cfgmgmt/config_request.proto
...
func (x *ConfigRequest) Reset() {
	*x = ConfigRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_config_cfgmgmt_config_request_proto_msgTypes[0]
...
func (*ConfigRequest) Descriptor() ([]byte, []int) {
	return file_config_cfgmgmt_config_request_proto_rawDescGZIP(), []int{0}
}
...
func (x *ConfigRequest_V1) Reset() {
	*x = ConfigRequest_V1{}
	if protoimpl.UnsafeEnabled {
		mi := &file_config_cfgmgmt_config_request_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ConfigRequest_V1) Descriptor() ([]byte, []int) {
	return file_config_cfgmgmt_config_request_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ConfigRequest_V1_System) Reset() {
	*x = ConfigRequest_V1_System{}
	if protoimpl.UnsafeEnabled {
		mi := &file_config_cfgmgmt_config_request_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ConfigRequest_V1_System) Descriptor() ([]byte, []int) {
	return file_config_cfgmgmt_config_request_proto_rawDescGZIP(), []int{0, 0, 0}
}
...
func (x *ConfigRequest_V1_Service) Reset() {
	*x = ConfigRequest_V1_Service{}
	if protoimpl.UnsafeEnabled {
		mi := &file_config_cfgmgmt_config_request_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ConfigRequest_V1_Service) Descriptor() ([]byte, []int) {
	return file_config_cfgmgmt_config_request_proto_rawDescGZIP(), []int{0, 0, 1}
}
...
func (x *ConfigRequest_V1_System_Service) Reset() {
	*x = ConfigRequest_V1_System_Service{}
	if protoimpl.UnsafeEnabled {
		mi := &file_config_cfgmgmt_config_request_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ConfigRequest_V1_System_Service) Descriptor() ([]byte, []int) {
	return file_config_cfgmgmt_config_request_proto_rawDescGZIP(), []int{0, 0, 0, 0}
}
...
func (x *ConfigRequest_V1_System_Log) Reset() {
	*x = ConfigRequest_V1_System_Log{}
	if protoimpl.UnsafeEnabled {
		mi := &file_config_cfgmgmt_config_request_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ConfigRequest_V1_System_Log) Descriptor() ([]byte, []int) {
	return file_config_cfgmgmt_config_request_proto_rawDescGZIP(), []int{0, 0, 0, 1}
}
...
var File_config_cfgmgmt_config_request_proto protoreflect.FileDescriptor

var file_config_cfgmgmt_config_request_proto_rawDesc = []byte{
	0x0a, 0x23, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2f, 0x63, 0x66, 0x67, 0x6d, 0x67, 0x6d, 0x74,
	...
	0x67, 0x6d, 0x74, 0x1a, 0x1a, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2f, 0x73, 0x68, 0x61, 0x72,
	...
	0x65, 0x72, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb2, 0x06, 0x0a, 0x0d, 0x43, 0x6f,
	...
	0x75, 0x65, 0x73, 0x74, 0x2e, 0x56, 0x31, 0x52, 0x02, 0x76, 0x31, 0x1a, 0xbf, 0x05, 0x0a, 0x02,
	...
	0x63, 0x66, 0x67, 0x6d, 0x67, 0x6d, 0x74, 0x2e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x56, 0x31, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x52, 0x03, 0x73, 0x76, 0x63, 0x1a, 0x9a, 0x04, 0x0a, 0x06, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d,
	...
	0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x73, 0x52, 0x03, 0x74, 0x6c, 0x73, 0x12, 0x4b, 0x0a,
	0x03, 0x6c, 0x6f, 0x67, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x39, 0x2e, 0x63, 0x68, 0x65,
	0x66, 0x2e, 0x61, 0x75, 0x74, 0x6f, 0x6d, 0x61, 0x74, 0x65, 0x2e, 0x64, 0x6f, 0x6d, 0x61, 0x69,
	0x6e, 0x2e, 0x63, 0x66, 0x67, 0x6d, 0x67, 0x6d, 0x74, 0x2e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x56, 0x31, 0x2e, 0x53, 0x79, 0x73, 0x74, 0x65,
	0x6d, 0x2e, 0x4c, 0x6f, 0x67, 0x52, 0x03, 0x6c, 0x6f, 0x67, 0x1a, 0x84, 0x01, 0x0a, 0x07, 0x53,
	...
	0x63, 0x65, 0x10, 0x87, 0x4f, 0x1a, 0x04, 0x67, 0x72, 0x70, 0x63, 0x52, 0x04, 0x70, 0x6f, 0x72,
	...
	0xf3, 0x18, 0x15, 0x0a, 0x13, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2d, 0x6d, 0x67, 0x6d, 0x74,
	0x2d, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x4a, 0x04, 0x08, 0x01, 0x10, 0x03, 0x42, 0x2d,
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2f, 0x63, 0x66, 0x67, 0x6d, 0x67, 0x6d, 0x74, 0x62, 0x06, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_config_cfgmgmt_config_request_proto_rawDescOnce sync.Once
	file_config_cfgmgmt_config_request_proto_rawDescData = file_config_cfgmgmt_config_request_proto_rawDesc
)

func file_config_cfgmgmt_config_request_proto_rawDescGZIP() []byte {
	file_config_cfgmgmt_config_request_proto_rawDescOnce.Do(func() {
		file_config_cfgmgmt_config_request_proto_rawDescData = protoimpl.X.CompressGZIP(file_config_cfgmgmt_config_request_proto_rawDescData)
	})
	return file_config_cfgmgmt_config_request_proto_rawDescData
}

var file_config_cfgmgmt_config_request_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_config_cfgmgmt_config_request_proto_goTypes = []interface{}{
	(*ConfigRequest)(nil),                   // 0: chef.automate.domain.cfgmgmt.ConfigRequest
	(*ConfigRequest_V1)(nil),                // 1: chef.automate.domain.cfgmgmt.ConfigRequest.V1
	(*ConfigRequest_V1_System)(nil),         // 2: chef.automate.domain.cfgmgmt.ConfigRequest.V1.System
	(*ConfigRequest_V1_Service)(nil),        // 3: chef.automate.domain.cfgmgmt.ConfigRequest.V1.Service
	(*ConfigRequest_V1_System_Service)(nil), // 4: chef.automate.domain.cfgmgmt.ConfigRequest.V1.System.Service
	(*ConfigRequest_V1_System_Log)(nil),     // 5: chef.automate.domain.cfgmgmt.ConfigRequest.V1.System.Log
...
var file_config_cfgmgmt_config_request_proto_depIdxs = []int32{
	1,  // 0: chef.automate.domain.cfgmgmt.ConfigRequest.v1:type_name -> chef.automate.domain.cfgmgmt.ConfigRequest.V1
	2,  // 1: chef.automate.domain.cfgmgmt.ConfigRequest.V1.sys:type_name -> chef.automate.domain.cfgmgmt.ConfigRequest.V1.System
	3,  // 2: chef.automate.domain.cfgmgmt.ConfigRequest.V1.svc:type_name -> chef.automate.domain.cfgmgmt.ConfigRequest.V1.Service
	6,  // 3: chef.automate.domain.cfgmgmt.ConfigRequest.V1.System.mlsa:type_name -> chef.automate.infra.config.Mlsa
	4,  // 4: chef.automate.domain.cfgmgmt.ConfigRequest.V1.System.service:type_name -> chef.automate.domain.cfgmgmt.ConfigRequest.V1.System.Service
	7,  // 5: chef.automate.domain.cfgmgmt.ConfigRequest.V1.System.tls:type_name -> chef.automate.infra.config.TLSCredentials
	5,  // 6: chef.automate.domain.cfgmgmt.ConfigRequest.V1.System.log:type_name -> chef.automate.domain.cfgmgmt.ConfigRequest.V1.System.Log
	8,  // 7: chef.automate.domain.cfgmgmt.ConfigRequest.V1.System.Service.host:type_name -> google.protobuf.StringValue
	9,  // 8: chef.automate.domain.cfgmgmt.ConfigRequest.V1.System.Service.port:type_name -> google.protobuf.Int32Value
	8,  // 9: chef.automate.domain.cfgmgmt.ConfigRequest.V1.System.Log.format:type_name -> google.protobuf.StringValue
	8,  // 10: chef.automate.domain.cfgmgmt.ConfigRequest.V1.System.Log.level:type_name -> google.protobuf.StringValue
...
func init() { file_config_cfgmgmt_config_request_proto_init() }
func file_config_cfgmgmt_config_request_proto_init() {
	if File_config_cfgmgmt_config_request_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_config_cfgmgmt_config_request_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_config_cfgmgmt_config_request_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_config_cfgmgmt_config_request_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_config_cfgmgmt_config_request_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_config_cfgmgmt_config_request_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_config_cfgmgmt_config_request_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_config_cfgmgmt_config_request_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_config_cfgmgmt_config_request_proto_goTypes,
		DependencyIndexes: file_config_cfgmgmt_config_request_proto_depIdxs,
		MessageInfos:      file_config_cfgmgmt_config_request_proto_msgTypes,
	}.Build()
	File_config_cfgmgmt_config_request_proto = out.File
	file_config_cfgmgmt_config_request_proto_rawDesc = nil
	file_config_cfgmgmt_config_request_proto_goTypes = nil
	file_config_cfgmgmt_config_request_proto_depIdxs = nil
}
