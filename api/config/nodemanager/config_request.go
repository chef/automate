	...
	return &ConfigRequest{
		V1: &ConfigRequest_V1{
			Sys: &ConfigRequest_V1_System{
				...
				Nodemanager: &ConfigRequest_V1_System_Nodemanager{},
...
func DefaultConfigRequest() *ConfigRequest {
	...
	c.V1.Sys.Service.Port = w.Int32(10120)
	c.V1.Sys.Log.Level = w.String("info")
	c.V1.Sys.Log.Format = w.String("text")
	c.V1.Sys.Nodemanager.Awsec2PollingInterval = w.Int32(60)
	c.V1.Sys.Nodemanager.AzurevmPollingInterval = w.Int32(180)
	c.V1.Sys.Nodemanager.ManualPollingInterval = w.Int32(1440)
	c.V1.Sys.Storage.Database = w.String("nodemanager_service")
	c.V1.Sys.Storage.User = w.String("nodemanager")
	return c
}
