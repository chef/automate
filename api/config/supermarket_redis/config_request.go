...
func DefaultConfigRequest() *ConfigRequest {
	...
	c.V1.Sys.Supermarket.SqlRetryCount = w.Int32(0)
	c.V1.Sys.Supermarket.SqlRetryDelay = w.Int32(10)
	c.V1.Sys.Supermarket.AbandonedUploadCleanupInterval = w.Int32(1140000)
	c.V1.Sys.Supermarket.DeletedDataCleanupInterval = w.Int32(420000)
	c.V1.Sys.Supermarket.StreamDownload = w.Bool(true)
