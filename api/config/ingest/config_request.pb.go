...
const file_config_ingest_config_request_proto_rawDesc = "" +
	"\n" +
	"\"config/ingest/config_request.proto\x12\x1bchef.automate.domain.ingest\x1a\x1aconfig/shared/global.proto\x1a\x17config/shared/tls.proto\x1a?automate-grpc/protoc-gen-a2-config/api/a2conf/annotations.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\x86\x0e\n" +
	"\rConfigRequest\x12=\n" +
	"\x02v1\x18\x03 \x01(\v2-.chef.automate.domain.ingest.ConfigRequest.V1R\x02v1\x1a\x99\r\n" +
	"\x02V1\x12F\n" +
	"\x03sys\x18\x01 \x01(\v24.chef.automate.domain.ingest.ConfigRequest.V1.SystemR\x03sys\x12G\n" +
	"\x03svc\x18\x02 \x01(\v25.chef.automate.domain.ingest.ConfigRequest.V1.ServiceR\x03svc\x1a\xf6\v\n" +
	"\x06System\x124\n" +
	"\x04mlsa\x18\x01 \x01(\v2 .chef.automate.infra.config.MlsaR\x04mlsa\x12V\n" +
	"\aservice\x18\x02 \x01(\v2<.chef.automate.domain.ingest.ConfigRequest.V1.System.ServiceR\aservice\x12<\n" +
	"\x03tls\x18\x03 \x01(\v2*.chef.automate.infra.config.TLSCredentialsR\x03tls\x12J\n" +
	"\x03log\x18\x04 \x01(\v28.chef.automate.domain.ingest.ConfigRequest.V1.System.LogR\x03log\x1a\xe2\b\n" +
	"\aService\x124\n" +
	...
	"\aservice\x10\x8aO\x1a\x04grpcR\x04port\x12i\n" +
	"!purge_converge_history_after_days\x18\x03 \x01(\v2\x1b.google.protobuf.Int32ValueB\x02\x18\x01R\x1dpurgeConvergeHistoryAfterDays\x12X\n" +
	"\x18purge_actions_after_days\x18\x04 \x01(\v2\x1b.google.protobuf.Int32ValueB\x02\x18\x01R\x15purgeActionsAfterDays\x12^\n" +
	"\x1emax_number_of_bundled_run_msgs\x18\x06 \x01(\v2\x1b.google.protobuf.Int32ValueR\x19maxNumberOfBundledRunMsgs\x12d\n" +
	"!max_number_of_bundled_action_msgs\x18\a \x01(\v2\x1b.google.protobuf.Int32ValueR\x1cmaxNumberOfBundledActionMsgs\x12a\n" +
	"\x1fnumber_of_run_msgs_transformers\x18\b \x01(\v2\x1b.google.protobuf.Int32ValueR\x1bnumberOfRunMsgsTransformers\x12[\n" +
	"\x1cnumber_of_run_msg_publishers\x18\t \x01(\v2\x1b.google.protobuf.Int32ValueR\x18numberOfRunMsgPublishers\x12K\n" +
	"\x13message_buffer_size\x18\n" +
	" \x01(\v2\x1b.google.protobuf.Int32ValueR\x11messageBufferSize\x12]\n" +
	"\x1dnodes_missing_running_default\x18\v \x01(\v2\x1a.google.protobuf.BoolValueR\x1anodesMissingRunningDefault\x12u\n" +
	"*missing_nodes_for_deletion_running_default\x18\f \x01(\v2\x1a.google.protobuf.BoolValueR%missingNodesForDeletionRunningDefault\x12d\n" +
	" number_of_nodemanager_publishers\x18\r \x01(\v2\x1b.google.protobuf.Int32ValueR\x1dnumberOfNodemanagerPublishersJ\x04\b\x05\x10\x06\x1ao\n" +
	"\x03Log\x124\n" +
	...
	"\x0eingest-serviceJ\x04\b\x01\x10\x03B,Z*github.com/chef/automate/api/config/ingestb\x06proto3"

var (
	file_config_ingest_config_request_proto_rawDescOnce sync.Once
	file_config_ingest_config_request_proto_rawDescData []byte
)

func file_config_ingest_config_request_proto_rawDescGZIP() []byte {
	file_config_ingest_config_request_proto_rawDescOnce.Do(func() {
		file_config_ingest_config_request_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_config_ingest_config_request_proto_rawDesc), len(file_config_ingest_config_request_proto_rawDesc)))
	})
...
func file_config_ingest_config_request_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_ingest_config_request_proto_rawDesc), len(file_config_ingest_config_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
