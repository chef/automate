...
const file_config_compliance_config_request_proto_rawDesc = "" +
	"\n" +
	"&config/compliance/config_request.proto\x12&chef.automate.domain.compliance.config\x1a\x1aconfig/shared/global.proto\x1a\x17config/shared/tls.proto\x1a?automate-grpc/protoc-gen-a2-config/api/a2conf/annotations.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\x86\x16\n" +
	"\rConfigRequest\x12H\n" +
	"\x02v1\x18\x03 \x01(\v28.chef.automate.domain.compliance.config.ConfigRequest.V1R\x02v1\x1a\x8a\x15\n" +
	"\x02V1\x12Q\n" +
	"\x03sys\x18\x01 \x01(\v2?.chef.automate.domain.compliance.config.ConfigRequest.V1.SystemR\x03sys\x12R\n" +
	"\x03svc\x18\x02 \x01(\v2@.chef.automate.domain.compliance.config.ConfigRequest.V1.ServiceR\x03svc\x1a\xd1\x13\n" +
	"\x06System\x124\n" +
	"\x04mlsa\x18\x01 \x01(\v2 .chef.automate.infra.config.MlsaR\x04mlsa\x12a\n" +
	"\aservice\x18\x02 \x01(\v2G.chef.automate.domain.compliance.config.ConfigRequest.V1.System.ServiceR\aservice\x12<\n" +
	"\x03tls\x18\x03 \x01(\v2*.chef.automate.infra.config.TLSCredentialsR\x03tls\x12d\n" +
	"\bprofiles\x18\x04 \x01(\v2H.chef.automate.domain.compliance.config.ConfigRequest.V1.System.ProfilesR\bprofiles\x12a\n" +
	"\astorage\x18\x05 \x01(\v2G.chef.automate.domain.compliance.config.ConfigRequest.V1.System.StorageR\astorage\x12^\n" +
	"\x06logger\x18\x06 \x01(\v2F.chef.automate.domain.compliance.config.ConfigRequest.V1.System.LoggerR\x06logger\x12k\n" +
	"\tretention\x18\a \x01(\v2I.chef.automate.domain.compliance.config.ConfigRequest.V1.System.RetentionB\x02\x18\x01R\tretention\x12[\n" +
	"\x05agent\x18\n" +
	" \x01(\v2E.chef.automate.domain.compliance.config.ConfigRequest.V1.System.AgentR\x05agent\x12[\n" +
	"\x05proxy\x18\v \x01(\v2E.chef.automate.domain.compliance.config.ConfigRequest.V1.System.ProxyR\x05proxy\x1a\x8d\x05\n" +
	"\aService\x124\n" +
	...
	"\aservice\x10\x89O\x1a\x04grpcR\x04port\x12A\n" +
	"\rexternal_fqdn\x18\a \x01(\v2\x1c.google.protobuf.StringValueR\fexternalFqdn\x12K\n" +
	"\x13message_buffer_size\x18\b \x01(\v2\x1b.google.protobuf.Int32ValueR\x11messageBufferSize\x12P\n" +
	"\x16enable_large_reporting\x18\t \x01(\v2\x1a.google.protobuf.BoolValueR\x14enableLargeReporting\x12T\n" +
	"\x18lcr_open_search_requests\x18\n" +
	" \x01(\v2\x1b.google.protobuf.Int32ValueR\x15lcrOpenSearchRequests\x12k\n" +
	"$enable_enhanced_compliance_reporting\x18\v \x01(\v2\x1a.google.protobuf.BoolValueR!enableEnhancedComplianceReporting\x12^\n" +
	"\x1dcontrol_data_populators_count\x18\f \x01(\v2\x1b.google.protobuf.Int32ValueR\x1acontrolDataPopulatorsCount\x1a\x98\x01\n" +
	"\x05Proxy\x12I\n" +
	"\x11connection_string\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x10connectionString\x12D\n" +
	"\x0fno_proxy_string\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\rnoProxyString\x1ad\n" +
	"\bProfiles\x12R\n" +
	"\x17install_market_profiles\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\x15installMarketProfilesJ\x04\b\x01\x10\x02\x1a{\n" +
	"\aStorage\x128\n" +
	"\bdatabase\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\bdatabase\x120\n" +
	"\x04user\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x04userJ\x04\b\x03\x10\x04\x1ar\n" +
	"\x06Logger\x124\n" +
	...
	"\tRetention\x12Q\n" +
	"\x16compliance_report_days\x18\x01 \x01(\v2\x1b.google.protobuf.Int32ValueR\x14complianceReportDays\x1a\xb1\x03\n" +
	"\x05Agent\x125\n" +
	"\aworkers\x18\x01 \x01(\v2\x1b.google.protobuf.Int32ValueR\aworkers\x12<\n" +
	"\vbuffer_size\x18\x02 \x01(\v2\x1b.google.protobuf.Int32ValueR\n" +
	"bufferSize\x12P\n" +
	"\x15remote_inspec_version\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\x13remoteInspecVersion\x12M\n" +
	"\x14result_message_limit\x18\x04 \x01(\v2\x1b.google.protobuf.Int32ValueR\x12resultMessageLimit\x12O\n" +
	"\x15control_results_limit\x18\x05 \x01(\v2\x1b.google.protobuf.Int32ValueR\x13controlResultsLimit\x12A\n" +
	"\x0erun_time_limit\x18\x06 \x01(\v2\x1b.google.protobuf.FloatValueR\frunTimeLimitJ\x04\b\b\x10\tJ\x04\b\t\x10\n" +
	"\x1a\t\n" +
	"\aService:\x18\xc2\xf3\x18\x14\n" +
	"\x12compliance-serviceJ\x04\b\x01\x10\x03B0Z.github.com/chef/automate/api/config/complianceb\x06proto3"

var (
	file_config_compliance_config_request_proto_rawDescOnce sync.Once
	file_config_compliance_config_request_proto_rawDescData []byte
)
...
func file_config_compliance_config_request_proto_rawDescGZIP() []byte {
	file_config_compliance_config_request_proto_rawDescOnce.Do(func() {
		file_config_compliance_config_request_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_config_compliance_config_request_proto_rawDesc), len(file_config_compliance_config_request_proto_rawDesc)))
	})
...
func file_config_compliance_config_request_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_compliance_config_request_proto_rawDesc), len(file_config_compliance_config_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
