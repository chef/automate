...
type ConfigRequest_V1_System_Service struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Deprecated: Marked as deprecated in config/data_feed/config_request.proto.
...
const file_config_data_feed_config_request_proto_rawDesc = "" +
	"\n" +
	"%config/data_feed/config_request.proto\x12\x1echef.automate.domain.data_feed\x1a\x1aconfig/shared/global.proto\x1a\x17config/shared/tls.proto\x1a?automate-grpc/protoc-gen-a2-config/api/a2conf/annotations.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\xa1\v\n" +
	"\rConfigRequest\x12@\n" +
	"\x02v1\x18\x01 \x01(\v20.chef.automate.domain.data_feed.ConfigRequest.V1R\x02v1\x1a\xb4\n" +
	"\n" +
	"\x02V1\x12I\n" +
	"\x03sys\x18\x01 \x01(\v27.chef.automate.domain.data_feed.ConfigRequest.V1.SystemR\x03sys\x1a\xe2\t\n" +
	"\x06System\x124\n" +
	...
	"\aservice\x18\x03 \x01(\v2?.chef.automate.domain.data_feed.ConfigRequest.V1.System.ServiceR\aservice\x12M\n" +
	"\x03log\x18\x04 \x01(\v2;.chef.automate.domain.data_feed.ConfigRequest.V1.System.LogR\x03log\x1a\xc8\x06\n" +
	"\aService\x124\n" +
	...
	"\aservice\x10\xf9N\x1a\x04grpcR\x04port\x12A\n" +
	"\rfeed_interval\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\ffeedInterval\x12C\n" +
	"\x0fasset_page_size\x18\x04 \x01(\v2\x1b.google.protobuf.Int32ValueR\rassetPageSize\x12G\n" +
	"\x11reports_page_size\x18\x05 \x01(\v2\x1b.google.protobuf.Int32ValueR\x0freportsPageSize\x12C\n" +
	"\x0fnode_batch_size\x18\x06 \x01(\v2\x1b.google.protobuf.Int32ValueR\rnodeBatchSize\x12H\n" +
	"\x12updated_nodes_only\x18\a \x01(\v2\x1a.google.protobuf.BoolValueR\x10updatedNodesOnly\x12J\n" +
	"\x13disable_cidr_filter\x18\b \x01(\v2\x1a.google.protobuf.BoolValueR\x11disableCidrFilter\x12=\n" +
	"\vcidr_filter\x18\t \x01(\v2\x1c.google.protobuf.StringValueR\n" +
	"cidrFilter\x12A\n" +
	"\rexternal_fqdn\x18\n" +
	" \x01(\v2\x1c.google.protobuf.StringValueR\fexternalFqdn\x12O\n" +
	"\x15accepted_status_codes\x18\v \x03(\v2\x1b.google.protobuf.Int32ValueR\x13acceptedStatusCodes\x12?\n" +
	"\fcontent_type\x18\f \x01(\v2\x1c.google.protobuf.StringValueR\vcontentType\x1ao\n" +
	"\x03Log\x124\n" +
	"\x06format\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x06format\x122\n" +
	"\x05level\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x05level:\x17\xc2\xf3\x18\x13\n" +
	"\x11data-feed-serviceB/Z-github.com/chef/automate/api/config/data_feedb\x06proto3"

var (
	file_config_data_feed_config_request_proto_rawDescOnce sync.Once
	file_config_data_feed_config_request_proto_rawDescData []byte
)
...
func file_config_data_feed_config_request_proto_rawDescGZIP() []byte {
	file_config_data_feed_config_request_proto_rawDescOnce.Do(func() {
		file_config_data_feed_config_request_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_config_data_feed_config_request_proto_rawDesc), len(file_config_data_feed_config_request_proto_rawDesc)))
	})
...
var file_config_data_feed_config_request_proto_goTypes = []any{
...
func file_config_data_feed_config_request_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_data_feed_config_request_proto_rawDesc), len(file_config_data_feed_config_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
