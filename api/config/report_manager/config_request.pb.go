...
func (x *ConfigRequest_V1_System_Minio) GetEndpoint() *wrappers.StringValue {
	if x != nil {
		return x.Endpoint
	}
	return nil
...
func (x *ConfigRequest_V1_System_Minio) GetRootUser() *wrappers.StringValue {
	if x != nil {
		return x.RootUser
	}
	return nil
...
func (x *ConfigRequest_V1_System_Minio) GetRootPassword() *wrappers.StringValue {
	if x != nil {
