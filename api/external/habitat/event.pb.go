...
func (UpdateStrategy) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_event_eab28dec5843f583, []int{0}
}
...
func (HealthCheckResult) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_event_eab28dec5843f583, []int{1}
}
...
func (*UpdateConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_event_eab28dec5843f583, []int{2}
}
...
func (*ServiceStartedEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_event_eab28dec5843f583, []int{3}
}
...
func (*ServiceStoppedEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_event_eab28dec5843f583, []int{4}
}
...
func (*HealthCheckEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_event_eab28dec5843f583, []int{5}
}
...
func init() {
	proto.RegisterFile("api/external/habitat/event.proto", fileDescriptor_event_eab28dec5843f583)
}

var fileDescriptor_event_eab28dec5843f583 = []byte{
