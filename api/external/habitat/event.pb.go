...
func (x *EventMetadata) GetOccurredAt() *timestamp.Timestamp {
	if x != nil {
		return x.OccurredAt
	}
	return nil
...
func (x *HealthCheckEvent) GetExecution() *duration.Duration {
	if x != nil {
		return x.Execution
	}
	return nil
...
func (x *HealthCheckEvent) GetExitStatus() *wrappers.Int32Value {
	if x != nil {
		return x.ExitStatus
	}
	return nil
...
func (x *HealthCheckEvent) GetStdout() *wrappers.StringValue {
	if x != nil {
		return x.Stdout
	}
	return nil
...
func (x *HealthCheckEvent) GetStderr() *wrappers.StringValue {
	if x != nil {
		return x.Stderr
	}
	return nil
