...
var file_external_data_feed_data_feed_proto_rawDesc = []byte{
	...
	0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x32, 0xe2, 0x0c, 0x0a, 0x0f, 0x44, 0x61, 0x74, 0x61,
	...
	0x73, 0x74, 0x12, 0xf7, 0x01, 0x0a, 0x11, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x44, 0x65, 0x73,
	...
	,
...
var file_external_data_feed_data_feed_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_external_data_feed_data_feed_proto_goTypes = []interface{}{
	...
	(*UpdateDestinationEnableRequest)(nil), // 9: chef.automate.api.datafeed.UpdateDestinationEnableRequest
	(*ListDestinationRequest)(nil),         // 10: chef.automate.api.datafeed.ListDestinationRequest
	(*ListDestinationResponse)(nil),        // 11: chef.automate.api.datafeed.ListDestinationResponse
	(*UsernamePassword)(nil),               // 12: chef.automate.api.datafeed.UsernamePassword
	(*SecretId)(nil),                       // 13: chef.automate.api.datafeed.SecretId
	(*SecretIdWithExtraPrams)(nil),         // 14: chef.automate.api.datafeed.SecretIdWithExtraPrams
	(*Header)(nil),                         // 15: chef.automate.api.datafeed.Header
	(*AWS)(nil),                            // 16: chef.automate.api.datafeed.AWS
	(*URLValidationRequest)(nil),           // 17: chef.automate.api.datafeed.URLValidationRequest
	(*TestDestinationResponse)(nil),        // 18: chef.automate.api.datafeed.TestDestinationResponse
	(*query.Kv)(nil),                       // 19: chef.automate.api.common.query.Kv
}
var file_external_data_feed_data_feed_proto_depIdxs = []int32{
	19, // 0: chef.automate.api.datafeed.AddDestinationRequest.meta_data:type_name -> chef.automate.api.common.query.Kv
	19, // 1: chef.automate.api.datafeed.AddDestinationResponse.meta_data:type_name -> chef.automate.api.common.query.Kv
	19, // 2: chef.automate.api.datafeed.GetDestinationResponse.meta_data:type_name -> chef.automate.api.common.query.Kv
	19, // 3: chef.automate.api.datafeed.DeleteDestinationResponse.meta_data:type_name -> chef.automate.api.common.query.Kv
	19, // 4: chef.automate.api.datafeed.UpdateDestinationRequest.meta_data:type_name -> chef.automate.api.common.query.Kv
	19, // 5: chef.automate.api.datafeed.UpdateDestinationResponse.meta_data:type_name -> chef.automate.api.common.query.Kv
	...
	19, // 7: chef.automate.api.datafeed.SecretIdWithExtraPrams.meta_data:type_name -> chef.automate.api.common.query.Kv
	12, // 8: chef.automate.api.datafeed.URLValidationRequest.username_password:type_name -> chef.automate.api.datafeed.UsernamePassword
	13, // 9: chef.automate.api.datafeed.URLValidationRequest.secret_id:type_name -> chef.automate.api.datafeed.SecretId
	14, // 10: chef.automate.api.datafeed.URLValidationRequest.secret_id_with_addon:type_name -> chef.automate.api.datafeed.SecretIdWithExtraPrams
	15, // 11: chef.automate.api.datafeed.URLValidationRequest.header:type_name -> chef.automate.api.datafeed.Header
	16, // 12: chef.automate.api.datafeed.URLValidationRequest.aws:type_name -> chef.automate.api.datafeed.AWS
	...
	10, // 17: chef.automate.api.datafeed.DatafeedService.ListDestinations:input_type -> chef.automate.api.datafeed.ListDestinationRequest
	17, // 18: chef.automate.api.datafeed.DatafeedService.TestDestination:input_type -> chef.automate.api.datafeed.URLValidationRequest
	9,  // 19: chef.automate.api.datafeed.DatafeedService.EnableDestination:input_type -> chef.automate.api.datafeed.UpdateDestinationEnableRequest
	1,  // 20: chef.automate.api.datafeed.DatafeedService.AddDestination:output_type -> chef.automate.api.datafeed.AddDestinationResponse
	3,  // 21: chef.automate.api.datafeed.DatafeedService.GetDestination:output_type -> chef.automate.api.datafeed.GetDestinationResponse
	5,  // 22: chef.automate.api.datafeed.DatafeedService.DeleteDestination:output_type -> chef.automate.api.datafeed.DeleteDestinationResponse
	8,  // 23: chef.automate.api.datafeed.DatafeedService.UpdateDestination:output_type -> chef.automate.api.datafeed.UpdateDestinationResponse
	11, // 24: chef.automate.api.datafeed.DatafeedService.ListDestinations:output_type -> chef.automate.api.datafeed.ListDestinationResponse
	18, // 25: chef.automate.api.datafeed.DatafeedService.TestDestination:output_type -> chef.automate.api.datafeed.TestDestinationResponse
	3,  // 26: chef.automate.api.datafeed.DatafeedService.EnableDestination:output_type -> chef.automate.api.datafeed.GetDestinationResponse
...
func file_external_data_feed_data_feed_proto_init() {
	...
	file_external_data_feed_data_feed_proto_msgTypes[17].OneofWrappers = []interface{}{
