...
type PutUserSettingsRequest struct {
	...
	Settings      map[string]*UserSettingValue `protobuf:"bytes,2,rep,name=settings,proto3" json:"settings,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_external_user_settings_user_settings_proto_rawDesc = "" +
	"\n" +
	"*external/user_settings/user_settings.proto\x12\x1fchef.automate.api.user_settings\x1a\x1cgoogle/api/annotations.proto\x1a*external/annotations/iam/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\"8\n" +
	"\x04User\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1c\n" +
	"\tconnector\x18\x02 \x01(\tR\tconnector\"S\n" +
	"\x16GetUserSettingsRequest\x129\n" +
	"\x04user\x18\x01 \x01(\v2%.chef.automate.api.user_settings.UserR\x04user\"\xa6\x02\n" +
	"\x16PutUserSettingsRequest\x129\n" +
	"\x04user\x18\x01 \x01(\v2%.chef.automate.api.user_settings.UserR\x04user\x12a\n" +
	"\bsettings\x18\x02 \x03(\v2E.chef.automate.api.user_settings.PutUserSettingsRequest.SettingsEntryR\bsettings\x1an\n" +
	"\rSettingsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12G\n" +
	"\x05value\x18\x02 \x01(\v21.chef.automate.api.user_settings.UserSettingValueR\x05value:\x028\x01\"V\n" +
	"\x19DeleteUserSettingsRequest\x129\n" +
	"\x04user\x18\x01 \x01(\v2%.chef.automate.api.user_settings.UserR\x04user\"\xa8\x02\n" +
	"\x17GetUserSettingsResponse\x129\n" +
	"\x04user\x18\x01 \x01(\v2%.chef.automate.api.user_settings.UserR\x04user\x12b\n" +
	"\bsettings\x18\x02 \x03(\v2F.chef.automate.api.user_settings.GetUserSettingsResponse.SettingsEntryR\bsettings\x1an\n" +
	"\rSettingsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12G\n" +
	"\x05value\x18\x02 \x01(\v21.chef.automate.api.user_settings.UserSettingValueR\x05value:\x028\x01\"T\n" +
	"\x17PutUserSettingsResponse\x129\n" +
	"\x04user\x18\x01 \x01(\v2%.chef.automate.api.user_settings.UserR\x04user\"\x8a\x01\n" +
	"\x10UserSettingValue\x12#\n" +
	"\rdefault_value\x18\x01 \x01(\tR\fdefaultValue\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\x12\x18\n" +
	"\aenabled\x18\x03 \x01(\bR\aenabled\x12!\n" +
	"\fvalid_values\x18\x04 \x03(\tR\vvalidValues2\xee\x05\n" +
	"\x13UserSettingsService\x12\xeb\x01\n" +
	"\x0fGetUserSettings\x127.chef.automate.api.user_settings.GetUserSettingsRequest\x1a8.chef.automate.api.user_settings.GetUserSettingsResponse\"e\x8a\xb5\x18'\n" +
	"\x0eiam:introspect\x12\x15iam:introspect:getAll\x82\xd3\xe4\x93\x024\x122/api/v0/user-settings/{user.name}/{user.connector}\x12\xee\x01\n" +
	"\x0fPutUserSettings\x127.chef.automate.api.user_settings.PutUserSettingsRequest\x1a8.chef.automate.api.user_settings.PutUserSettingsResponse\"h\x8a\xb5\x18'\n" +
	"\x0eiam:introspect\x12\x15iam:introspect:update\x82\xd3\xe4\x93\x027:\x01*\x1a2/api/v0/user-settings/{user.name}/{user.connector}\x12\xf7\x01\n" +
	"\x12DeleteUserSettings\x12:.chef.automate.api.user_settings.DeleteUserSettingsRequest\x1a\x16.google.protobuf.Empty\"\x8c\x01\x8a\xb5\x18N\n" +
	"0global:userSettings:{user.name}:{user.connector}\x12\x1aglobal:userSettings:delete\x82\xd3\xe4\x93\x024*2/api/v0/user-settings/{user.name}/{user.connector}B5Z3github.com/chef/automate/api/external/user_settingsb\x06proto3"

var (
	file_external_user_settings_user_settings_proto_rawDescOnce sync.Once
	file_external_user_settings_user_settings_proto_rawDescData []byte
)
...
func file_external_user_settings_user_settings_proto_rawDescGZIP() []byte {
	file_external_user_settings_user_settings_proto_rawDescOnce.Do(func() {
		file_external_user_settings_user_settings_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_external_user_settings_user_settings_proto_rawDesc), len(file_external_user_settings_user_settings_proto_rawDesc)))
	})
...
func file_external_user_settings_user_settings_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_external_user_settings_user_settings_proto_rawDesc), len(file_external_user_settings_user_settings_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   1,
