...
const file_external_event_feed_response_eventstrings_proto_rawDesc = "" +
	"\n" +
	"/external/event_feed/response/eventstrings.proto\x12%chef.automate.api.event_feed.response\x1a(external/event_feed/response/event.proto\"\xba\x01\n" +
	"\x1dGetEventStringBucketsResponse\x12L\n" +
	"\astrings\x18\x01 \x03(\v22.chef.automate.api.event_feed.response.EventStringR\astrings\x12\x14\n" +
	"\x05start\x18\x02 \x01(\tR\x05start\x12\x10\n" +
	"\x03end\x18\x03 \x01(\tR\x03end\x12#\n" +
	"\rhours_between\x18\x04 \x01(\x05R\fhoursBetween\"\x88\x01\n" +
	"\vEventString\x12V\n" +
	"\n" +
	"collection\x18\x01 \x03(\v26.chef.automate.api.event_feed.response.EventCollectionR\n" +
	"collection\x12!\n" +
	"\fevent_action\x18\x02 \x01(\tR\veventAction\"g\n" +
	"\x0fEventCollection\x12T\n" +
	"\fevents_count\x18\x01 \x03(\v21.chef.automate.api.event_feed.response.EventCountR\veventsCountB;Z9github.com/chef/automate/api/external/event_feed/responseb\x06proto3"

var (
	file_external_event_feed_response_eventstrings_proto_rawDescOnce sync.Once
	file_external_event_feed_response_eventstrings_proto_rawDescData []byte
)
...
func file_external_event_feed_response_eventstrings_proto_rawDescGZIP() []byte {
	file_external_event_feed_response_eventstrings_proto_rawDescOnce.Do(func() {
		file_external_event_feed_response_eventstrings_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_external_event_feed_response_eventstrings_proto_rawDesc), len(file_external_event_feed_response_eventstrings_proto_rawDesc)))
	})
...
func file_external_event_feed_response_eventstrings_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_external_event_feed_response_eventstrings_proto_rawDesc), len(file_external_event_feed_response_eventstrings_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
