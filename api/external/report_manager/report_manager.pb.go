...
func file_external_report_manager_report_manager_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_external_report_manager_report_manager_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_external_report_manager_report_manager_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_external_report_manager_report_manager_proto_msgTypes[2].Exporter = func(v any, i int) any {
