...
const file_external_compliance_scanner_jobs_jobs_proto_rawDesc = "" +
	"\n" +
	"+external/compliance/scanner/jobs/jobs.proto\x12,chef.automate.api.compliance.scanner.jobs.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a*external/annotations/iam/annotations.proto\x1a&external/common/query/parameters.proto\"\x0f\n" +
	"\rRerunResponse\"(\n" +
	"\x02Id\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\"\x81\x02\n" +
	"\x05Query\x12@\n" +
	"\afilters\x18\x14 \x03(\v2&.chef.automate.api.common.query.FilterR\afilters\x12S\n" +
	"\x05order\x18\x15 \x01(\x0e2=.chef.automate.api.compliance.scanner.jobs.v1.Query.OrderTypeR\x05order\x12\x12\n" +
	...
	"\afilters\x18\x02 \x03(\v2&.chef.automate.api.common.query.FilterR\afilters\"\xbb\x06\n" +
	"\x03Job\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x12\n" +
	"\x04type\x18\x03 \x01(\tR\x04type\x12\x18\n" +
	"\atimeout\x18\x04 \x01(\x05R\atimeout\x126\n" +
	"\x04tags\x18\x14 \x03(\v2\".chef.automate.api.common.query.KvR\x04tags\x129\n" +
	"\n" +
	...
	"\fretries_left\x18\x1b \x01(\x05R\vretriesLeft\x12R\n" +
	"\aresults\x18\x1c \x03(\v28.chef.automate.api.compliance.scanner.jobs.v1.ResultsRowR\aresults\x12\x14\n" +
	"\x05nodes\x18d \x03(\tR\x05nodes\x12\x1a\n" +
	"\bprofiles\x18e \x03(\tR\bprofiles\x12\x1d\n" +
	"\n" +
	"node_count\x18f \x01(\x05R\tnodeCount\x12#\n" +
	"\rprofile_count\x18g \x01(\x05R\fprofileCount\x12b\n" +
	"\x0enode_selectors\x18h \x03(\v2;.chef.automate.api.compliance.scanner.jobs.v1.ManagerFilterR\rnodeSelectors\x12A\n" +
	...
	"\adeleted\x18m \x01(\bR\adeleted\"c\n" +
	"\x04Jobs\x12E\n" +
	"\x04jobs\x18\x01 \x03(\v21.chef.automate.api.compliance.scanner.jobs.v1.JobR\x04jobs\x12\x14\n" +
	...
	"\bend_time\x18\x15 \x01(\v2\x1a.google.protobuf.TimestampR\aendTime2\xa3\n" +
	"\n" +
	"\vJobsService\x12\xd5\x01\n" +
	"\x06Create\x121.chef.automate.api.compliance.scanner.jobs.v1.Job\x1a0.chef.automate.api.compliance.scanner.jobs.v1.Id\"f\x8a\xb5\x188\n" +
	"\x17compliance:scanner:jobs\x12\x1dcompliance:scannerJobs:create\x82\xd3\xe4\x93\x02$:\x01*\"\x1f/api/v0/compliance/scanner/jobs\x12\xda\x01\n" +
	"\x04Read\x120.chef.automate.api.compliance.scanner.jobs.v1.Id\x1a1.chef.automate.api.compliance.scanner.jobs.v1.Job\"m\x8a\xb5\x18:\n" +
	"\x1ccompliance:scanner:jobs:{id}\x12\x1acompliance:scannerJobs:get\x82\xd3\xe4\x93\x02)\x12'/api/v0/compliance/scanner/jobs/id/{id}\x12\xc8\x01\n" +
	"\x06Update\x121.chef.automate.api.compliance.scanner.jobs.v1.Job\x1a\x16.google.protobuf.Empty\"s\x8a\xb5\x18=\n" +
	"\x1ccompliance:scanner:jobs:{id}\x12\x1dcompliance:scannerJobs:update\x82\xd3\xe4\x93\x02,:\x01*\x1a'/api/v0/compliance/scanner/jobs/id/{id}\x12\xc4\x01\n" +
	"\x06Delete\x120.chef.automate.api.compliance.scanner.jobs.v1.Id\x1a\x16.google.protobuf.Empty\"p\x8a\xb5\x18=\n" +
	"\x1ccompliance:scanner:jobs:{id}\x12\x1dcompliance:scannerJobs:delete\x82\xd3\xe4\x93\x02)*'/api/v0/compliance/scanner/jobs/id/{id}\x12\xdc\x01\n" +
	"\x04List\x123.chef.automate.api.compliance.scanner.jobs.v1.Query\x1a2.chef.automate.api.compliance.scanner.jobs.v1.Jobs\"k\x8a\xb5\x186\n" +
	"\x17compliance:scanner:jobs\x12\x1bcompliance:scannerJobs:list\x82\xd3\xe4\x93\x02+:\x01*\"&/api/v0/compliance/scanner/jobs/search\x12\xed\x01\n" +
	"\x05Rerun\x120.chef.automate.api.compliance.scanner.jobs.v1.Id\x1a;.chef.automate.api.compliance.scanner.jobs.v1.RerunResponse\"u\x8a\xb5\x18<\n" +
	"\x1ccompliance:scanner:jobs:{id}\x12\x1ccompliance:scannerJobs:rerun\x82\xd3\xe4\x93\x02/\x12-/api/v0/compliance/scanner/jobs/rerun/id/{id}B?Z=github.com/chef/automate/api/external/compliance/scanner/jobsb\x06proto3"

var (
	file_external_compliance_scanner_jobs_jobs_proto_rawDescOnce sync.Once
	file_external_compliance_scanner_jobs_jobs_proto_rawDescData []byte
)
...
func file_external_compliance_scanner_jobs_jobs_proto_rawDescGZIP() []byte {
	file_external_compliance_scanner_jobs_jobs_proto_rawDescOnce.Do(func() {
		file_external_compliance_scanner_jobs_jobs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_external_compliance_scanner_jobs_jobs_proto_rawDesc), len(file_external_compliance_scanner_jobs_jobs_proto_rawDesc)))
	})
...
func file_external_compliance_scanner_jobs_jobs_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_external_compliance_scanner_jobs_jobs_proto_rawDesc), len(file_external_compliance_scanner_jobs_jobs_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
