...
const file_external_compliance_reporting_stats_stats_proto_rawDesc = "" +
	"\n" +
	"/external/compliance/reporting/stats/stats.proto\x12/chef.automate.api.compliance.reporting.stats.v1\x1a\x1cgoogle/api/annotations.proto\x1a*external/annotations/iam/annotations.proto\x1a-external/compliance/reporting/reporting.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\a\n" +
	"\x05Empty\"8\n" +
	"\n" +
	"ListFilter\x12\x16\n" +
	"\x06values\x18\x14 \x03(\tR\x06values\x12\x12\n" +
	"\x04type\x18\x15 \x01(\tR\x04type\"\xed\x02\n" +
	"\x05Query\x12\x0e\n" +
	"\x02id\x18\x11 \x01(\tR\x02id\x12\x12\n" +
	"\x04type\x18\x13 \x01(\tR\x04type\x12\x12\n" +
	"\x04size\x18\x12 \x01(\x05R\x04size\x12\x1a\n" +
	"\binterval\x18\x19 \x01(\x05R\binterval\x12U\n" +
	"\afilters\x18\x14 \x03(\v2;.chef.automate.api.compliance.reporting.stats.v1.ListFilterR\afilters\x12V\n" +
	"\x05order\x18\x15 \x01(\x0e2@.chef.automate.api.compliance.reporting.stats.v1.Query.OrderTypeR\x05order\x12\x12\n" +
	...
	"\x04DESC\x10\x01\"\xbe\x02\n" +
	"\aSummary\x12k\n" +
	"\x10controls_summary\x18\x01 \x01(\v2@.chef.automate.api.compliance.reporting.stats.v1.ControlsSummaryR\x0fcontrolsSummary\x12_\n" +
	"\fnode_summary\x18\x02 \x01(\v2<.chef.automate.api.compliance.reporting.stats.v1.NodeSummaryR\vnodeSummary\x12e\n" +
	"\x0ereport_summary\x18\x03 \x01(\v2>.chef.automate.api.compliance.reporting.stats.v1.ReportSummaryR\rreportSummary\"\xc5\x01\n" +
	...
	"\bcontrols\x18\x06 \x01(\x05R\bcontrols\"\xb0\x01\n" +
	"\rReportSummary\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x1a\n" +
	"\bduration\x18\x02 \x01(\x01R\bduration\x12\x1d\n" +
	"\n" +
	"start_date\x18\x03 \x01(\tR\tstartDate\x12L\n" +
	"\x05stats\x18\x04 \x01(\v26.chef.automate.api.compliance.reporting.stats.v1.StatsR\x05stats\"\x8a\x01\n" +
	"\x05Trend\x12\x1f\n" +
	...
	"\x06Trends\x12N\n" +
	"\x06trends\x18\x01 \x03(\v26.chef.automate.api.compliance.reporting.stats.v1.TrendR\x06trends\"\xb8\x02\n" +
	"\aProfile\x12_\n" +
	"\fprofile_list\x18\x01 \x03(\v2<.chef.automate.api.compliance.reporting.stats.v1.ProfileListR\vprofileList\x12h\n" +
	"\x0fprofile_summary\x18\x02 \x01(\v2?.chef.automate.api.compliance.reporting.stats.v1.ProfileSummaryR\x0eprofileSummary\x12b\n" +
	"\rcontrol_stats\x18\x03 \x03(\v2=.chef.automate.api.compliance.reporting.stats.v1.ControlStatsR\fcontrolStats\"\xe5\x01\n" +
	...
	"\x06waived\x18\t \x01(\x05R\x06waived\"\xf2\x03\n" +
	...
	"\asummary\x18\b \x01(\tR\asummary\x12T\n" +
	"\bsupports\x18\t \x03(\v28.chef.automate.api.compliance.reporting.stats.v1.SupportR\bsupports\x12Z\n" +
	"\x05stats\x18\n" +
	" \x01(\v2D.chef.automate.api.compliance.reporting.stats.v1.ProfileSummaryStatsR\x05stats\x12O\n" +
	"\adepends\x18\v \x03(\v25.chef.automate.api.compliance.reporting.v1.DependencyR\adepends\"\xbb\x01\n" +
	...
	"\bplatform\x18\a \x01(\tR\bplatform\"\x88\x03\n" +
	"\bFailures\x12[\n" +
	"\bprofiles\x18\x01 \x03(\v2?.chef.automate.api.compliance.reporting.stats.v1.FailureSummaryR\bprofiles\x12]\n" +
	"\tplatforms\x18\x02 \x03(\v2?.chef.automate.api.compliance.reporting.stats.v1.FailureSummaryR\tplatforms\x12[\n" +
	"\bcontrols\x18\x03 \x03(\v2?.chef.automate.api.compliance.reporting.stats.v1.FailureSummaryR\bcontrols\x12c\n" +
	"\fenvironments\x18\x04 \x03(\v2?.chef.automate.api.compliance.reporting.stats.v1.FailureSummaryR\fenvironments\"j\n" +
	...
	"\bnode_cnt\x18\x02 \x01(\x03R\anodeCnt2\xca\f\n" +
	"\fStatsService\x12\xfc\x01\n" +
	"\vReadSummary\x126.chef.automate.api.compliance.reporting.stats.v1.Query\x1a8.chef.automate.api.compliance.reporting.stats.v1.Summary\"{\x8a\xb5\x18B\n" +
	"\"compliance:reporting:stats:summary\x12\x1ccompliance:reportSummary:get\x82\xd3\xe4\x93\x02/:\x01*\"*/api/v0/compliance/reporting/stats/summary\x12\xf3\x01\n" +
	"\tReadTrend\x126.chef.automate.api.compliance.reporting.stats.v1.Query\x1a7.chef.automate.api.compliance.reporting.stats.v1.Trends\"u\x8a\xb5\x18>\n" +
	" compliance:reporting:stats:trend\x12\x1acompliance:reportTrend:get\x82\xd3\xe4\x93\x02-:\x01*\"(/api/v0/compliance/reporting/stats/trend\x12\x80\x02\n" +
	"\fReadProfiles\x126.chef.automate.api.compliance.reporting.stats.v1.Query\x1a8.chef.automate.api.compliance.reporting.stats.v1.Profile\"~\x8a\xb5\x18D\n" +
	"#compliance:reporting:stats:profiles\x12\x1dcompliance:reportProfiles:get\x82\xd3\xe4\x93\x020:\x01*\"+/api/v0/compliance/reporting/stats/profiles\x12\x81\x02\n" +
	"\fReadFailures\x126.chef.automate.api.compliance.reporting.stats.v1.Query\x1a9.chef.automate.api.compliance.reporting.stats.v1.Failures\"~\x8a\xb5\x18D\n" +
	"#compliance:reporting:stats:failures\x12\x1dcompliance:reportFailures:get\x82\xd3\xe4\x93\x020:\x01*\"+/api/v0/compliance/reporting/stats/failures\x12\xaa\x02\n" +
	"\x17UpdateTelemetryReported\x12O.chef.automate.api.compliance.reporting.stats.v1.UpdateTelemetryReportedRequest\x1aP.chef.automate.api.compliance.reporting.stats.v1.UpdateTelemetryReportedResponse\"l\x8a\xb5\x18'\n" +
	"\x0eiam:introspect\x12\x15iam:introspect:getAll\x82\xd3\xe4\x93\x02;:\x01*\x1a6/api/v0/compliance/reporting/stats/nodes/count/updated\x12\x90\x02\n" +
	"\x12GetNodesUsageCount\x12J.chef.automate.api.compliance.reporting.stats.v1.GetNodesUsageCountRequest\x1aK.chef.automate.api.compliance.reporting.stats.v1.GetNodesUsageCountResponse\"a\x8a\xb5\x18'\n" +
	"\x0eiam:introspect\x12\x15iam:introspect:getAll\x82\xd3\xe4\x93\x020\x12./api/v0/compliance/reporting/stats/nodes/countBBZ@github.com/chef/automate/api/external/compliance/reporting/statsb\x06proto3"

var (
	file_external_compliance_reporting_stats_stats_proto_rawDescOnce sync.Once
	file_external_compliance_reporting_stats_stats_proto_rawDescData []byte
)
...
func file_external_compliance_reporting_stats_stats_proto_rawDescGZIP() []byte {
	file_external_compliance_reporting_stats_stats_proto_rawDescOnce.Do(func() {
		file_external_compliance_reporting_stats_stats_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_external_compliance_reporting_stats_stats_proto_rawDesc), len(file_external_compliance_reporting_stats_stats_proto_rawDesc)))
	})
...
func file_external_compliance_reporting_stats_stats_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_external_compliance_reporting_stats_stats_proto_rawDesc), len(file_external_compliance_reporting_stats_stats_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   22,
			NumExtensions: 0,
			NumServices:   1,
