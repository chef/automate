...
func file_external_common_version_version_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_external_common_version_version_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_external_common_version_version_proto_msgTypes[1].Exporter = func(v any, i int) any {
