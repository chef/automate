...
// Note that using this registration option will cause many gRPC library features to stop working. Consider using RegisterTeamsHandlerFromEndpoint instead.
...
var (
	pattern_Teams_CreateTeam_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"apis", "iam", "v2", "teams"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Teams_ListTeams_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"apis", "iam", "v2", "teams"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Teams_GetTeam_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"apis", "iam", "v2", "teams", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Teams_UpdateTeam_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"apis", "iam", "v2", "teams", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Teams_DeleteTeam_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"apis", "iam", "v2", "teams", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Teams_GetTeamMembership_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"apis", "iam", "v2", "teams", "id", "users"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Teams_AddTeamMembers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"apis", "iam", "v2", "teams", "id", "users"}, "add", runtime.AssumeColonVerbOpt(true)))

	pattern_Teams_RemoveTeamMembers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"apis", "iam", "v2", "teams", "id", "users"}, "remove", runtime.AssumeColonVerbOpt(true)))

	pattern_Teams_GetTeamsForMember_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"apis", "iam", "v2", "users", "membership_id", "teams"}, "", runtime.AssumeColonVerbOpt(true)))
)
