...
func file_external_iam_v2_common_rules_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_external_iam_v2_common_rules_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Rule); i {
			case 0:
				return &v.state
			case 1:
		...
		file_external_iam_v2_common_rules_proto_msgTypes[1].Exporter = func(v any, i int) any {
