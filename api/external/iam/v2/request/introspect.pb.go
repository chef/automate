...
func file_external_iam_v2_request_introspect_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_external_iam_v2_request_introspect_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_external_iam_v2_request_introspect_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_external_iam_v2_request_introspect_proto_msgTypes[2].Exporter = func(v any, i int) any {
