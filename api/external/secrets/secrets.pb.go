...
const file_external_secrets_secrets_proto_rawDesc = "" +
	"\n" +
	"\x1eexternal/secrets/secrets.proto\x12\x19chef.automate.api.secrets\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cgoogle/api/annotations.proto\x1a*external/annotations/iam/annotations.proto\x1a&external/common/query/parameters.proto\"\x10\n" +
	"\x0eUpdateResponse\"\x10\n" +
	"\x0eDeleteResponse\"\x14\n" +
	"\x02Id\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"\xee\x01\n" +
	"\x05Query\x12@\n" +
	"\afilters\x18\x14 \x03(\v2&.chef.automate.api.common.query.FilterR\afilters\x12@\n" +
	"\x05order\x18\x15 \x01(\x0e2*.chef.automate.api.secrets.Query.OrderTypeR\x05order\x12\x12\n" +
	...
	"\x04DESC\x10\x01\"\xf1\x01\n" +
	"\x06Secret\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x12\n" +
	"\x04type\x18\x03 \x01(\tR\x04type\x12?\n" +
	"\rlast_modified\x18\x14 \x01(\v2\x1a.google.protobuf.TimestampR\flastModified\x126\n" +
	"\x04tags\x18\x15 \x03(\v2\".chef.automate.api.common.query.KvR\x04tags\x126\n" +
	"\x04data\x18\x16 \x03(\v2\".chef.automate.api.common.query.KvR\x04data\"\\\n" +
	"\aSecrets\x12;\n" +
	"\asecrets\x18\x01 \x03(\v2!.chef.automate.api.secrets.SecretR\asecrets\x12\x14\n" +
	"\x05total\x18\x14 \x01(\x05R\x05total2\xb5\x06\n" +
	"\x0eSecretsService\x12\x93\x01\n" +
	"\x06Create\x12!.chef.automate.api.secrets.Secret\x1a\x1d.chef.automate.api.secrets.Id\"G\x8a\xb5\x18)\n" +
	"\x0fsecrets:secrets\x12\x16secrets:secrets:create\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/api/v0/secrets\x12\x98\x01\n" +
	"\x04Read\x12\x1d.chef.automate.api.secrets.Id\x1a!.chef.automate.api.secrets.Secret\"N\x8a\xb5\x18+\n" +
	"\x14secrets:secrets:{id}\x12\x13secrets:secrets:get\x82\xd3\xe4\x93\x02\x19\x12\x17/api/v0/secrets/id/{id}\x12\xac\x01\n" +
	"\x06Update\x12!.chef.automate.api.secrets.Secret\x1a).chef.automate.api.secrets.UpdateResponse\"T\x8a\xb5\x18.\n" +
	"\x14secrets:secrets:{id}\x12\x16secrets:secrets:update\x82\xd3\xe4\x93\x02\x1c:\x01*2\x17/api/v0/secrets/id/{id}\x12\xa5\x01\n" +
	"\x06Delete\x12\x1d.chef.automate.api.secrets.Id\x1a).chef.automate.api.secrets.DeleteResponse\"Q\x8a\xb5\x18.\n" +
	"\x14secrets:secrets:{id}\x12\x16secrets:secrets:delete\x82\xd3\xe4\x93\x02\x19*\x17/api/v0/secrets/id/{id}\x12\x9a\x01\n" +
	"\x04List\x12 .chef.automate.api.secrets.Query\x1a\".chef.automate.api.secrets.Secrets\"L\x8a\xb5\x18'\n" +
	"\x0fsecrets:secrets\x12\x14secrets:secrets:list\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/api/v0/secrets/searchB/Z-github.com/chef/automate/api/external/secretsb\x06proto3"

var (
	file_external_secrets_secrets_proto_rawDescOnce sync.Once
	file_external_secrets_secrets_proto_rawDescData []byte
)

func file_external_secrets_secrets_proto_rawDescGZIP() []byte {
	file_external_secrets_secrets_proto_rawDescOnce.Do(func() {
		file_external_secrets_secrets_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_external_secrets_secrets_proto_rawDesc), len(file_external_secrets_secrets_proto_rawDesc)))
	})
...
func file_external_secrets_secrets_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_external_secrets_secrets_proto_rawDesc), len(file_external_secrets_secrets_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
