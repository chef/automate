...
func file_external_ingest_request_action_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_external_ingest_request_action_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Action); i {
			case 0:
				return &v.state
			case 1:
		...
		file_external_ingest_request_action_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Delete); i {
			case 0:
				return &v.state
			case 1:
		...
		file_external_ingest_request_action_proto_msgTypes[2].Exporter = func(v any, i int) any {
