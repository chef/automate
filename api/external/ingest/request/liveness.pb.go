...
func (*Liveness) Descriptor() ([]byte, []int) {
	return fileDescriptor_liveness_a62ea728d151c45c, []int{0}
}
...
func init() {
	proto.RegisterFile("api/external/ingest/request/liveness.proto", fileDescriptor_liveness_a62ea728d151c45c)
}

var fileDescriptor_liveness_a62ea728d151c45c = []byte{
