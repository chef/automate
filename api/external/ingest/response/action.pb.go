...
func (*ProcessChefActionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_dee6dfe57e3af171, []int{0}
}
...
func (*ProcessNodeDeleteResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_dee6dfe57e3af171, []int{1}
}
...
func (*ProcessMultipleNodeDeleteResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_dee6dfe57e3af171, []int{2}
}
...
func init() {
	proto.RegisterFile("api/external/ingest/response/action.proto", fileDescriptor_dee6dfe57e3af171)
}

var fileDescriptor_dee6dfe57e3af171 = []byte{
