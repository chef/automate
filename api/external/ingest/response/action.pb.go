...
const file_external_ingest_response_action_proto_rawDesc = "" +
	"\n" +
	"%external/ingest/response/action.proto\x12!chef.automate.api.ingest.response\"\x1b\n" +
	"\x19ProcessChefActionResponse\"\x1b\n" +
	"\x19ProcessNodeDeleteResponse\"#\n" +
	"!ProcessMultipleNodeDeleteResponseB7Z5github.com/chef/automate/api/external/ingest/responseb\x06proto3"

var (
	file_external_ingest_response_action_proto_rawDescOnce sync.Once
	file_external_ingest_response_action_proto_rawDescData []byte
)
...
func file_external_ingest_response_action_proto_rawDescGZIP() []byte {
	file_external_ingest_response_action_proto_rawDescOnce.Do(func() {
		file_external_ingest_response_action_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_external_ingest_response_action_proto_rawDesc), len(file_external_ingest_response_action_proto_rawDesc)))
	})
...
func file_external_ingest_response_action_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_external_ingest_response_action_proto_rawDesc), len(file_external_ingest_response_action_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
