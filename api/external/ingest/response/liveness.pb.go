...
func (*ProcessLivenessResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_57ee751fbef65287, []int{0}
}
...
func init() {
	proto.RegisterFile("api/external/ingest/response/liveness.proto", fileDescriptor_57ee751fbef65287)
}

var fileDescriptor_57ee751fbef65287 = []byte{
