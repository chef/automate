...
func request_ChefIngester_ProcessMultipleNodeDeletes_0(ctx context.Context, marshaler runtime.Marshaler, client ChefIngesterClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.MultipleNodeDeleteRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.ProcessMultipleNodeDeletes(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ChefIngester_ProcessMultipleNodeDeletes_0(ctx context.Context, marshaler runtime.Marshaler, server ChefIngesterServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.MultipleNodeDeleteRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ProcessMultipleNodeDeletes(ctx, &protoReq)
	return msg, metadata, err
...
func request_ChefIngester_InsertDummy_0(ctx context.Context, marshaler runtime.Marshaler, client ChefIngesterClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.InsertRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.InsertDummy(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ChefIngester_InsertDummy_0(ctx context.Context, marshaler runtime.Marshaler, server ChefIngesterServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.InsertRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.InsertDummy(ctx, &protoReq)
	return msg, metadata, err

}

func request_ChefIngester_InsertDummyDetails_0(ctx context.Context, marshaler runtime.Marshaler, client ChefIngesterClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.InsertRequestDetails
	var metadata runtime.ServerMetadata
	...
	msg, err := client.InsertDummyDetails(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ChefIngester_InsertDummyDetails_0(ctx context.Context, marshaler runtime.Marshaler, server ChefIngesterServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.InsertRequestDetails
	var metadata runtime.ServerMetadata
	...
	msg, err := server.InsertDummyDetails(ctx, &protoReq)
	return msg, metadata, err
...
// Note that using this registration option will cause many gRPC library features to stop working. Consider using RegisterChefIngesterHandlerFromEndpoint instead.
func RegisterChefIngesterHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ChefIngesterServer) error {
	...
	mux.Handle("POST", pattern_ChefIngester_ProcessMultipleNodeDeletes_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_ChefIngester_ProcessMultipleNodeDeletes_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_ChefIngester_ProcessMultipleNodeDeletes_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_ChefIngester_InsertDummy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_ChefIngester_InsertDummy_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_ChefIngester_InsertDummy_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_ChefIngester_InsertDummyDetails_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_ChefIngester_InsertDummyDetails_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_ChefIngester_InsertDummyDetails_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterChefIngesterHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ChefIngesterClient) error {
	...
	mux.Handle("POST", pattern_ChefIngester_ProcessMultipleNodeDeletes_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ChefIngester_ProcessMultipleNodeDeletes_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_ChefIngester_InsertDummy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ChefIngester_InsertDummy_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_ChefIngester_InsertDummyDetails_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ChefIngester_InsertDummyDetails_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_ChefIngester_ProcessChefRun_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"api", "v0", "ingest", "events", "chef", "run"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ChefIngester_ProcessChefAction_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"api", "v0", "ingest", "events", "chef", "action"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ChefIngester_ProcessNodeDelete_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"api", "v0", "ingest", "events", "chef", "nodedelete"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ChefIngester_ProcessMultipleNodeDeletes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"api", "v0", "ingest", "events", "chef", "node-multiple-deletes"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ChefIngester_ProcessLivenessPing_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"api", "v0", "ingest", "events", "chef", "liveness"}, "", runtime.AssumeColonVerbOpt(true)))
	...
	pattern_ChefIngester_InsertDummy_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"api", "v0", "ingest", "events", "chef", "insert_request"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ChefIngester_InsertDummyDetails_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"api", "v0", "ingest", "events", "chef", "insert_request_details"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	...
	forward_ChefIngester_ProcessMultipleNodeDeletes_0 = runtime.ForwardResponseMessage
	...
	forward_ChefIngester_InsertDummy_0 = runtime.ForwardResponseMessage

	forward_ChefIngester_InsertDummyDetails_0 = runtime.ForwardResponseMessage
)
