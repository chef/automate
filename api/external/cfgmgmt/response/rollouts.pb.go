...
type CurrentRolloutProgress struct {
	...
	LatestRunFailedCount     int32    `protobuf:"varint,4,opt,name=latest_run_failed_count,json=latestRunFailedCount,proto3" json:"latest_run_failed_count,omitempty"`
...
func (m *CurrentRolloutProgress) GetLatestRunFailedCount() int32 {
	if m != nil {
		return m.LatestRunFailedCount
	}
	return 0
}
...
type PastRolloutProgress struct {
	...
	// don't include the success/failure, it would be misleading since we
...
var fileDescriptor_d3bb6ceeab2493f2 = []byte{
	...
	,
}
