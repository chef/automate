...
func (SCMType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_b6e6b7837556b920, []int{0}
}
...
func (SCMWebType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_b6e6b7837556b920, []int{1}
}
...
func (*NodeSegmentsWithRolloutProgress) Descriptor() ([]byte, []int) {
	return fileDescriptor_b6e6b7837556b920, []int{2}
}
...
func (*NodeSegmentRolloutProgress) Descriptor() ([]byte, []int) {
	return fileDescriptor_b6e6b7837556b920, []int{3}
}
...
func (*CurrentRolloutProgress) Descriptor() ([]byte, []int) {
	return fileDescriptor_b6e6b7837556b920, []int{4}
}
...
func (*PastRolloutProgress) Descriptor() ([]byte, []int) {
	return fileDescriptor_b6e6b7837556b920, []int{5}
}
...
func (*CreateRolloutTest) Descriptor() ([]byte, []int) {
	return fileDescriptor_b6e6b7837556b920, []int{6}
}
...
func init() {
	proto.RegisterFile("external/cfgmgmt/response/rollouts.proto", fileDescriptor_b6e6b7837556b920)
}

var fileDescriptor_b6e6b7837556b920 = []byte{
	// 881 bytes of a gzipped FileDescriptorProto
	,
}
