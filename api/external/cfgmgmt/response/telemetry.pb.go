...
const file_external_cfgmgmt_response_telemetry_proto_rawDesc = "" +
	"\n" +
	")external/cfgmgmt/response/telemetry.proto\x12\"chef.automate.api.cfgmgmt.response\"!\n" +
	...
	"\bnode_cnt\x18\x02 \x01(\x03R\anodeCntB8Z6github.com/chef/automate/api/external/cfgmgmt/responseb\x06proto3"

var (
	file_external_cfgmgmt_response_telemetry_proto_rawDescOnce sync.Once
	file_external_cfgmgmt_response_telemetry_proto_rawDescData []byte
)
...
func file_external_cfgmgmt_response_telemetry_proto_rawDescGZIP() []byte {
	file_external_cfgmgmt_response_telemetry_proto_rawDescOnce.Do(func() {
		file_external_cfgmgmt_response_telemetry_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_external_cfgmgmt_response_telemetry_proto_rawDesc), len(file_external_cfgmgmt_response_telemetry_proto_rawDesc)))
	})
...
var file_external_cfgmgmt_response_telemetry_proto_goTypes = []any{
...
func file_external_cfgmgmt_response_telemetry_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_external_cfgmgmt_response_telemetry_proto_rawDesc), len(file_external_cfgmgmt_response_telemetry_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
