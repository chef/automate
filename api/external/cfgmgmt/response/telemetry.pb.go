...
func file_external_cfgmgmt_response_telemetry_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_external_cfgmgmt_response_telemetry_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_external_cfgmgmt_response_telemetry_proto_msgTypes[1].Exporter = func(v any, i int) any {
