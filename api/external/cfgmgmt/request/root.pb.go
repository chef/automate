...
func (*Organizations) Descriptor() ([]byte, []int) {
	return fileDescriptor_b4fbca625d88215a, []int{0}
}
...
func (*SourceFqdns) Descriptor() ([]byte, []int) {
	return fileDescriptor_b4fbca625d88215a, []int{1}
}
...
func init() {
	proto.RegisterFile("api/external/cfgmgmt/request/root.proto", fileDescriptor_b4fbca625d88215a)
}

var fileDescriptor_b4fbca625d88215a = []byte{
