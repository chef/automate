...
const file_external_cfgmgmt_request_stats_proto_rawDesc = "" +
	"\n" +
	"$external/cfgmgmt/request/stats.proto\x12!chef.automate.api.cfgmgmt.request\x1a,protoc-gen-swagger/options/annotations.proto\"\x8c\x01\n" +
	"\vNodesCounts\x12\x16\n" +
	"\x06filter\x18\x01 \x03(\tR\x06filter\x12\x14\n" +
	"\x05start\x18\x02 \x01(\tR\x05start\x12\x10\n" +
	"\x03end\x18\x03 \x01(\tR\x03end:=\x92A:\n" +
	"\t\xd2\x01\x06filter2-\x12+{\"filter\": [\"name:mySO*\",\"platform:ubun*\"]}\"\xc4\x01\n" +
	"\n" +
	"RunsCounts\x12\x16\n" +
	"\x06filter\x18\x01 \x03(\tR\x06filter\x12\x14\n" +
	"\x05start\x18\x02 \x01(\tR\x05start\x12\x10\n" +
	"\x03end\x18\x03 \x01(\tR\x03end\x12\x17\n" +
	"\anode_id\x18\x04 \x01(\tR\x06nodeId:]\x92AZ\n" +
	"\n" +
	"\xd2\x01\anode_id2L\x12J{\"node_id\": \"821fff07-abc9-4160-96b1-83d68ae5cfdd\", \"start\": \"2019-11-02\"}\"L\n" +
...
var (
	...
	file_external_cfgmgmt_request_stats_proto_rawDescData []byte
)
...
func file_external_cfgmgmt_request_stats_proto_rawDescGZIP() []byte {
	file_external_cfgmgmt_request_stats_proto_rawDescOnce.Do(func() {
		file_external_cfgmgmt_request_stats_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_external_cfgmgmt_request_stats_proto_rawDesc), len(file_external_cfgmgmt_request_stats_proto_rawDesc)))
	})
...
func file_external_cfgmgmt_request_stats_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_external_cfgmgmt_request_stats_proto_rawDesc), len(file_external_cfgmgmt_request_stats_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
