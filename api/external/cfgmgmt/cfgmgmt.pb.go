...
var file_external_cfgmgmt_cfgmgmt_proto_rawDesc = []byte{
	...
	0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x25, 0x65,
	0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x63, 0x66, 0x67, 0x6d, 0x67, 0x6d, 0x74, 0x2f,
	0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2f, 0x6e, 0x6f, 0x64, 0x65, 0x73, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x28, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x63,
	0x66, 0x67, 0x6d, 0x67, 0x6d, 0x74, 0x2f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2f,
	0x72, 0x6f, 0x6c, 0x6c, 0x6f, 0x75, 0x74, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x25,
	...
	0x63, 0x66, 0x67, 0x6d, 0x67, 0x6d, 0x74, 0x2f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x2f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x26, 0x65,
	0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x71,
	0x75, 0x65, 0x72, 0x79, 0x2f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x2e,
	...
	0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1e, 0x65, 0x78,
	0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x72, 0x65,
	...
	0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xe0, 0x25,
	0x0a, 0x0a, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x4d, 0x67, 0x6d, 0x74, 0x12, 0x96, 0x01, 0x0a,
...
var file_external_cfgmgmt_cfgmgmt_proto_goTypes = []interface{}{
	...
	(*_struct.ListValue)(nil),                           // 24: google.protobuf.ListValue
	(*response.NodesCounts)(nil),                        // 25: chef.automate.api.cfgmgmt.response.NodesCounts
	(*response.RunsCounts)(nil),                         // 26: chef.automate.api.cfgmgmt.response.RunsCounts
	(*response.CheckInCountsTimeSeries)(nil),            // 27: chef.automate.api.cfgmgmt.response.CheckInCountsTimeSeries
	(*response.MissingNodeDurationCounts)(nil),          // 28: chef.automate.api.cfgmgmt.response.MissingNodeDurationCounts
	(*response.Run)(nil),                                // 29: chef.automate.api.cfgmgmt.response.Run
	(*response.NodeAttribute)(nil),                      // 30: chef.automate.api.cfgmgmt.response.NodeAttribute
	(*version.VersionInfo)(nil),                         // 31: chef.automate.api.common.version.VersionInfo
	(*response.PolicyCookbooks)(nil),                    // 32: chef.automate.api.cfgmgmt.response.PolicyCookbooks
	(*response.Errors)(nil),                             // 33: chef.automate.api.cfgmgmt.response.Errors
	(*common.ExportData)(nil),                           // 34: chef.automate.api.common.ExportData
	(*response.NodeMetadataCounts)(nil),                 // 35: chef.automate.api.cfgmgmt.response.NodeMetadataCounts
	(*response.NodeRunsDailyStatusTimeSeries)(nil),      // 36: chef.automate.api.cfgmgmt.response.NodeRunsDailyStatusTimeSeries
	(*response.Rollout)(nil),                            // 37: chef.automate.api.cfgmgmt.response.Rollout
	(*response.CreateRolloutTest)(nil),                  // 38: chef.automate.api.cfgmgmt.response.CreateRolloutTest
	(*response.Rollouts)(nil),                           // 39: chef.automate.api.cfgmgmt.response.Rollouts
	(*response.NodeSegmentsWithRolloutProgress)(nil),    // 40: chef.automate.api.cfgmgmt.response.NodeSegmentsWithRolloutProgress
}
var file_external_cfgmgmt_cfgmgmt_proto_depIdxs = []int32{
	...
	24, // 24: chef.automate.api.cfgmgmt.ConfigMgmt.GetNodes:output_type -> google.protobuf.ListValue
	24, // 25: chef.automate.api.cfgmgmt.ConfigMgmt.GetRuns:output_type -> google.protobuf.ListValue
	25, // 26: chef.automate.api.cfgmgmt.ConfigMgmt.GetNodesCounts:output_type -> chef.automate.api.cfgmgmt.response.NodesCounts
	26, // 27: chef.automate.api.cfgmgmt.ConfigMgmt.GetRunsCounts:output_type -> chef.automate.api.cfgmgmt.response.RunsCounts
	27, // 28: chef.automate.api.cfgmgmt.ConfigMgmt.GetCheckInCountsTimeSeries:output_type -> chef.automate.api.cfgmgmt.response.CheckInCountsTimeSeries
	28, // 29: chef.automate.api.cfgmgmt.ConfigMgmt.GetMissingNodeDurationCounts:output_type -> chef.automate.api.cfgmgmt.response.MissingNodeDurationCounts
	29, // 30: chef.automate.api.cfgmgmt.ConfigMgmt.GetNodeRun:output_type -> chef.automate.api.cfgmgmt.response.Run
	24, // 31: chef.automate.api.cfgmgmt.ConfigMgmt.GetSuggestions:output_type -> google.protobuf.ListValue
	24, // 32: chef.automate.api.cfgmgmt.ConfigMgmt.GetOrganizations:output_type -> google.protobuf.ListValue
	24, // 33: chef.automate.api.cfgmgmt.ConfigMgmt.GetSourceFqdns:output_type -> google.protobuf.ListValue
	30, // 34: chef.automate.api.cfgmgmt.ConfigMgmt.GetAttributes:output_type -> chef.automate.api.cfgmgmt.response.NodeAttribute
	31, // 35: chef.automate.api.cfgmgmt.ConfigMgmt.GetVersion:output_type -> chef.automate.api.common.version.VersionInfo
	32, // 36: chef.automate.api.cfgmgmt.ConfigMgmt.GetPolicyCookbooks:output_type -> chef.automate.api.cfgmgmt.response.PolicyCookbooks
	33, // 37: chef.automate.api.cfgmgmt.ConfigMgmt.GetErrors:output_type -> chef.automate.api.cfgmgmt.response.Errors
	34, // 38: chef.automate.api.cfgmgmt.ConfigMgmt.NodeExport:output_type -> chef.automate.api.common.ExportData
	34, // 39: chef.automate.api.cfgmgmt.ConfigMgmt.ReportExport:output_type -> chef.automate.api.common.ExportData
	35, // 40: chef.automate.api.cfgmgmt.ConfigMgmt.GetNodeMetadataCounts:output_type -> chef.automate.api.cfgmgmt.response.NodeMetadataCounts
	36, // 41: chef.automate.api.cfgmgmt.ConfigMgmt.GetNodeRunsDailyStatusTimeSeries:output_type -> chef.automate.api.cfgmgmt.response.NodeRunsDailyStatusTimeSeries
	37, // 42: chef.automate.api.cfgmgmt.ConfigMgmt.CreateRollout:output_type -> chef.automate.api.cfgmgmt.response.Rollout
	38, // 43: chef.automate.api.cfgmgmt.ConfigMgmt.CreateRolloutTest:output_type -> chef.automate.api.cfgmgmt.response.CreateRolloutTest
	39, // 44: chef.automate.api.cfgmgmt.ConfigMgmt.GetRollouts:output_type -> chef.automate.api.cfgmgmt.response.Rollouts
	37, // 45: chef.automate.api.cfgmgmt.ConfigMgmt.GetRolloutById:output_type -> chef.automate.api.cfgmgmt.response.Rollout
	37, // 46: chef.automate.api.cfgmgmt.ConfigMgmt.GetRolloutForChefRun:output_type -> chef.automate.api.cfgmgmt.response.Rollout
	40, // 47: chef.automate.api.cfgmgmt.ConfigMgmt.ListNodeSegmentsWithRolloutProgress:output_type -> chef.automate.api.cfgmgmt.response.NodeSegmentsWithRolloutProgress
