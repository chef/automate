...
func (x *UpdateWebuiKey) Reset() {
	*x = UpdateWebuiKey{}
	if protoimpl.UnsafeEnabled {
		mi := &file_external_infra_proxy_request_servers_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UpdateWebuiKey) Descriptor() ([]byte, []int) {
	return file_external_infra_proxy_request_servers_proto_rawDescGZIP(), []int{7}
}
...
var file_external_infra_proxy_request_servers_proto_rawDesc = []byte{
	...
	0x62, 0x75, 0x69, 0x4b, 0x65, 0x79, 0x22, 0x3d, 0x0a, 0x0e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	0x57, 0x65, 0x62, 0x75, 0x69, 0x4b, 0x65, 0x79, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x77, 0x65, 0x62, 0x75,
...
var file_external_infra_proxy_request_servers_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_external_infra_proxy_request_servers_proto_goTypes = []interface{}{
	...
	(*UpdateWebuiKey)(nil),   // 7: chef.automate.api.infra_proxy.request.UpdateWebuiKey
}
...
func file_external_infra_proxy_request_servers_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_external_infra_proxy_request_servers_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
