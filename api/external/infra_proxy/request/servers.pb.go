...
var file_external_infra_proxy_request_servers_proto_rawDesc = []byte{
	...
	0x71, 0x64, 0x6e, 0x42, 0x3b, 0x5a, 0x39, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_external_infra_proxy_request_servers_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_external_infra_proxy_request_servers_proto_goTypes = []any{
...
func file_external_infra_proxy_request_servers_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_external_infra_proxy_request_servers_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_external_infra_proxy_request_servers_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_external_infra_proxy_request_servers_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_external_infra_proxy_request_servers_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_external_infra_proxy_request_servers_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_external_infra_proxy_request_servers_proto_msgTypes[5].Exporter = func(v any, i int) any {
