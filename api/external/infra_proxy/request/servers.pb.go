...
const file_external_infra_proxy_request_servers_proto_rawDesc = "" +
	"\n" +
	"*external/infra_proxy/request/servers.proto\x12%chef.automate.api.infra_proxy.request\"e\n" +
	...
	"\x04fqdn\x18\x01 \x01(\tR\x04fqdnB;Z9github.com/chef/automate/api/external/infra_proxy/requestb\x06proto3"

var (
	file_external_infra_proxy_request_servers_proto_rawDescOnce sync.Once
	file_external_infra_proxy_request_servers_proto_rawDescData []byte
)
...
func file_external_infra_proxy_request_servers_proto_rawDescGZIP() []byte {
	file_external_infra_proxy_request_servers_proto_rawDescOnce.Do(func() {
		file_external_infra_proxy_request_servers_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_external_infra_proxy_request_servers_proto_rawDesc), len(file_external_infra_proxy_request_servers_proto_rawDesc)))
	})
...
func file_external_infra_proxy_request_servers_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_external_infra_proxy_request_servers_proto_rawDesc), len(file_external_infra_proxy_request_servers_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
