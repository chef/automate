...
var file_external_infra_proxy_request_nodes_proto_depIdxs = []int32{
	6, // 0: chef.automate.api.infra_proxy.request.Nodes.search_query:type_name -> chef.automate.api.infra_proxy.request.SearchQuery
	7, // 1: chef.automate.api.infra_proxy.request.NodeDetails.automatic_attributes:type_name -> google.protobuf.Struct
	7, // 2: chef.automate.api.infra_proxy.request.NodeDetails.default_attributes:type_name -> google.protobuf.Struct
	7, // 3: chef.automate.api.infra_proxy.request.NodeDetails.normal_attributes:type_name -> google.protobuf.Struct
	7, // 4: chef.automate.api.infra_proxy.request.NodeDetails.override_attributes:type_name -> google.protobuf.Struct
	7, // 5: chef.automate.api.infra_proxy.request.UpdateNodeAttributes.attributes:type_name -> google.protobuf.Struct
