...
const file_external_infra_proxy_request_databags_proto_rawDesc = "" +
	"\n" +
	"+external/infra_proxy/request/databags.proto\x12%chef.automate.api.infra_proxy.request\x1a\x1cgoogle/protobuf/struct.proto\x1a)external/infra_proxy/request/common.proto\">\n" +
	"\bDataBags\x12\x15\n" +
	...
	"\fsearch_query\x18\x04 \x01(\v22.chef.automate.api.infra_proxy.request.SearchQueryR\vsearchQuery\"i\n" +
	...
	"\x04data\x18\x05 \x01(\v2\x17.google.protobuf.StructR\x04dataB;Z9github.com/chef/automate/api/external/infra_proxy/requestb\x06proto3"

var (
	file_external_infra_proxy_request_databags_proto_rawDescOnce sync.Once
	file_external_infra_proxy_request_databags_proto_rawDescData []byte
)
...
func file_external_infra_proxy_request_databags_proto_rawDescGZIP() []byte {
	file_external_infra_proxy_request_databags_proto_rawDescOnce.Do(func() {
		file_external_infra_proxy_request_databags_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_external_infra_proxy_request_databags_proto_rawDesc), len(file_external_infra_proxy_request_databags_proto_rawDesc)))
	})
...
func file_external_infra_proxy_request_databags_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_external_infra_proxy_request_databags_proto_rawDesc), len(file_external_infra_proxy_request_databags_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
