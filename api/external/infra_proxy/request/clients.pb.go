...
const file_external_infra_proxy_request_clients_proto_rawDesc = "" +
	"\n" +
	"*external/infra_proxy/request/clients.proto\x12%chef.automate.api.infra_proxy.request\x1a)external/infra_proxy/request/common.proto\"\x94\x01\n" +
	"\aClients\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x12\x1b\n" +
	"\tserver_id\x18\x02 \x01(\tR\bserverId\x12U\n" +
	"\fsearch_query\x18\x03 \x01(\v22.chef.automate.api.infra_proxy.request.SearchQueryR\vsearchQuery\"P\n" +
	"\x06Client\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x12\x1b\n" +
	...
	"\x03key\x18\x04 \x01(\tR\x03keyB;Z9github.com/chef/automate/api/external/infra_proxy/requestb\x06proto3"

var (
	file_external_infra_proxy_request_clients_proto_rawDescOnce sync.Once
	file_external_infra_proxy_request_clients_proto_rawDescData []byte
)
...
func file_external_infra_proxy_request_clients_proto_rawDescGZIP() []byte {
	file_external_infra_proxy_request_clients_proto_rawDescOnce.Do(func() {
		file_external_infra_proxy_request_clients_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_external_infra_proxy_request_clients_proto_rawDesc), len(file_external_infra_proxy_request_clients_proto_rawDesc)))
	})
...
func file_external_infra_proxy_request_clients_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_external_infra_proxy_request_clients_proto_rawDesc), len(file_external_infra_proxy_request_clients_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
