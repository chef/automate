...
func (x *GetInfraServerOrgs) Reset() {
	*x = GetInfraServerOrgs{}
	if protoimpl.UnsafeEnabled {
		mi := &file_external_infra_proxy_request_orgs_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetInfraServerOrgs) Descriptor() ([]byte, []int) {
	return file_external_infra_proxy_request_orgs_proto_rawDescGZIP(), []int{6}
}
...
func file_external_infra_proxy_request_orgs_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_external_infra_proxy_request_orgs_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
