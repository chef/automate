...
func request_InfraProxy_GetAutomateInfraServerOrgs_0(ctx context.Context, marshaler runtime.Marshaler, client InfraProxyClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.AutomateInfraServerOrgs
	var metadata runtime.ServerMetadata
	...
	msg, err := client.GetAutomateInfraServerOrgs(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_InfraProxy_GetAutomateInfraServerOrgs_0(ctx context.Context, marshaler runtime.Marshaler, server InfraProxyServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.AutomateInfraServerOrgs
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetAutomateInfraServerOrgs(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterInfraProxyHandlerServer(ctx context.Context, mux *runtime.ServeMux, server InfraProxyServer) error {
	...
	mux.Handle("POST", pattern_InfraProxy_GetAutomateInfraServerOrgs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_InfraProxy_GetAutomateInfraServerOrgs_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_InfraProxy_GetAutomateInfraServerOrgs_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterInfraProxyHandlerClient(ctx context.Context, mux *runtime.ServeMux, client InfraProxyClient) error {
	...
	mux.Handle("POST", pattern_InfraProxy_GetAutomateInfraServerOrgs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_InfraProxy_GetAutomateInfraServerOrgs_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_InfraProxy_GetAutomateInfraServerOrgs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"api", "v0", "infra", "servers", "server_id", "automateinfraserverorgs"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	...
	forward_InfraProxy_GetAutomateInfraServerOrgs_0 = runtime.ForwardResponseMessage
)
