...
var file_external_infra_proxy_infra_proxy_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xb0, 0x6c, 0x0a,
...
var file_external_infra_proxy_infra_proxy_proto_goTypes = []interface{}{
	...
	(*request.UpdateNodeTags)(nil),          // 39: chef.automate.api.infra_proxy.request.UpdateNodeTags
	(*request.UpdateNodeEnvironment)(nil),   // 40: chef.automate.api.infra_proxy.request.UpdateNodeEnvironment
	(*request.Policyfiles)(nil),             // 41: chef.automate.api.infra_proxy.request.Policyfiles
	(*request.Policyfile)(nil),              // 42: chef.automate.api.infra_proxy.request.Policyfile
	(*response.GetServers)(nil),             // 43: chef.automate.api.infra_proxy.response.GetServers
	(*response.GetServer)(nil),              // 44: chef.automate.api.infra_proxy.response.GetServer
	(*response.CreateServer)(nil),           // 45: chef.automate.api.infra_proxy.response.CreateServer
	(*response.UpdateServer)(nil),           // 46: chef.automate.api.infra_proxy.response.UpdateServer
	(*response.DeleteServer)(nil),           // 47: chef.automate.api.infra_proxy.response.DeleteServer
	(*response.GetOrgs)(nil),                // 48: chef.automate.api.infra_proxy.response.GetOrgs
	(*response.GetOrg)(nil),                 // 49: chef.automate.api.infra_proxy.response.GetOrg
	(*response.CreateOrg)(nil),              // 50: chef.automate.api.infra_proxy.response.CreateOrg
	(*response.UpdateOrg)(nil),              // 51: chef.automate.api.infra_proxy.response.UpdateOrg
	(*response.DeleteOrg)(nil),              // 52: chef.automate.api.infra_proxy.response.DeleteOrg
	(*response.ResetOrgAdminKey)(nil),       // 53: chef.automate.api.infra_proxy.response.ResetOrgAdminKey
	(*response.Cookbooks)(nil),              // 54: chef.automate.api.infra_proxy.response.Cookbooks
	(*response.CookbookVersions)(nil),       // 55: chef.automate.api.infra_proxy.response.CookbookVersions
	(*response.Cookbook)(nil),               // 56: chef.automate.api.infra_proxy.response.Cookbook
	(*response.CookbookFileContent)(nil),    // 57: chef.automate.api.infra_proxy.response.CookbookFileContent
	(*response.Roles)(nil),                  // 58: chef.automate.api.infra_proxy.response.Roles
	(*response.Role)(nil),                   // 59: chef.automate.api.infra_proxy.response.Role
	(*response.ExpandedRunList)(nil),        // 60: chef.automate.api.infra_proxy.response.ExpandedRunList
	(*response.RoleEnvironments)(nil),       // 61: chef.automate.api.infra_proxy.response.RoleEnvironments
	(*response.Clients)(nil),                // 62: chef.automate.api.infra_proxy.response.Clients
	(*response.Client)(nil),                 // 63: chef.automate.api.infra_proxy.response.Client
	(*response.CreateClient)(nil),           // 64: chef.automate.api.infra_proxy.response.CreateClient
	(*response.ResetClient)(nil),            // 65: chef.automate.api.infra_proxy.response.ResetClient
	(*response.DataBags)(nil),               // 66: chef.automate.api.infra_proxy.response.DataBags
	(*response.DataBagItems)(nil),           // 67: chef.automate.api.infra_proxy.response.DataBagItems
	(*response.DataBagItem)(nil),            // 68: chef.automate.api.infra_proxy.response.DataBagItem
	(*response.CreateDataBag)(nil),          // 69: chef.automate.api.infra_proxy.response.CreateDataBag
	(*response.CreateDataBagItem)(nil),      // 70: chef.automate.api.infra_proxy.response.CreateDataBagItem
	(*response.DataBag)(nil),                // 71: chef.automate.api.infra_proxy.response.DataBag
	(*response.UpdateDataBagItem)(nil),      // 72: chef.automate.api.infra_proxy.response.UpdateDataBagItem
	(*response.Environments)(nil),           // 73: chef.automate.api.infra_proxy.response.Environments
	(*response.Environment)(nil),            // 74: chef.automate.api.infra_proxy.response.Environment
	(*response.EnvironmentRecipesList)(nil), // 75: chef.automate.api.infra_proxy.response.EnvironmentRecipesList
	(*response.Nodes)(nil),                  // 76: chef.automate.api.infra_proxy.response.Nodes
	(*response.DeleteNode)(nil),             // 77: chef.automate.api.infra_proxy.response.DeleteNode
	(*response.Node)(nil),                   // 78: chef.automate.api.infra_proxy.response.Node
	(*response.UpdateNodeAttributes)(nil),   // 79: chef.automate.api.infra_proxy.response.UpdateNodeAttributes
	(*response.UpdateNodeTags)(nil),         // 80: chef.automate.api.infra_proxy.response.UpdateNodeTags
	(*response.UpdateNodeEnvironment)(nil),  // 81: chef.automate.api.infra_proxy.response.UpdateNodeEnvironment
	(*response.Policyfiles)(nil),            // 82: chef.automate.api.infra_proxy.response.Policyfiles
	(*response.Policyfile)(nil),             // 83: chef.automate.api.infra_proxy.response.Policyfile
}
var file_external_infra_proxy_infra_proxy_proto_depIdxs = []int32{
	...
	39, // 46: chef.automate.api.infra_proxy.InfraProxy.UpdateNodeTags:input_type -> chef.automate.api.infra_proxy.request.UpdateNodeTags
	40, // 47: chef.automate.api.infra_proxy.InfraProxy.UpdateNodeEnvironment:input_type -> chef.automate.api.infra_proxy.request.UpdateNodeEnvironment
	41, // 48: chef.automate.api.infra_proxy.InfraProxy.GetPolicyfiles:input_type -> chef.automate.api.infra_proxy.request.Policyfiles
	42, // 49: chef.automate.api.infra_proxy.InfraProxy.GetPolicyfile:input_type -> chef.automate.api.infra_proxy.request.Policyfile
	43, // 50: chef.automate.api.infra_proxy.InfraProxy.GetServers:output_type -> chef.automate.api.infra_proxy.response.GetServers
	44, // 51: chef.automate.api.infra_proxy.InfraProxy.GetServer:output_type -> chef.automate.api.infra_proxy.response.GetServer
	45, // 52: chef.automate.api.infra_proxy.InfraProxy.CreateServer:output_type -> chef.automate.api.infra_proxy.response.CreateServer
	46, // 53: chef.automate.api.infra_proxy.InfraProxy.UpdateServer:output_type -> chef.automate.api.infra_proxy.response.UpdateServer
	47, // 54: chef.automate.api.infra_proxy.InfraProxy.DeleteServer:output_type -> chef.automate.api.infra_proxy.response.DeleteServer
	48, // 55: chef.automate.api.infra_proxy.InfraProxy.GetOrgs:output_type -> chef.automate.api.infra_proxy.response.GetOrgs
	49, // 56: chef.automate.api.infra_proxy.InfraProxy.GetOrg:output_type -> chef.automate.api.infra_proxy.response.GetOrg
	50, // 57: chef.automate.api.infra_proxy.InfraProxy.CreateOrg:output_type -> chef.automate.api.infra_proxy.response.CreateOrg
	51, // 58: chef.automate.api.infra_proxy.InfraProxy.UpdateOrg:output_type -> chef.automate.api.infra_proxy.response.UpdateOrg
	52, // 59: chef.automate.api.infra_proxy.InfraProxy.DeleteOrg:output_type -> chef.automate.api.infra_proxy.response.DeleteOrg
	53, // 60: chef.automate.api.infra_proxy.InfraProxy.ResetOrgAdminKey:output_type -> chef.automate.api.infra_proxy.response.ResetOrgAdminKey
	54, // 61: chef.automate.api.infra_proxy.InfraProxy.GetCookbooks:output_type -> chef.automate.api.infra_proxy.response.Cookbooks
	55, // 62: chef.automate.api.infra_proxy.InfraProxy.GetCookbookVersions:output_type -> chef.automate.api.infra_proxy.response.CookbookVersions
	56, // 63: chef.automate.api.infra_proxy.InfraProxy.GetCookbook:output_type -> chef.automate.api.infra_proxy.response.Cookbook
	57, // 64: chef.automate.api.infra_proxy.InfraProxy.GetCookbookFileContent:output_type -> chef.automate.api.infra_proxy.response.CookbookFileContent
	58, // 65: chef.automate.api.infra_proxy.InfraProxy.GetRoles:output_type -> chef.automate.api.infra_proxy.response.Roles
	59, // 66: chef.automate.api.infra_proxy.InfraProxy.GetRole:output_type -> chef.automate.api.infra_proxy.response.Role
	60, // 67: chef.automate.api.infra_proxy.InfraProxy.GetRoleExpandedRunList:output_type -> chef.automate.api.infra_proxy.response.ExpandedRunList
	61, // 68: chef.automate.api.infra_proxy.InfraProxy.GetRoleEnvironments:output_type -> chef.automate.api.infra_proxy.response.RoleEnvironments
	59, // 69: chef.automate.api.infra_proxy.InfraProxy.CreateRole:output_type -> chef.automate.api.infra_proxy.response.Role
	59, // 70: chef.automate.api.infra_proxy.InfraProxy.DeleteRole:output_type -> chef.automate.api.infra_proxy.response.Role
	59, // 71: chef.automate.api.infra_proxy.InfraProxy.UpdateRole:output_type -> chef.automate.api.infra_proxy.response.Role
	62, // 72: chef.automate.api.infra_proxy.InfraProxy.GetClients:output_type -> chef.automate.api.infra_proxy.response.Clients
	63, // 73: chef.automate.api.infra_proxy.InfraProxy.GetClient:output_type -> chef.automate.api.infra_proxy.response.Client
	64, // 74: chef.automate.api.infra_proxy.InfraProxy.CreateClient:output_type -> chef.automate.api.infra_proxy.response.CreateClient
	63, // 75: chef.automate.api.infra_proxy.InfraProxy.DeleteClient:output_type -> chef.automate.api.infra_proxy.response.Client
	65, // 76: chef.automate.api.infra_proxy.InfraProxy.ResetClientKey:output_type -> chef.automate.api.infra_proxy.response.ResetClient
	66, // 77: chef.automate.api.infra_proxy.InfraProxy.GetDataBags:output_type -> chef.automate.api.infra_proxy.response.DataBags
	67, // 78: chef.automate.api.infra_proxy.InfraProxy.GetDataBagItems:output_type -> chef.automate.api.infra_proxy.response.DataBagItems
	68, // 79: chef.automate.api.infra_proxy.InfraProxy.GetDataBagItem:output_type -> chef.automate.api.infra_proxy.response.DataBagItem
	69, // 80: chef.automate.api.infra_proxy.InfraProxy.CreateDataBag:output_type -> chef.automate.api.infra_proxy.response.CreateDataBag
	70, // 81: chef.automate.api.infra_proxy.InfraProxy.CreateDataBagItem:output_type -> chef.automate.api.infra_proxy.response.CreateDataBagItem
	71, // 82: chef.automate.api.infra_proxy.InfraProxy.DeleteDataBag:output_type -> chef.automate.api.infra_proxy.response.DataBag
	68, // 83: chef.automate.api.infra_proxy.InfraProxy.DeleteDataBagItem:output_type -> chef.automate.api.infra_proxy.response.DataBagItem
	72, // 84: chef.automate.api.infra_proxy.InfraProxy.UpdateDataBagItem:output_type -> chef.automate.api.infra_proxy.response.UpdateDataBagItem
	73, // 85: chef.automate.api.infra_proxy.InfraProxy.GetEnvironments:output_type -> chef.automate.api.infra_proxy.response.Environments
	74, // 86: chef.automate.api.infra_proxy.InfraProxy.GetEnvironment:output_type -> chef.automate.api.infra_proxy.response.Environment
	74, // 87: chef.automate.api.infra_proxy.InfraProxy.CreateEnvironment:output_type -> chef.automate.api.infra_proxy.response.Environment
	74, // 88: chef.automate.api.infra_proxy.InfraProxy.DeleteEnvironment:output_type -> chef.automate.api.infra_proxy.response.Environment
	74, // 89: chef.automate.api.infra_proxy.InfraProxy.UpdateEnvironment:output_type -> chef.automate.api.infra_proxy.response.Environment
	75, // 90: chef.automate.api.infra_proxy.InfraProxy.GetEnvironmentRecipes:output_type -> chef.automate.api.infra_proxy.response.EnvironmentRecipesList
	76, // 91: chef.automate.api.infra_proxy.InfraProxy.GetNodes:output_type -> chef.automate.api.infra_proxy.response.Nodes
	77, // 92: chef.automate.api.infra_proxy.InfraProxy.DeleteNode:output_type -> chef.automate.api.infra_proxy.response.DeleteNode
	78, // 93: chef.automate.api.infra_proxy.InfraProxy.UpdateNode:output_type -> chef.automate.api.infra_proxy.response.Node
	79, // 94: chef.automate.api.infra_proxy.InfraProxy.UpdateNodeAttributes:output_type -> chef.automate.api.infra_proxy.response.UpdateNodeAttributes
	78, // 95: chef.automate.api.infra_proxy.InfraProxy.GetNode:output_type -> chef.automate.api.infra_proxy.response.Node
	80, // 96: chef.automate.api.infra_proxy.InfraProxy.UpdateNodeTags:output_type -> chef.automate.api.infra_proxy.response.UpdateNodeTags
	81, // 97: chef.automate.api.infra_proxy.InfraProxy.UpdateNodeEnvironment:output_type -> chef.automate.api.infra_proxy.response.UpdateNodeEnvironment
	82, // 98: chef.automate.api.infra_proxy.InfraProxy.GetPolicyfiles:output_type -> chef.automate.api.infra_proxy.response.Policyfiles
	83, // 99: chef.automate.api.infra_proxy.InfraProxy.GetPolicyfile:output_type -> chef.automate.api.infra_proxy.response.Policyfile
