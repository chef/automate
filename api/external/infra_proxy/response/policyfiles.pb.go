...
func (x *DeletePolicyfile) GetRevisionId() string {
	if x != nil {
		return x.RevisionId
	}
	return ""
...
var file_external_infra_proxy_response_policyfiles_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x07, 0x72, 0x75, 0x6e, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x33, 0x0a, 0x10, 0x44,
...
var file_external_infra_proxy_response_policyfiles_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_external_infra_proxy_response_policyfiles_proto_goTypes = []interface{}{
	...
	(*ExpandedRunList)(nil),    // 9: chef.automate.api.infra_proxy.response.ExpandedRunList
}
var file_external_infra_proxy_response_policyfiles_proto_depIdxs = []int32{
	...
	9, // 4: chef.automate.api.infra_proxy.response.Policyfile.expanded_run_list:type_name -> chef.automate.api.infra_proxy.response.ExpandedRunList
