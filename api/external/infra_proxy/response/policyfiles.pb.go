...
var file_external_infra_proxy_response_policyfiles_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x65, 0x22, 0x84, 0x01, 0x0a, 0x0b, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x67, 0x72,
...
var file_external_infra_proxy_response_policyfiles_proto_goTypes = []interface{}{
	...
	(*Policygroup)(nil),        // 9: chef.automate.api.infra_proxy.response.Policygroup
	(*GroupPolicy)(nil),        // 10: chef.automate.api.infra_proxy.response.GroupPolicy
...
var file_external_infra_proxy_response_policyfiles_proto_depIdxs = []int32{
	...
	10, // 8: chef.automate.api.infra_proxy.response.Policygroup.policies:type_name -> chef.automate.api.infra_proxy.response.GroupPolicy
