...
const file_external_infra_proxy_response_policyfiles_proto_rawDesc = "" +
	"\n" +
	"/external/infra_proxy/response/policyfiles.proto\x12&chef.automate.api.infra_proxy.response\x1a)external/infra_proxy/response/roles.proto\"e\n" +
	"\vPolicyfiles\x12V\n" +
	"\bpolicies\x18\x01 \x03(\v2:.chef.automate.api.infra_proxy.response.PolicyfileListItemR\bpolicies\"l\n" +
	"\x12PolicyfileListItem\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1f\n" +
	"\vrevision_id\x18\x03 \x01(\tR\n" +
	"revisionId\x12!\n" +
	"\fpolicy_group\x18\x02 \x01(\tR\vpolicyGroup\"\xde\x05\n" +
	"\n" +
	"Policyfile\x12\x12\n" +
	...
	"\vrevision_id\x18\x03 \x01(\tR\n" +
	"revisionId\x12\x19\n" +
	"\brun_list\x18\x04 \x03(\tR\arunList\x12Z\n" +
	"\x0enamed_run_list\x18\x05 \x03(\v24.chef.automate.api.infra_proxy.response.NamedRunListR\fnamedRunList\x12n\n" +
	"\x15included_policy_locks\x18\x06 \x03(\v2:.chef.automate.api.infra_proxy.response.IncludedPolicyLockR\x13includedPolicyLocks\x12[\n" +
	"\x0ecookbook_locks\x18\a \x03(\v24.chef.automate.api.infra_proxy.response.CookbookLockR\rcookbookLocks\x12-\n" +
	"\x12default_attributes\x18\b \x01(\tR\x11defaultAttributes\x12/\n" +
	"\x13override_attributes\x18\t \x01(\tR\x12overrideAttributes\x12c\n" +
	"\x11expanded_run_list\x18\n" +
	" \x03(\v27.chef.automate.api.infra_proxy.response.ExpandedRunListR\x0fexpandedRunList\x12o\n" +
	"\x14solution_dependecies\x18\v \x03(\v2<.chef.automate.api.infra_proxy.response.SolutionDependenciesR\x13solutionDependecies\"\xa1\x01\n" +
	"\x14SolutionDependencies\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x18\n" +
	"\aversion\x18\x02 \x01(\tR\aversion\x12[\n" +
	"\fdependencies\x18\x03 \x03(\v27.chef.automate.api.infra_proxy.response.DepedenciesDataR\fdependencies\"?\n" +
	"\x0fDepedenciesData\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x18\n" +
	"\aversion\x18\x02 \x01(\tR\aversion\"\xa7\x01\n" +
	"\x12IncludedPolicyLock\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1f\n" +
	"\vrevision_id\x18\x02 \x01(\tR\n" +
	"revisionId\x12\\\n" +
	"\x0esource_options\x18\x03 \x01(\v25.chef.automate.api.infra_proxy.response.SourceOptionsR\rsourceOptions\"\xed\x02\n" +
	...
	"\tcache_key\x18\x06 \x01(\tR\bcacheKey\x12O\n" +
	"\tSCMDetail\x18\a \x01(\v21.chef.automate.api.infra_proxy.response.SCMDetailR\tSCMDetail\x12\\\n" +
	"\x0esource_options\x18\b \x01(\v25.chef.automate.api.infra_proxy.response.SourceOptionsR\rsourceOptions\"\xe1\x01\n" +
	"\tSCMDetail\x12\x12\n" +
	...
	"\x13PolicyfileRevisions\x12X\n" +
	"\trevisions\x18\x01 \x03(\v2:.chef.automate.api.infra_proxy.response.PolicyfileRevisionR\trevisions\"5\n" +
	"\x12PolicyfileRevision\x12\x1f\n" +
	"\vrevision_id\x18\x01 \x01(\tR\n" +
	"revisionId\"\x84\x01\n" +
	"\vPolicygroup\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12O\n" +
	"\bpolicies\x18\x02 \x03(\v23.chef.automate.api.infra_proxy.response.GroupPolicyR\bpolicies\x12\x10\n" +
	"\x03uri\x18\x03 \x01(\tR\x03uri\"B\n" +
	"\vGroupPolicy\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1f\n" +
	"\vrevision_id\x18\x02 \x01(\tR\n" +
	"revisionIdB<Z:github.com/chef/automate/api/external/infra_proxy/responseb\x06proto3"

var (
	file_external_infra_proxy_response_policyfiles_proto_rawDescOnce sync.Once
	file_external_infra_proxy_response_policyfiles_proto_rawDescData []byte
)
...
func file_external_infra_proxy_response_policyfiles_proto_rawDescGZIP() []byte {
	file_external_infra_proxy_response_policyfiles_proto_rawDescOnce.Do(func() {
		file_external_infra_proxy_response_policyfiles_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_external_infra_proxy_response_policyfiles_proto_rawDesc), len(file_external_infra_proxy_response_policyfiles_proto_rawDesc)))
	})
...
func file_external_infra_proxy_response_policyfiles_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_external_infra_proxy_response_policyfiles_proto_rawDesc), len(file_external_infra_proxy_response_policyfiles_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   15,
			NumExtensions: 0,
			NumServices:   0,
