...
const file_external_infra_proxy_response_clients_proto_rawDesc = "" +
	"\n" +
	"+external/infra_proxy/response/clients.proto\x12&chef.automate.api.infra_proxy.response\"\x85\x01\n" +
	"\aClients\x12P\n" +
	"\aclients\x18\x01 \x03(\v26.chef.automate.api.infra_proxy.response.ClientListItemR\aclients\x12\x12\n" +
	"\x04page\x18\x02 \x01(\x05R\x04page\x12\x14\n" +
	"\x05total\x18\x03 \x01(\x05R\x05total\"B\n" +
	"\x0eClientListItem\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1c\n" +
	"\tvalidator\x18\x02 \x01(\bR\tvalidator\"\x8a\x02\n" +
	"\x06Client\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1f\n" +
	"\vclient_name\x18\x02 \x01(\tR\n" +
	"clientName\x12\x19\n" +
	"\borg_name\x18\x03 \x01(\tR\aorgName\x12\x1c\n" +
	"\tvalidator\x18\x04 \x01(\bR\tvalidator\x12\x1d\n" +
	"\n" +
	"json_class\x18\x05 \x01(\tR\tjsonClass\x12\x1b\n" +
	"\tchef_type\x18\x06 \x01(\tR\bchefType\x12V\n" +
	"\n" +
	"client_key\x18\a \x01(\v27.chef.automate.api.infra_proxy.response.ClientAccessKeyR\tclientKey\"t\n" +
	"\fCreateClient\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12P\n" +
	"\n" +
	"client_key\x18\x02 \x01(\v21.chef.automate.api.infra_proxy.response.ClientKeyR\tclientKey\"s\n" +
	"\vResetClient\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12P\n" +
	"\n" +
	"client_key\x18\x02 \x01(\v21.chef.automate.api.infra_proxy.response.ClientKeyR\tclientKey\"\x88\x01\n" +
	"\tClientKey\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1d\n" +
	"\n" +
	"public_key\x18\x02 \x01(\tR\tpublicKey\x12'\n" +
	"\x0fexpiration_date\x18\x03 \x01(\tR\x0eexpirationDate\x12\x1f\n" +
	"\vprivate_key\x18\x04 \x01(\tR\n" +
	"privateKey\"m\n" +
	"\x0fClientAccessKey\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1d\n" +
	"\n" +
	"public_key\x18\x02 \x01(\tR\tpublicKey\x12'\n" +
	"\x0fexpiration_date\x18\x03 \x01(\tR\x0eexpirationDateB<Z:github.com/chef/automate/api/external/infra_proxy/responseb\x06proto3"

var (
	file_external_infra_proxy_response_clients_proto_rawDescOnce sync.Once
	file_external_infra_proxy_response_clients_proto_rawDescData []byte
)
...
func file_external_infra_proxy_response_clients_proto_rawDescGZIP() []byte {
	file_external_infra_proxy_response_clients_proto_rawDescOnce.Do(func() {
		file_external_infra_proxy_response_clients_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_external_infra_proxy_response_clients_proto_rawDesc), len(file_external_infra_proxy_response_clients_proto_rawDesc)))
	})
...
func file_external_infra_proxy_response_clients_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_external_infra_proxy_response_clients_proto_rawDesc), len(file_external_infra_proxy_response_clients_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
