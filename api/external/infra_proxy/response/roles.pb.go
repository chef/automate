...
const file_external_infra_proxy_response_roles_proto_rawDesc = "" +
	"\n" +
	")external/infra_proxy/response/roles.proto\x12&chef.automate.api.infra_proxy.response\x1a*external/infra_proxy/response/common.proto\"}\n" +
	"\x05Roles\x12J\n" +
	"\x05roles\x18\x01 \x03(\v24.chef.automate.api.infra_proxy.response.RoleListItemR\x05roles\x12\x12\n" +
	...
	"\brun_list\x18\a \x03(\tR\arunList\"m\n" +
	"\x0fExpandedRunList\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12J\n" +
	"\brun_list\x18\x02 \x03(\v2/.chef.automate.api.infra_proxy.response.RunListR\arunList\"6\n" +
	"\x10RoleEnvironments\x12\"\n" +
	"\fenvironments\x18\x01 \x03(\tR\fenvironmentsB<Z:github.com/chef/automate/api/external/infra_proxy/responseb\x06proto3"

var (
	file_external_infra_proxy_response_roles_proto_rawDescOnce sync.Once
	file_external_infra_proxy_response_roles_proto_rawDescData []byte
)
...
func file_external_infra_proxy_response_roles_proto_rawDescGZIP() []byte {
	file_external_infra_proxy_response_roles_proto_rawDescOnce.Do(func() {
		file_external_infra_proxy_response_roles_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_external_infra_proxy_response_roles_proto_rawDesc), len(file_external_infra_proxy_response_roles_proto_rawDesc)))
	})
...
var file_external_infra_proxy_response_roles_proto_goTypes = []any{
...
func file_external_infra_proxy_response_roles_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_external_infra_proxy_response_roles_proto_rawDesc), len(file_external_infra_proxy_response_roles_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
