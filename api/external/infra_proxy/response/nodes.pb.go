...
const file_external_infra_proxy_response_nodes_proto_rawDesc = "" +
	"\n" +
	")external/infra_proxy/response/nodes.proto\x12&chef.automate.api.infra_proxy.response\x1a*external/infra_proxy/response/common.proto\"~\n" +
	"\x05Nodes\x12K\n" +
	"\x05nodes\x18\x01 \x03(\v25.chef.automate.api.infra_proxy.response.NodeAttributeR\x05nodes\x12\x12\n" +
	...
	"\brun_list\x18\x02 \x03(\v2/.chef.automate.api.infra_proxy.response.RunListR\arunListB<Z:github.com/chef/automate/api/external/infra_proxy/responseb\x06proto3"

var (
	file_external_infra_proxy_response_nodes_proto_rawDescOnce sync.Once
	file_external_infra_proxy_response_nodes_proto_rawDescData []byte
)
...
func file_external_infra_proxy_response_nodes_proto_rawDescGZIP() []byte {
	file_external_infra_proxy_response_nodes_proto_rawDescOnce.Do(func() {
		file_external_infra_proxy_response_nodes_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_external_infra_proxy_response_nodes_proto_rawDesc), len(file_external_infra_proxy_response_nodes_proto_rawDesc)))
	})
...
var file_external_infra_proxy_response_nodes_proto_goTypes = []any{
...
func file_external_infra_proxy_response_nodes_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_external_infra_proxy_response_nodes_proto_rawDesc), len(file_external_infra_proxy_response_nodes_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
