...
const file_external_infra_proxy_response_databags_proto_rawDesc = "" +
	"\n" +
	",external/infra_proxy/response/databags.proto\x12&chef.automate.api.infra_proxy.response\"`\n" +
	"\bDataBags\x12T\n" +
	"\tdata_bags\x18\x01 \x03(\v27.chef.automate.api.infra_proxy.response.DataBagListItemR\bdataBags\"\x9b\x01\n" +
	"\fDataBagItems\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12M\n" +
	"\x05items\x18\x02 \x03(\v27.chef.automate.api.infra_proxy.response.DataBagListItemR\x05items\x12\x12\n" +
	"\x04page\x18\x03 \x01(\x05R\x04page\x12\x14\n" +
	"\x05total\x18\x04 \x01(\x05R\x05total\"%\n" +
	"\x0fDataBagListItem\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"E\n" +
	"\vDataBagItem\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12\x12\n" +
	"\x04data\x18\x03 \x01(\tR\x04data\"\x1d\n" +
	"\aDataBag\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"#\n" +
	"\rCreateDataBag\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"7\n" +
	"\x11CreateDataBagItem\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\"@\n" +
	"\x11UpdateDataBagItem\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x17\n" +
	"\aitem_id\x18\x02 \x01(\tR\x06itemIdB<Z:github.com/chef/automate/api/external/infra_proxy/responseb\x06proto3"

var (
	file_external_infra_proxy_response_databags_proto_rawDescOnce sync.Once
	file_external_infra_proxy_response_databags_proto_rawDescData []byte
)
...
func file_external_infra_proxy_response_databags_proto_rawDescGZIP() []byte {
	file_external_infra_proxy_response_databags_proto_rawDescOnce.Do(func() {
		file_external_infra_proxy_response_databags_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_external_infra_proxy_response_databags_proto_rawDesc), len(file_external_infra_proxy_response_databags_proto_rawDesc)))
	})
...
var file_external_infra_proxy_response_databags_proto_goTypes = []any{
...
func file_external_infra_proxy_response_databags_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_external_infra_proxy_response_databags_proto_rawDesc), len(file_external_infra_proxy_response_databags_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
