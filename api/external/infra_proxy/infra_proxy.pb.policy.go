...
func init() {
	...
	policy.MapMethodTo("/chef.automate.api.infra_proxy.InfraProxy/ValidateWebuiKey", "infra:infraServers", "infra:infraServers:get", "POST", "/api/v0/infra/servers/validate/{fqdn}", func(unexpandedResource string, input interface{}) string {
