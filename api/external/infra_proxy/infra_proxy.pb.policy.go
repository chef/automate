...
func init() {
	...
	policy.MapMethodTo("/chef.automate.api.infra_proxy.InfraProxy/UpdateWebuiKey", "infra:infraServers", "infra:infraServers:update", "POST", "/api/v0/infra/servers/update", func(unexpandedResource string, input interface{}) string {
		if m, ok := input.(*request.UpdateWebuiKey); ok {
			return policy.ExpandParameterizedResource(unexpandedResource, func(want string) string {
				switch want {
				case "id":
					return m.Id
	...
	policy.MapMethodTo("/chef.automate.api.infra_proxy.InfraProxy/GetInfraServerOrgs", "infra:infraServers:{server_id}:infraserverorgs", "infra:infraServers:get", "GET", "/api/v0/infra/servers/{server_id}/infraserverorgs", func(unexpandedResource string, input interface{}) string {
		if m, ok := input.(*request.GetInfraServerOrgs); ok {
			return policy.ExpandParameterizedResource(unexpandedResource, func(want string) string {
				switch want {
				case "server_id":
					return m.ServerId
	...
	policy.MapMethodTo("/chef.automate.api.infra_proxy.InfraProxy/GetClients", "infra:infraServers:{server_id}:orgs:{org_id}:clients", "infra:infraServersOrgsClient:get", "GET", "/api/v0/infra/servers/{server_id}/orgs/{org_id}/clients", func(unexpandedResource string, input interface{}) string {
	...
	policy.MapMethodTo("/chef.automate.api.infra_proxy.InfraProxy/GetClient", "infra:servers:{server_id}:orgs:{org_id}:clients", "infra:infraServersOrgsClient:get", "GET", "/api/v0/infra/servers/{server_id}/orgs/{org_id}/clients/{name}", func(unexpandedResource string, input interface{}) string {
	...
	policy.MapMethodTo("/chef.automate.api.infra_proxy.InfraProxy/CreateClient", "infra:servers:{server_id}:orgs:{org_id}:clients", "infra:infraServersOrgsClient:create", "POST", "/api/v0/infra/servers/{server_id}/orgs/{org_id}/clients", func(unexpandedResource string, input interface{}) string {
	...
	policy.MapMethodTo("/chef.automate.api.infra_proxy.InfraProxy/DeleteClient", "infra:servers:{server_id}:orgs:{org_id}:clients", "infra:infraServersOrgsClient:delete", "DELETE", "/api/v0/infra/servers/{server_id}/orgs/{org_id}/clients/{name}", func(unexpandedResource string, input interface{}) string {
		if m, ok := input.(*request.Client); ok {
			return policy.ExpandParameterizedResource(unexpandedResource, func(want string) string {
				switch want {
				case "org_id":
	...
	policy.MapMethodTo("/chef.automate.api.infra_proxy.InfraProxy/ResetClientKey", "infra:servers:{server_id}:orgs:{org_id}:clients", "infra:infraServersOrgsClient:update", "PUT", "/api/v0/infra/servers/{server_id}/orgs/{org_id}/clients/{name}/reset", func(unexpandedResource string, input interface{}) string {
	...
	policy.MapMethodTo("/chef.automate.api.infra_proxy.InfraProxy/GetAutomateInfraServerUsersList", "infra:infraServers:{server_id}:automateinfraserverusers", "infra:infraServers:get", "GET", "/api/v0/infra/servers/{server_id}/automateinfraserverusers", func(unexpandedResource string, input interface{}) string {
		if m, ok := input.(*request.AutomateInfraServerUsers); ok {
			return policy.ExpandParameterizedResource(unexpandedResource, func(want string) string {
				switch want {
				case "server_id":
					return m.ServerId
	...
	policy.MapMethodTo("/chef.automate.api.infra_proxy.InfraProxy/GetAutomateInfraOrgUsersList", "infra:infraServers:{server_id}:orgs:{org_id}:users", "infra:infraServersOrgs:get", "GET", "/api/v0/infra/servers/{server_id}/org/{org_id}/users", func(unexpandedResource string, input interface{}) string {
		if m, ok := input.(*request.AutomateInfraOrgUsers); ok {
			return policy.ExpandParameterizedResource(unexpandedResource, func(want string) string {
				switch want {
				case "server_id":
					return m.ServerId
	...
	policy.MapMethodTo("/chef.automate.api.infra_proxy.InfraProxy/ResetInfraServerUserKey", "infra:infraServers", "infra:infraServersResetInfraServerUserKey:put", "PUT", "/api/v0/infra/servers/{server_id}/user/{user_name}", func(unexpandedResource string, input interface{}) string {
