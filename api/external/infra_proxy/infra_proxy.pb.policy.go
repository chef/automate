...
func init() {
	...
	policy.MapMethodTo("/chef.automate.api.infra_proxy.InfraProxy/ResetInfraServerUserKey", "iam:usersSelf:{user_name}", "iam:usersSelf:update", "PUT", "/api/v0/infra/servers/{server_id}/user/{user_name}", func(unexpandedResource string, input interface{}) string {
