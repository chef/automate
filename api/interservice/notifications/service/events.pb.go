...
const file_interservice_notifications_service_events_proto_rawDesc = "" +
	"\n" +
	"/interservice/notifications/service/events.proto\x12*chef.automate.domain.notifications.service\"k\n" +
	...
	"\bend_time\x18\x02 \x01(\tR\aendTime\"\xa9\x0e\n" +
	"\aProfile\x12\x12\n" +
	...
	"\x06sha256\x18\t \x01(\tR\x06sha256\x12W\n" +
	"\bsupports\x18\n" +
	" \x03(\v2;.chef.automate.domain.notifications.service.PlatformSupportR\bsupports\x12]\n" +
	"\n" +
	"attributes\x18\v \x03(\v2=.chef.automate.domain.notifications.service.Profile.AttributeR\n" +
	"attributes\x12d\n" +
	"\x0ffailed_controls\x18\f \x03(\v2;.chef.automate.domain.notifications.service.Profile.ControlR\x0efailedControls\x12W\n" +
	"\x05stats\x18\r \x01(\v2A.chef.automate.domain.notifications.service.Profile.ControlTotalsR\x05stats\x1a\xd0\x06\n" +
	"\aControl\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x16\n" +
	"\x06impact\x18\x02 \x01(\x02R\x06impact\x12\x14\n" +
	"\x05title\x18\x03 \x01(\tR\x05title\x12\x12\n" +
	"\x04code\x18\x04 \x01(\tR\x04code\x12\x12\n" +
	"\x04desc\x18\x05 \x01(\tR\x04desc\x12c\n" +
	"\x0fsource_location\x18\x06 \x01(\v2:.chef.automate.domain.notifications.service.SourceLocationR\x0esourceLocation\x12D\n" +
	"\x04refs\x18\a \x03(\v20.chef.automate.domain.notifications.service.RefsR\x04refs\x12i\n" +
	"\x0efailed_results\x18\t \x03(\v2B.chef.automate.domain.notifications.service.Profile.Control.ResultR\rfailedResults\x12^\n" +
	"\x05stats\x18\n" +
	" \x01(\v2H.chef.automate.domain.notifications.service.Profile.Control.ResultTotalsR\x05stats\x1a\xb4\x01\n" +
	"\x06Result\x12\x16\n" +
	...
	"\x10num_passed_tests\x18\x04 \x01(\x05R\x0enumPassedTestsJ\x04\b\b\x10\t\x1a\xad\x01\n" +
	"\tAttribute\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12_\n" +
	"\aoptions\x18\x02 \x01(\v2E.chef.automate.domain.notifications.service.Profile.Attribute.OptionsR\aoptions\x1a+\n" +
	"\aOptions\x12 \n" +
	...
	"\ttimestamp\x18\x06 \x01(\tR\ttimestamp\"\xcd\x04\n" +
	"\x11ComplianceFailure\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12%\n" +
	"\x0ecompliance_url\x18\x02 \x01(\tR\rcomplianceUrl\x12\x1b\n" +
	"\tnode_name\x18\x03 \x01(\tR\bnodeName\x12\x17\n" +
	"\anode_id\x18\x04 \x01(\tR\x06nodeId\x12%\n" +
	"\x0einspec_version\x18\x05 \x01(\tR\rinspecVersion\x12l\n" +
	"\vtest_totals\x18\x06 \x01(\v2K.chef.automate.domain.notifications.service.ComplianceFailure.ControlTotalsR\n" +
	"testTotals\x12\\\n" +
	"\x0ffailed_profiles\x18\a \x03(\v23.chef.automate.domain.notifications.service.ProfileR\x0efailedProfiles\x12\x19\n" +
	...
	"\x0fcritical_failed\x18\x05 \x01(\x05R\x0ecriticalFailed\"\xe9\x02\n" +
	"\n" +
	"CCRFailure\x12\x15\n" +
	...
	"\x06recipe\x18\x06 \x01(\tR\x06recipe\x12H\n" +
	"\x04time\x18\a \x01(\v24.chef.automate.domain.notifications.service.TimeInfoR\x04time\x12W\n" +
	"\texception\x18\b \x01(\v29.chef.automate.domain.notifications.service.ExceptionInfoR\texception\x12\x1c\n" +
	"\ttimestamp\x18\t \x01(\tR\ttimestamp\"\xf7\x01\n" +
	"\n" +
	"CCRSuccess\x12\x15\n" +
	"\x06run_id\x18\x01 \x01(\tR\x05runId\x12\x1b\n" +
	"\tnode_name\x18\x02 \x01(\tR\bnodeName\x12\x17\n" +
	"\arun_url\x18\x03 \x01(\tR\x06runUrl\x12H\n" +
	"\x04time\x18\x04 \x01(\v24.chef.automate.domain.notifications.service.TimeInfoR\x04time\x124\n" +
	...
	"\n" +
	"CCRSuccess\x18\x02 \x01(\v26.chef.automate.domain.notifications.service.CCRSuccessH\x00R\n" +
	"CCRSuccess\x12X\n" +
	"\n" +
	"CCRFailure\x18\x03 \x01(\v26.chef.automate.domain.notifications.service.CCRFailureH\x00R\n" +
	"CCRFailure\x12m\n" +
	"\x11ComplianceSuccess\x18\x04 \x01(\v2=.chef.automate.domain.notifications.service.ComplianceSuccessH\x00R\x11ComplianceSuccess\x12m\n" +
	"\x11ComplianceFailure\x18\x05 \x01(\v2=.chef.automate.domain.notifications.service.ComplianceFailureH\x00R\x11ComplianceFailureB\a\n" +
	"\x05eventBAZ?github.com/chef/automate/api/interservice/notifications/serviceb\x06proto3"

var (
	file_interservice_notifications_service_events_proto_rawDescOnce sync.Once
	file_interservice_notifications_service_events_proto_rawDescData []byte
)
...
func file_interservice_notifications_service_events_proto_rawDescGZIP() []byte {
	file_interservice_notifications_service_events_proto_rawDescOnce.Do(func() {
		file_interservice_notifications_service_events_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_interservice_notifications_service_events_proto_rawDesc), len(file_interservice_notifications_service_events_proto_rawDesc)))
	})
...
func file_interservice_notifications_service_events_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_interservice_notifications_service_events_proto_rawDesc), len(file_interservice_notifications_service_events_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   19,
			NumExtensions: 0,
			NumServices:   0,
