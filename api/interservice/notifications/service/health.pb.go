...
const file_interservice_notifications_service_health_proto_rawDesc = "" +
	"\n" +
	"/interservice/notifications/service/health.proto\x12*chef.automate.domain.notifications.service\"\x10\n" +
	"\x0eVersionRequest\"+\n" +
	"\x0fVersionResponse\x12\x18\n" +
	"\aversion\x18\x01 \x01(\tR\aversionBAZ?github.com/chef/automate/api/interservice/notifications/serviceb\x06proto3"

var (
	file_interservice_notifications_service_health_proto_rawDescOnce sync.Once
	file_interservice_notifications_service_health_proto_rawDescData []byte
)
...
func file_interservice_notifications_service_health_proto_rawDescGZIP() []byte {
	file_interservice_notifications_service_health_proto_rawDescOnce.Do(func() {
		file_interservice_notifications_service_health_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_interservice_notifications_service_health_proto_rawDesc), len(file_interservice_notifications_service_health_proto_rawDesc)))
	})
...
func file_interservice_notifications_service_health_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_interservice_notifications_service_health_proto_rawDesc), len(file_interservice_notifications_service_health_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
