...
func file_interservice_notifications_service_health_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_interservice_notifications_service_health_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_interservice_notifications_service_health_proto_msgTypes[1].Exporter = func(v any, i int) any {
