...
type ShowResponse struct {
	...
	EsPolicies     []*data_lifecycle.OsPolicy `protobuf:"bytes,3,rep,name=es_policies,json=esPolicies,proto3" json:"es_policies,omitempty" toml:"es_policies,omitempty" mapstructure:"es_policies,omitempty"`
...
func (x *ShowResponse) GetEsPolicies() []*data_lifecycle.OsPolicy {
	if x != nil {
		return x.EsPolicies
	}
	return nil
...
type PolicyUpdate struct {
	...
	Es []*data_lifecycle.OsPolicyUpdate `protobuf:"bytes,1,rep,name=es,proto3" json:"es,omitempty" toml:"es,omitempty" mapstructure:"es,omitempty"`
...
func (x *PolicyUpdate) GetEs() []*data_lifecycle.OsPolicyUpdate {
	if x != nil {
		return x.Es
	}
	return nil
...
var file_interservice_data_lifecycle_purge_proto_depIdxs = []int32{
	...
	7,  // 1: chef.automate.infra.data_lifecycle.api.ShowResponse.es_policies:type_name -> chef.automate.api.data_lifecycle.OsPolicy
	...
	10, // 7: chef.automate.infra.data_lifecycle.api.PolicyUpdate.es:type_name -> chef.automate.api.data_lifecycle.OsPolicyUpdate
