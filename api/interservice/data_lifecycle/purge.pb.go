...
const file_interservice_data_lifecycle_purge_proto_rawDesc = "" +
	"\n" +
	"'interservice/data_lifecycle/purge.proto\x12&chef.automate.infra.data_lifecycle.api\x1a\x1fgoogle/protobuf/timestamp.proto\x1a,external/data_lifecycle/data_lifecycle.proto\"\f\n" +
	"\n" +
	"RunRequest\"\r\n" +
	"\vRunResponse\"\xa7\x01\n" +
	"\x10ConfigureRequest\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12\x1e\n" +
	"\n" +
	"recurrence\x18\x02 \x01(\tR\n" +
	"recurrence\x12Y\n" +
	"\rpolicy_update\x18\x03 \x01(\v24.chef.automate.infra.data_lifecycle.api.PolicyUpdateR\fpolicyUpdate\"\x13\n" +
	"\x11ConfigureResponse\"\r\n" +
	"\vShowRequest\"\xa0\x04\n" +
	"\fShowResponse\x12#\n" +
	"\rinstance_name\x18\x01 \x01(\tR\finstanceName\x12#\n" +
	"\rworkflow_name\x18\x02 \x01(\tR\fworkflowName\x12K\n" +
	"\ves_policies\x18\x03 \x03(\v2*.chef.automate.api.data_lifecycle.EsPolicyR\n" +
	"esPolicies\x12K\n" +
	"\vpg_policies\x18\x04 \x03(\v2*.chef.automate.api.data_lifecycle.PgPolicyR\n" +
	"pgPolicies\x12\x1e\n" +
	"\n" +
	...
	"\blast_end\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\alastEnd\"\x92\x01\n" +
	"\fPolicyUpdate\x12@\n" +
	"\x02es\x18\x01 \x03(\v20.chef.automate.api.data_lifecycle.EsPolicyUpdateR\x02es\x12@\n" +
	"\x02pg\x18\x02 \x03(\v20.chef.automate.api.data_lifecycle.PgPolicyUpdateR\x02pg2\xed\x02\n" +
	"\x05Purge\x12n\n" +
	"\x03Run\x122.chef.automate.infra.data_lifecycle.api.RunRequest\x1a3.chef.automate.infra.data_lifecycle.api.RunResponse\x12\x80\x01\n" +
	"\tConfigure\x128.chef.automate.infra.data_lifecycle.api.ConfigureRequest\x1a9.chef.automate.infra.data_lifecycle.api.ConfigureResponse\x12q\n" +
	"\x04Show\x123.chef.automate.infra.data_lifecycle.api.ShowRequest\x1a4.chef.automate.infra.data_lifecycle.api.ShowResponseB:Z8github.com/chef/automate/api/interservice/data_lifecycleb\x06proto3"

var (
	file_interservice_data_lifecycle_purge_proto_rawDescOnce sync.Once
	file_interservice_data_lifecycle_purge_proto_rawDescData []byte
)
...
func file_interservice_data_lifecycle_purge_proto_rawDescGZIP() []byte {
	file_interservice_data_lifecycle_purge_proto_rawDescOnce.Do(func() {
		file_interservice_data_lifecycle_purge_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_interservice_data_lifecycle_purge_proto_rawDesc), len(file_interservice_data_lifecycle_purge_proto_rawDesc)))
	})
...
func file_interservice_data_lifecycle_purge_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_interservice_data_lifecycle_purge_proto_rawDesc), len(file_interservice_data_lifecycle_purge_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
