...
const file_interservice_teams_teams_proto_rawDesc = "" +
	"\n" +
	"\x1einterservice/teams/teams.proto\x12\x1achef.automate.domain.teams\x1a\x1cgoogle/api/annotations.proto\x1a\x17validate/validate.proto\x1a%external/common/version/version.proto\"F\n" +
	"\x04Team\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x1a\n" +
	"\bprojects\x18\x03 \x03(\tR\bprojects\"'\n" +
	"\n" +
	"GetTeamReq\x12\x19\n" +
	"\x02id\x18\x01 \x01(\tB\t\xfaB\x06r\x042\x02\\SR\x02id\"C\n" +
	"\vGetTeamResp\x124\n" +
	"\x04team\x18\x01 \x01(\v2 .chef.automate.domain.teams.TeamR\x04team\"\x0e\n" +
	"\fListTeamsReq\"G\n" +
	"\rListTeamsResp\x126\n" +
	"\x05teams\x18\x01 \x03(\v2 .chef.automate.domain.teams.TeamR\x05teams\"|\n" +
	"\rUpdateTeamReq\x12\x19\n" +
	"\x02id\x18\x01 \x01(\tB\t\xfaB\x06r\x042\x02\\SR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12<\n" +
	"\bprojects\x18\x03 \x03(\tB \xfaB\x1d\x92\x01\x1a\x18\x01\"\x16r\x142\x12^[a-z0-9-_]{1,64}$R\bprojects\"F\n" +
	"\x0eUpdateTeamResp\x124\n" +
	"\x04team\x18\x01 \x01(\v2 .chef.automate.domain.teams.TeamR\x04team\"*\n" +
	"\rDeleteTeamReq\x12\x19\n" +
	"\x02id\x18\x01 \x01(\tB\t\xfaB\x06r\x042\x02\\SR\x02id\"F\n" +
	"\x0eDeleteTeamResp\x124\n" +
	"\x04team\x18\x01 \x01(\v2 .chef.automate.domain.teams.TeamR\x04team\"\x8c\x01\n" +
	"\rCreateTeamReq\x12)\n" +
	"\x02id\x18\x01 \x01(\tB\x19\xfaB\x16r\x142\x12^[a-z0-9-_]{1,64}$R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12<\n" +
	"\bprojects\x18\x03 \x03(\tB \xfaB\x1d\x92\x01\x1a\x18\x01\"\x16r\x142\x12^[a-z0-9-_]{1,64}$R\bprojects\"F\n" +
	"\x0eCreateTeamResp\x124\n" +
	"\x04team\x18\x01 \x01(\v2 .chef.automate.domain.teams.TeamR\x04team\"n\n" +
	"\x11AddTeamMembersReq\x12\x19\n" +
	"\x02id\x18\x01 \x01(\tB\t\xfaB\x06r\x042\x02\\SR\x02id\x12>\n" +
	"\buser_ids\x18\x02 \x03(\tB#\xfaB \x92\x01\x1d\b\x01\x18\x01\"\x17r\x152\x13^[[:alnum:]_.+@-]+$R\auserIds\"/\n" +
	"\x12AddTeamMembersResp\x12\x19\n" +
	"\buser_ids\x18\x01 \x03(\tR\auserIds\"q\n" +
	"\x14RemoveTeamMembersReq\x12\x19\n" +
	"\x02id\x18\x01 \x01(\tB\t\xfaB\x06r\x042\x02\\SR\x02id\x12>\n" +
	"\buser_ids\x18\x02 \x03(\tB#\xfaB \x92\x01\x1d\b\x01\x18\x01\"\x17r\x152\x13^[[:alnum:]_.+@-]+$R\auserIds\"2\n" +
	"\x15RemoveTeamMembersResp\x12\x19\n" +
	"\buser_ids\x18\x01 \x03(\tR\auserIds\"K\n" +
	"\x14GetTeamsForMemberReq\x123\n" +
	"\auser_id\x18\x01 \x01(\tB\x1a\xfaB\x17r\x152\x13^[[:alnum:]_.+@-]+$R\x06userId\"O\n" +
	"\x15GetTeamsForMemberResp\x126\n" +
	"\x05teams\x18\x01 \x03(\v2 .chef.automate.domain.teams.TeamR\x05teams\"1\n" +
	"\x14GetTeamMembershipReq\x12\x19\n" +
	"\x02id\x18\x01 \x01(\tB\t\xfaB\x06r\x042\x02\\SR\x02id\"2\n" +
	"\x15GetTeamMembershipResp\x12\x19\n" +
	"\buser_ids\x18\x01 \x03(\tR\auserIds\"\x10\n" +
	"\x0eUpgradeToV2Req\"\x11\n" +
	"\x0fUpgradeToV2Resp\"\x0e\n" +
	"\fResetToV1Req\"\x0f\n" +
	"\rResetToV1Resp\"1\n" +
	"\x16PurgeUserMembershipReq\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\"+\n" +
	"\x17PurgeUserMembershipResp\x12\x10\n" +
	"\x03ids\x18\x01 \x03(\tR\x03ids2\xe4\t\n" +
	"\fTeamsService\x12s\n" +
	"\n" +
	"GetVersion\x124.chef.automate.api.common.version.VersionInfoRequest\x1a-.chef.automate.api.common.version.VersionInfo\"\x00\x12\\\n" +
	"\aGetTeam\x12&.chef.automate.domain.teams.GetTeamReq\x1a'.chef.automate.domain.teams.GetTeamResp\"\x00\x12b\n" +
	"\tListTeams\x12(.chef.automate.domain.teams.ListTeamsReq\x1a).chef.automate.domain.teams.ListTeamsResp\"\x00\x12e\n" +
	"\n" +
	"CreateTeam\x12).chef.automate.domain.teams.CreateTeamReq\x1a*.chef.automate.domain.teams.CreateTeamResp\"\x00\x12e\n" +
	"\n" +
	"UpdateTeam\x12).chef.automate.domain.teams.UpdateTeamReq\x1a*.chef.automate.domain.teams.UpdateTeamResp\"\x00\x12e\n" +
	"\n" +
	"DeleteTeam\x12).chef.automate.domain.teams.DeleteTeamReq\x1a*.chef.automate.domain.teams.DeleteTeamResp\"\x00\x12q\n" +
	"\x0eAddTeamMembers\x12-.chef.automate.domain.teams.AddTeamMembersReq\x1a..chef.automate.domain.teams.AddTeamMembersResp\"\x00\x12z\n" +
	"\x11RemoveTeamMembers\x120.chef.automate.domain.teams.RemoveTeamMembersReq\x1a1.chef.automate.domain.teams.RemoveTeamMembersResp\"\x00\x12z\n" +
	"\x11GetTeamsForMember\x120.chef.automate.domain.teams.GetTeamsForMemberReq\x1a1.chef.automate.domain.teams.GetTeamsForMemberResp\"\x00\x12z\n" +
	"\x11GetTeamMembership\x120.chef.automate.domain.teams.GetTeamMembershipReq\x1a1.chef.automate.domain.teams.GetTeamMembershipResp\"\x00\x12\x80\x01\n" +
	"\x13PurgeUserMembership\x122.chef.automate.domain.teams.PurgeUserMembershipReq\x1a3.chef.automate.domain.teams.PurgeUserMembershipResp\"\x00B1Z/github.com/chef/automate/api/interservice/teamsb\x06proto3"

var (
	file_interservice_teams_teams_proto_rawDescOnce sync.Once
	file_interservice_teams_teams_proto_rawDescData []byte
)

func file_interservice_teams_teams_proto_rawDescGZIP() []byte {
	file_interservice_teams_teams_proto_rawDescOnce.Do(func() {
		file_interservice_teams_teams_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_interservice_teams_teams_proto_rawDesc), len(file_interservice_teams_teams_proto_rawDesc)))
	})
...
func file_interservice_teams_teams_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_interservice_teams_teams_proto_rawDesc), len(file_interservice_teams_teams_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   25,
			NumExtensions: 0,
			NumServices:   1,
