...
const file_interservice_event_feed_event_feed_proto_rawDesc = "" +
	"\n" +
	"(interservice/event_feed/event_feed.proto\x12#chef.automate.domain.event_feed.api\x1a\x1einterservice/event/event.proto\x1a'external/event_feed/request/event.proto\x1a(external/event_feed/response/event.proto\x1a\x1eexternal/common/response.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a&external/common/query/parameters.proto\"\xd6\x01\n" +
	"\vFeedRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x12\n" +
	"\x04size\x18\x02 \x01(\x05R\x04size\x12\x14\n" +
	"\x05start\x18\x04 \x01(\x03R\x05start\x12\x10\n" +
	"\x03end\x18\x05 \x01(\x03R\x03end\x12\x16\n" +
	"\x06before\x18\x06 \x01(\x03R\x06before\x12\x14\n" +
	"\x05after\x18\a \x01(\x03R\x05after\x12\x12\n" +
	"\x04sort\x18\b \x03(\tR\x04sort\x12\x18\n" +
	"\afilters\x18\t \x03(\tR\afilters\x12\x16\n" +
	"\x06cursor\x18\n" +
	" \x01(\tR\x06cursor\"\x86\x01\n" +
	"\fFeedResponse\x12Q\n" +
	"\ffeed_entries\x18\x01 \x03(\v2..chef.automate.domain.event_feed.api.FeedEntryR\vfeedEntries\x12#\n" +
	"\rtotal_entries\x18\x02 \x01(\x03R\ftotalEntries\"\xbc\x05\n" +
	"\tFeedEntry\x12\x0e\n" +
	...
	"\x16source_event_published\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x14sourceEventPublished\x124\n" +
	"\acreated\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\acreated\x12I\n" +
	"\bproducer\x18\a \x01(\v2-.chef.automate.domain.event_feed.api.ProducerR\bproducer\x12@\n" +
	"\x05actor\x18\b \x01(\v2*.chef.automate.domain.event_feed.api.ActorR\x05actor\x12\x12\n" +
	"\x04verb\x18\t \x01(\tR\x04verb\x12C\n" +
	"\x06object\x18\n" +
	" \x01(\v2+.chef.automate.domain.event_feed.api.ObjectR\x06object\x12C\n" +
	"\x06target\x18\v \x01(\v2+.chef.automate.domain.event_feed.api.TargetR\x06target\x12C\n" +
	"\x06parent\x18\f \x01(\v2+.chef.automate.domain.event_feed.api.ParentR\x06parent\x12+\n" +
	"\x11chef_organization\x18\r \x01(\tR\x10chefOrganization\x12*\n" +
	"\x11chef_infra_server\x18\x0e \x01(\tR\x0fchefInfraServer\",\n" +
	"\x06Parent\x12\x0e\n" +
	...
	"objectType\x12\x15\n" +
	"\x06p_tags\x18\x04 \x03(\tR\x05pTags\"L\n" +
	"\x05Actor\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x1f\n" +
	"\vobject_type\x18\x03 \x01(\tR\n" +
	...
	"\vobject_type\x18\x03 \x01(\tR\n" +
	"objectType\"\xc6\x01\n" +
	"\x12FeedSummaryRequest\x12\x14\n" +
	"\x05start\x18\x01 \x01(\x03R\x05start\x12\x10\n" +
	"\x03end\x18\x02 \x01(\x03R\x03end\x12\x12\n" +
	"\x04size\x18\x04 \x01(\x05R\x04size\x12\x12\n" +
	"\x04from\x18\x05 \x01(\x05R\x04from\x12\x1f\n" +
	"\vstart_after\x18\x06 \x01(\tR\n" +
	"startAfter\x12\x18\n" +
	"\afilters\x18\a \x03(\tR\afilters\x12%\n" +
	"\x0ecount_category\x18\t \x01(\tR\rcountCategory\"\x8e\x01\n" +
	"\x13FeedSummaryResponse\x12#\n" +
	"\rtotal_entries\x18\x01 \x01(\x03R\ftotalEntries\x12R\n" +
	"\fentry_counts\x18\x02 \x03(\v2/.chef.automate.domain.event_feed.api.EntryCountR\ventryCounts\">\n" +
	"\n" +
	"EntryCount\x12\x1a\n" +
	"\bcategory\x18\x01 \x01(\tR\bcategory\x12\x14\n" +
	"\x05count\x18\x02 \x01(\x03R\x05count\"\x8f\x01\n" +
	"\x13FeedTimelineRequest\x12\x14\n" +
	...
	"\afilters\x18\x05 \x03(\tR\afilters\"\xae\x01\n" +
	"\x14FeedTimelineResponse\x12\x14\n" +
	"\x05start\x18\x01 \x01(\tR\x05start\x12\x10\n" +
	"\x03end\x18\x02 \x01(\tR\x03end\x12\x1a\n" +
	"\binterval\x18\x03 \x01(\x05R\binterval\x12R\n" +
	"\faction_lines\x18\x04 \x03(\v2/.chef.automate.domain.event_feed.api.ActionLineR\vactionLines\"i\n" +
	"\n" +
	"ActionLine\x12\x16\n" +
	"\x06action\x18\x01 \x01(\tR\x06action\x12C\n" +
	"\x05slots\x18\x02 \x03(\v2-.chef.automate.domain.event_feed.api.TimeslotR\x05slots\"S\n" +
	"\bTimeslot\x12G\n" +
	"\x06counts\x18\x01 \x03(\v2/.chef.automate.domain.event_feed.api.EntryCountR\x06counts\"/\n" +
	"\x13EventExportResponse\x12\x18\n" +
	"\acontent\x18\x01 \x01(\fR\acontent\"\xb6\x01\n" +
	...
	"\x05order\x18\x05 \x01(\x0e2).chef.automate.api.common.query.SortOrderR\x05order2\xfe\x04\n" +
	"\x10EventFeedService\x12n\n" +
	"\aGetFeed\x120.chef.automate.domain.event_feed.api.FeedRequest\x1a1.chef.automate.domain.event_feed.api.FeedResponse\x12\x83\x01\n" +
	"\x0eGetFeedSummary\x127.chef.automate.domain.event_feed.api.FeedSummaryRequest\x1a8.chef.automate.domain.event_feed.api.FeedSummaryResponse\x12\x86\x01\n" +
	"\x0fGetFeedTimeline\x128.chef.automate.domain.event_feed.api.FeedTimelineRequest\x1a9.chef.automate.domain.event_feed.api.FeedTimelineResponse\x12f\n" +
	"\vHandleEvent\x12(.chef.automate.domain.event.api.EventMsg\x1a-.chef.automate.domain.event.api.EventResponse\x12\x82\x01\n" +
	"\vEventExport\x127.chef.automate.domain.event_feed.api.EventExportRequest\x1a8.chef.automate.domain.event_feed.api.EventExportResponse0\x01B6Z4github.com/chef/automate/api/interservice/event_feedb\x06proto3"

var (
	file_interservice_event_feed_event_feed_proto_rawDescOnce sync.Once
	file_interservice_event_feed_event_feed_proto_rawDescData []byte
)
...
func file_interservice_event_feed_event_feed_proto_rawDescGZIP() []byte {
	file_interservice_event_feed_event_feed_proto_rawDescOnce.Do(func() {
		file_interservice_event_feed_event_feed_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_interservice_event_feed_event_feed_proto_rawDesc), len(file_interservice_event_feed_event_feed_proto_rawDesc)))
	})
...
func file_interservice_event_feed_event_feed_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_interservice_event_feed_event_feed_proto_rawDesc), len(file_interservice_event_feed_event_feed_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   17,
			NumExtensions: 0,
			NumServices:   1,
