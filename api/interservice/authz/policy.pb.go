...
type GetUserPoliciesReq struct {
	...
	MemberType  string `protobuf:"bytes,1,opt,name=member_type,json=memberType,proto3" json:"member_type,omitempty" toml:"member_type,omitempty" mapstructure:"member_type,omitempty"`
	Username    string `protobuf:"bytes,2,opt,name=username,proto3" json:"username,omitempty" toml:"username,omitempty" mapstructure:"username,omitempty"`
	ConnectorId string `protobuf:"bytes,3,opt,name=connector_id,json=connectorId,proto3" json:"connector_id,omitempty" toml:"connector_id,omitempty" mapstructure:"connector_id,omitempty"`
}
...
func (x *GetUserPoliciesReq) GetMemberType() string {
	if x != nil {
		return x.MemberType
	}
	return ""
...
type GetUserPoliciesResp struct {
	...
	PolicyIds []string `protobuf:"bytes,1,rep,name=policy_ids,json=policyIds,proto3" json:"policy_ids,omitempty" toml:"policy_ids,omitempty" mapstructure:"policy_ids,omitempty"`
}
...
func (x *GetUserPoliciesResp) GetPolicyIds() []string {
	if x != nil {
		return x.PolicyIds
	}
	return nil
...
var file_interservice_authz_policy_proto_rawDesc = []byte{
	...
	,
...
var file_interservice_authz_policy_proto_depIdxs = []int32{
	...
	19, // 9: chef.automate.domain.authz.GetPolicyVersionResp.version:type_name -> chef.automate.domain.authz.Version
	...
	15, // 12: chef.automate.domain.authz.PoliciesService.ReplacePolicyMembers:input_type -> chef.automate.domain.authz.ReplacePolicyMembersReq
	...
	11, // 15: chef.automate.domain.authz.PoliciesService.GetUserPolicies:input_type -> chef.automate.domain.authz.GetUserPoliciesReq
	9,  // 16: chef.automate.domain.authz.PoliciesService.ListPolicies:input_type -> chef.automate.domain.authz.ListPoliciesReq
	13, // 17: chef.automate.domain.authz.PoliciesService.GetPolicy:input_type -> chef.automate.domain.authz.GetPolicyReq
	14, // 18: chef.automate.domain.authz.PoliciesService.UpdatePolicy:input_type -> chef.automate.domain.authz.UpdatePolicyReq
	20, // 19: chef.automate.domain.authz.PoliciesService.GetPolicyVersion:input_type -> chef.automate.domain.authz.GetPolicyVersionReq
	36, // 20: chef.automate.domain.authz.PoliciesService.CreateRole:input_type -> chef.automate.domain.authz.CreateRoleReq
	22, // 21: chef.automate.domain.authz.PoliciesService.ListRoles:input_type -> chef.automate.domain.authz.ListRolesReq
	35, // 22: chef.automate.domain.authz.PoliciesService.GetRole:input_type -> chef.automate.domain.authz.GetRoleReq
	24, // 23: chef.automate.domain.authz.PoliciesService.DeleteRole:input_type -> chef.automate.domain.authz.DeleteRoleReq
	26, // 24: chef.automate.domain.authz.PoliciesService.UpdateRole:input_type -> chef.automate.domain.authz.UpdateRoleReq
	27, // 25: chef.automate.domain.authz.PoliciesService.ListPolicyMembers:input_type -> chef.automate.domain.authz.ListPolicyMembersReq
	29, // 26: chef.automate.domain.authz.PoliciesService.RemovePolicyMembers:input_type -> chef.automate.domain.authz.RemovePolicyMembersReq
	17, // 27: chef.automate.domain.authz.PoliciesService.AddPolicyMembers:input_type -> chef.automate.domain.authz.AddPolicyMembersReq
	37, // 28: chef.automate.domain.authz.PoliciesService.PurgeSubjectFromPolicies:input_type -> chef.automate.domain.authz.PurgeSubjectFromPoliciesReq
	16, // 29: chef.automate.domain.authz.PoliciesService.ReplacePolicyMembers:output_type -> chef.automate.domain.authz.ReplacePolicyMembersResp
	3,  // 30: chef.automate.domain.authz.PoliciesService.CreatePolicy:output_type -> chef.automate.domain.authz.Policy
	7,  // 31: chef.automate.domain.authz.PoliciesService.DeletePolicy:output_type -> chef.automate.domain.authz.DeletePolicyResp
	12, // 32: chef.automate.domain.authz.PoliciesService.GetUserPolicies:output_type -> chef.automate.domain.authz.GetUserPoliciesResp
	10, // 33: chef.automate.domain.authz.PoliciesService.ListPolicies:output_type -> chef.automate.domain.authz.ListPoliciesResp
	3,  // 34: chef.automate.domain.authz.PoliciesService.GetPolicy:output_type -> chef.automate.domain.authz.Policy
	3,  // 35: chef.automate.domain.authz.PoliciesService.UpdatePolicy:output_type -> chef.automate.domain.authz.Policy
	21, // 36: chef.automate.domain.authz.PoliciesService.GetPolicyVersion:output_type -> chef.automate.domain.authz.GetPolicyVersionResp
	4,  // 37: chef.automate.domain.authz.PoliciesService.CreateRole:output_type -> chef.automate.domain.authz.Role
	23, // 38: chef.automate.domain.authz.PoliciesService.ListRoles:output_type -> chef.automate.domain.authz.ListRolesResp
	4,  // 39: chef.automate.domain.authz.PoliciesService.GetRole:output_type -> chef.automate.domain.authz.Role
	25, // 40: chef.automate.domain.authz.PoliciesService.DeleteRole:output_type -> chef.automate.domain.authz.DeleteRoleResp
	4,  // 41: chef.automate.domain.authz.PoliciesService.UpdateRole:output_type -> chef.automate.domain.authz.Role
	28, // 42: chef.automate.domain.authz.PoliciesService.ListPolicyMembers:output_type -> chef.automate.domain.authz.ListPolicyMembersResp
	30, // 43: chef.automate.domain.authz.PoliciesService.RemovePolicyMembers:output_type -> chef.automate.domain.authz.RemovePolicyMembersResp
	18, // 44: chef.automate.domain.authz.PoliciesService.AddPolicyMembers:output_type -> chef.automate.domain.authz.AddPolicyMembersResp
	38, // 45: chef.automate.domain.authz.PoliciesService.PurgeSubjectFromPolicies:output_type -> chef.automate.domain.authz.PurgeSubjectFromPoliciesResp
