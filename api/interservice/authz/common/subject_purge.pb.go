...
package common // import "github.com/chef/automate/api/interservice/authz/common"
...
func (*ErrorShouldUseV1) Descriptor() ([]byte, []int) {
	return fileDescriptor_subject_purge_41f64afbe3d0854a, []int{0}
}
...
func (dst *ErrorShouldUseV1) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ErrorShouldUseV1.Merge(dst, src)
}
...
func (*ErrorShouldUseV2) Descriptor() ([]byte, []int) {
	return fileDescriptor_subject_purge_41f64afbe3d0854a, []int{1}
}
...
func (dst *ErrorShouldUseV2) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ErrorShouldUseV2.Merge(dst, src)
}
...
type ErrorShouldUseV2_1 struct {
	XXX_NoUnkeyedLiteral struct{} `json:"-" toml:"-" mapstructure:"-,omitempty"`
	XXX_unrecognized     []byte   `json:"-" toml:"-" mapstructure:"-,omitempty"`
	XXX_sizecache        int32    `json:"-" toml:"-" mapstructure:"-,omitempty"`
}

func (m *ErrorShouldUseV2_1) Reset()         { *m = ErrorShouldUseV2_1{} }
func (m *ErrorShouldUseV2_1) String() string { return proto.CompactTextString(m) }
func (*ErrorShouldUseV2_1) ProtoMessage()    {}
func (*ErrorShouldUseV2_1) Descriptor() ([]byte, []int) {
	return fileDescriptor_subject_purge_41f64afbe3d0854a, []int{2}
}
func (m *ErrorShouldUseV2_1) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ErrorShouldUseV2_1.Unmarshal(m, b)
}
func (m *ErrorShouldUseV2_1) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ErrorShouldUseV2_1.Marshal(b, m, deterministic)
}
func (dst *ErrorShouldUseV2_1) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ErrorShouldUseV2_1.Merge(dst, src)
}
func (m *ErrorShouldUseV2_1) XXX_Size() int {
	return xxx_messageInfo_ErrorShouldUseV2_1.Size(m)
}
func (m *ErrorShouldUseV2_1) XXX_DiscardUnknown() {
	xxx_messageInfo_ErrorShouldUseV2_1.DiscardUnknown(m)
}

var xxx_messageInfo_ErrorShouldUseV2_1 proto.InternalMessageInfo
...
func (*PurgeSubjectFromPoliciesReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_subject_purge_41f64afbe3d0854a, []int{3}
}
...
func (*PurgeSubjectFromPoliciesResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_subject_purge_41f64afbe3d0854a, []int{4}
}
...
func init() {
	...
	proto.RegisterType((*ErrorShouldUseV2_1)(nil), "chef.automate.domain.authz.common.ErrorShouldUseV2_1")
...
func init() {
	proto.RegisterFile("api/interservice/authz/common/subject_purge.proto", fileDescriptor_subject_purge_41f64afbe3d0854a)
}

var fileDescriptor_subject_purge_41f64afbe3d0854a = []byte{
	// 396 bytes of a gzipped FileDescriptorProto
	,
}
