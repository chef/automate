...
func (*IsAuthorizedReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_authz_145a649003834a88, []int{0}
}
...
func (*IsAuthorizedResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_authz_145a649003834a88, []int{1}
}
...
func (*ProjectsAuthorizedReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_authz_145a649003834a88, []int{2}
}
...
func (*ProjectsAuthorizedResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_authz_145a649003834a88, []int{3}
}
...
func (*FilterAuthorizedPairsReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_authz_145a649003834a88, []int{4}
}
...
func (*FilterAuthorizedPairsResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_authz_145a649003834a88, []int{5}
}
...
func (*FilterAuthorizedProjectsResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_authz_145a649003834a88, []int{6}
}
...
func (*Pair) Descriptor() ([]byte, []int) {
	return fileDescriptor_authz_145a649003834a88, []int{7}
}
...
func init() {
	proto.RegisterFile("api/interservice/authz/v2/authz.proto", fileDescriptor_authz_145a649003834a88)
}

var fileDescriptor_authz_145a649003834a88 = []byte{
	// 646 bytes of a gzipped FileDescriptorProto
	,
}
