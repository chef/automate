...
const file_interservice_pg_sidecar_service_proto_rawDesc = "" +
	"\n" +
	"%interservice/pg_sidecar/service.proto\x12\x1echef.automate.infra.pg_sidecar\"s\n" +
	"\fErrorDetails\x12F\n" +
	"\x04code\x18\x14 \x01(\x0e22.chef.automate.infra.pg_sidecar.ErrorDetails.CodesR\x04code\"\x1b\n" +
	"\x05Codes\x12\x12\n" +
	"\x0eSRC_DB_MISSING\x10\x00\"\xd1\x01\n" +
	"\x10MigrateTablesReq\x12\x17\n" +
	"\afrom_db\x18\x14 \x01(\tR\x06fromDb\x12\x13\n" +
	"\x05to_db\x18\x15 \x01(\tR\x04toDb\x12\x14\n" +
	"\x05table\x18\x16 \x03(\tR\x05table\x12\x1f\n" +
	"\vimport_user\x18\x17 \x01(\tR\n" +
	"importUser\x122\n" +
	"\x16fail_if_src_db_missing\x18\x18 \x01(\bR\x12failIfSrcDbMissing\x12$\n" +
	"\x0eskip_db_create\x18\x19 \x01(\bR\fskipDbCreate\"\x12\n" +
	"\x10MigrateTablesRes\";\n" +
	"\vRenameDBReq\x12\x17\n" +
	"\afrom_db\x18\x14 \x01(\tR\x06fromDb\x12\x13\n" +
	"\x05to_db\x18\x15 \x01(\tR\x04toDb\"\r\n" +
	"\vRenameDBRes\"1\n" +
	"\vCreateDBReq\x12\x0e\n" +
	"\x02db\x18\x14 \x01(\tR\x02db\x12\x12\n" +
	"\x04user\x18\x15 \x01(\tR\x04user\"\r\n" +
	"\vCreateDBRes\"6\n" +
	"\x12CreateExtensionReq\x12\x0e\n" +
	"\x02db\x18\x14 \x01(\tR\x02db\x12\x10\n" +
	"\x03ext\x18\x15 \x01(\tR\x03ext\"\x14\n" +
	"\x12CreateExtensionRes\"G\n" +
	"\x0fDeploySqitchReq\x12\x0e\n" +
	"\x02db\x18\x14 \x01(\tR\x02db\x12\x10\n" +
	"\x03dir\x18\x15 \x01(\tR\x03dir\x12\x12\n" +
	"\x04user\x18\x16 \x01(\tR\x04user\"\x11\n" +
	"\x0fDeploySqitchRes\"<\n" +
	"\x16SetPublicSchemaRoleReq\x12\x12\n" +
	"\x04role\x18\x14 \x01(\tR\x04role\x12\x0e\n" +
	"\x02db\x18\x15 \x01(\tR\x02db\"\x18\n" +
	"\x16SetPublicSchemaRoleRes\"\xbe\x05\n" +
	"\fAlterRoleReq\x12\x12\n" +
	"\x04role\x18\x14 \x01(\tR\x04role\x12H\n" +
	"\x04with\x18\x15 \x01(\v24.chef.automate.infra.pg_sidecar.AlterRoleReq.OptionsR\x04with\x1a\x8b\x04\n" +
	"\aOptions\x12\x1c\n" +
	"\tsuperuser\x18\x14 \x01(\bR\tsuperuser\x12 \n" +
	"\vnosuperuser\x18\x15 \x01(\bR\vnosuperuser\x12\x1a\n" +
	"\bcreatedb\x18\x16 \x01(\bR\bcreatedb\x12\x1e\n" +
	"\n" +
	"nocreatedb\x18\x17 \x01(\bR\n" +
	"nocreatedb\x12\x1e\n" +
	"\n" +
	"createrole\x18\x18 \x01(\bR\n" +
	"createrole\x12\"\n" +
	"\fnocreaterole\x18\x19 \x01(\bR\fnocreaterole\x12\x1e\n" +
	"\n" +
	"createuser\x18\x1a \x01(\bR\n" +
	"createuser\x12\"\n" +
	"\fnocreateuser\x18\x1b \x01(\bR\fnocreateuser\x12\x18\n" +
	"\ainherit\x18\x1c \x01(\bR\ainherit\x12\x1c\n" +
	"\tnoinherit\x18\x1d \x01(\bR\tnoinherit\x12 \n" +
	"\vreplication\x18\x1e \x01(\bR\vreplication\x12$\n" +
	"\rnoreplication\x18\x1f \x01(\bR\rnoreplication\x12)\n" +
	"\x10connection_limit\x18  \x01(\x03R\x0fconnectionLimit\x12Q\n" +
	"\bpassword\x18! \x01(\v25.chef.automate.infra.pg_sidecar.AlterRoleReq.PasswordR\bpassword\x1aB\n" +
	"\bPassword\x12\x14\n" +
	"\x05value\x18\x14 \x01(\tR\x05value\x12 \n" +
	"\vunencrypted\x18\x15 \x01(\bR\vunencrypted\"\x0e\n" +
	"\fAlterRoleRes\"Q\n" +
	"\rDropTablesReq\x12\x0e\n" +
	"\x02db\x18\x14 \x01(\tR\x02db\x12\x16\n" +
	"\x06tables\x18\x15 \x03(\tR\x06tables\x12\x18\n" +
	"\acascade\x18\x16 \x01(\bR\acascade\"\x0f\n" +
	"\rDropTablesRes2\xad\a\n" +
	"\x10PGSidecarService\x12u\n" +
	"\rMigrateTables\x120.chef.automate.infra.pg_sidecar.MigrateTablesReq\x1a0.chef.automate.infra.pg_sidecar.MigrateTablesRes\"\x00\x12f\n" +
	"\bRenameDB\x12+.chef.automate.infra.pg_sidecar.RenameDBReq\x1a+.chef.automate.infra.pg_sidecar.RenameDBRes\"\x00\x12f\n" +
	"\bCreateDB\x12+.chef.automate.infra.pg_sidecar.CreateDBReq\x1a+.chef.automate.infra.pg_sidecar.CreateDBRes\"\x00\x12{\n" +
	"\x0fCreateExtension\x122.chef.automate.infra.pg_sidecar.CreateExtensionReq\x1a2.chef.automate.infra.pg_sidecar.CreateExtensionRes\"\x00\x12r\n" +
	"\fDeploySqitch\x12/.chef.automate.infra.pg_sidecar.DeploySqitchReq\x1a/.chef.automate.infra.pg_sidecar.DeploySqitchRes\"\x00\x12\x87\x01\n" +
	"\x13SetPublicSchemaRole\x126.chef.automate.infra.pg_sidecar.SetPublicSchemaRoleReq\x1a6.chef.automate.infra.pg_sidecar.SetPublicSchemaRoleRes\"\x00\x12i\n" +
	"\tAlterRole\x12,.chef.automate.infra.pg_sidecar.AlterRoleReq\x1a,.chef.automate.infra.pg_sidecar.AlterRoleRes\"\x00\x12l\n" +
	"\n" +
	"DropTables\x12-.chef.automate.infra.pg_sidecar.DropTablesReq\x1a-.chef.automate.infra.pg_sidecar.DropTablesRes\"\x00B6Z4github.com/chef/automate/api/interservice/pg_sidecarb\x06proto3"

var (
	file_interservice_pg_sidecar_service_proto_rawDescOnce sync.Once
	file_interservice_pg_sidecar_service_proto_rawDescData []byte
)
...
func file_interservice_pg_sidecar_service_proto_rawDescGZIP() []byte {
	file_interservice_pg_sidecar_service_proto_rawDescOnce.Do(func() {
		file_interservice_pg_sidecar_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_interservice_pg_sidecar_service_proto_rawDesc), len(file_interservice_pg_sidecar_service_proto_rawDesc)))
	})
...
func file_interservice_pg_sidecar_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_interservice_pg_sidecar_service_proto_rawDesc), len(file_interservice_pg_sidecar_service_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   19,
			NumExtensions: 0,
			NumServices:   1,
