...
func (*EventStrings) Descriptor() ([]byte, []int) {
	return fileDescriptor_79fffe55d4341d8b, []int{0}
}
...
func (*EventString) Descriptor() ([]byte, []int) {
	return fileDescriptor_79fffe55d4341d8b, []int{1}
}
...
func (*EventCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_79fffe55d4341d8b, []int{2}
}
...
func init() {
	proto.RegisterFile("api/interservice/cfgmgmt/response/eventstrings.proto", fileDescriptor_79fffe55d4341d8b)
}

var fileDescriptor_79fffe55d4341d8b = []byte{
