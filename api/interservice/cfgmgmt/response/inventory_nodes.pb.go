...
const file_interservice_cfgmgmt_response_inventory_nodes_proto_rawDesc = "" +
	"\n" +
	"3interservice/cfgmgmt/response/inventory_nodes.proto\x12%chef.automate.domain.cfgmgmt.response\x1a\x1fgoogle/protobuf/timestamp.proto\"\\\n" +
	"\x0eInventoryNodes\x12J\n" +
	"\x05nodes\x18\x01 \x03(\v24.chef.automate.domain.cfgmgmt.response.InventoryNodeR\x05nodes\"\xf2\x03\n" +
	"\rInventoryNode\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x124\n" +
	"\acheckin\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\acheckin\x12\"\n" +
	"\forganization\x18\x03 \x01(\tR\forganization\x12\x1a\n" +
	"\bplatform\x18\x04 \x01(\tR\bplatform\x12'\n" +
	"\x0fplatform_family\x18\x05 \x01(\tR\x0eplatformFamily\x12)\n" +
	"\x10platform_version\x18\x06 \x01(\tR\x0fplatformVersion\x12%\n" +
	"\x0eclient_version\x18\a \x01(\tR\rclientVersion\x12&\n" +
	"\x0fec2_instance_id\x18\b \x01(\tR\rec2InstanceId\x12*\n" +
	"\x11ec2_instance_type\x18\t \x01(\tR\x0fec2InstanceType\x12F\n" +
	"\x11last_ccr_received\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\x0flastCcrReceived\x12\x12\n" +
	"\x04name\x18\v \x01(\tR\x04name\x12\x12\n" +
	"\x04fqdn\x18\f \x01(\tR\x04fqdn\x12\x1c\n" +
	"\tipaddress\x18\r \x01(\tR\tipaddressB<Z:github.com/chef/automate/api/interservice/cfgmgmt/responseb\x06proto3"

var (
	file_interservice_cfgmgmt_response_inventory_nodes_proto_rawDescOnce sync.Once
	file_interservice_cfgmgmt_response_inventory_nodes_proto_rawDescData []byte
)
...
func file_interservice_cfgmgmt_response_inventory_nodes_proto_rawDescGZIP() []byte {
	file_interservice_cfgmgmt_response_inventory_nodes_proto_rawDescOnce.Do(func() {
		file_interservice_cfgmgmt_response_inventory_nodes_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_interservice_cfgmgmt_response_inventory_nodes_proto_rawDesc), len(file_interservice_cfgmgmt_response_inventory_nodes_proto_rawDesc)))
	})
...
func file_interservice_cfgmgmt_response_inventory_nodes_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_interservice_cfgmgmt_response_inventory_nodes_proto_rawDesc), len(file_interservice_cfgmgmt_response_inventory_nodes_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
