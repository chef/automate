...
const file_interservice_cfgmgmt_response_stats_proto_rawDesc = "" +
	"\n" +
	")interservice/cfgmgmt/response/stats.proto\x12%chef.automate.domain.cfgmgmt.response\"V\n" +
	"\n" +
	"RunsCounts\x12\x14\n" +
	...
	"\amissing\x18\x04 \x01(\x05R\amissing\"g\n" +
	"\x17CheckInCountsTimeSeries\x12L\n" +
	"\x06counts\x18\x01 \x03(\v24.chef.automate.domain.cfgmgmt.response.CheckInCountsR\x06counts\"c\n" +
	...
	"\x05total\x18\x04 \x01(\x05R\x05totalB<Z:github.com/chef/automate/api/interservice/cfgmgmt/responseb\x06proto3"

var (
	file_interservice_cfgmgmt_response_stats_proto_rawDescOnce sync.Once
	file_interservice_cfgmgmt_response_stats_proto_rawDescData []byte
)
...
func file_interservice_cfgmgmt_response_stats_proto_rawDescGZIP() []byte {
	file_interservice_cfgmgmt_response_stats_proto_rawDescOnce.Do(func() {
		file_interservice_cfgmgmt_response_stats_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_interservice_cfgmgmt_response_stats_proto_rawDesc), len(file_interservice_cfgmgmt_response_stats_proto_rawDesc)))
	})
...
func file_interservice_cfgmgmt_response_stats_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_interservice_cfgmgmt_response_stats_proto_rawDesc), len(file_interservice_cfgmgmt_response_stats_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
