...
func (*NodeExport) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_export_2193007f2f712d37, []int{0}
}
...
func (dst *NodeExport) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NodeExport.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("api/interservice/cfgmgmt/request/node_export.proto", fileDescriptor_node_export_2193007f2f712d37)
}

var fileDescriptor_node_export_2193007f2f712d37 = []byte{
