...
const file_interservice_cfgmgmt_request_node_export_proto_rawDesc = "" +
	"\n" +
	".interservice/cfgmgmt/request/node_export.proto\x12$chef.automate.domain.cfgmgmt.request\x1a\x1fgoogle/protobuf/timestamp.proto\x1a-interservice/cfgmgmt/request/parameters.proto\"\x8e\x01\n" +
	"\n" +
	"NodeExport\x12\x16\n" +
	"\x06filter\x18\x01 \x03(\tR\x06filter\x12G\n" +
	"\asorting\x18\x02 \x01(\v2-.chef.automate.domain.cfgmgmt.request.SortingR\asorting\x12\x1f\n" +
	...
	"\x03end\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x03endB;Z9github.com/chef/automate/api/interservice/cfgmgmt/requestb\x06proto3"

var (
	file_interservice_cfgmgmt_request_node_export_proto_rawDescOnce sync.Once
	file_interservice_cfgmgmt_request_node_export_proto_rawDescData []byte
)
...
func file_interservice_cfgmgmt_request_node_export_proto_rawDescGZIP() []byte {
	file_interservice_cfgmgmt_request_node_export_proto_rawDescOnce.Do(func() {
		file_interservice_cfgmgmt_request_node_export_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_interservice_cfgmgmt_request_node_export_proto_rawDesc), len(file_interservice_cfgmgmt_request_node_export_proto_rawDesc)))
	})
...
func file_interservice_cfgmgmt_request_node_export_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_interservice_cfgmgmt_request_node_export_proto_rawDesc), len(file_interservice_cfgmgmt_request_node_export_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
