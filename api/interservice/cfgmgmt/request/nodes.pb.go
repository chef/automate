...
func (*NodeRun) Descriptor() ([]byte, []int) {
	return fileDescriptor_nodes_78048aff47257299, []int{0}
}
...
func (*Nodes) Descriptor() ([]byte, []int) {
	return fileDescriptor_nodes_78048aff47257299, []int{1}
}
...
func (*Node) Descriptor() ([]byte, []int) {
	return fileDescriptor_nodes_78048aff47257299, []int{2}
}
...
func (*Runs) Descriptor() ([]byte, []int) {
	return fileDescriptor_nodes_78048aff47257299, []int{3}
}
...
func init() {
	proto.RegisterFile("api/interservice/cfgmgmt/request/nodes.proto", fileDescriptor_nodes_78048aff47257299)
}

var fileDescriptor_nodes_78048aff47257299 = []byte{
