...
type InventoryNodes struct {
	...
	From       int32                `protobuf:"varint,8,opt,name=from,proto3" json:"from,omitempty" toml:"from,omitempty" mapstructure:"from,omitempty"`
}
...
func (x *InventoryNodes) GetStart() *timestamp.Timestamp {
	if x != nil {
		return x.Start
	}
	return nil
...
func (x *InventoryNodes) GetEnd() *timestamp.Timestamp {
	if x != nil {
		return x.End
	}
	return nil
...
func (x *InventoryNodes) GetCursorDate() *timestamp.Timestamp {
	if x != nil {
		return x.CursorDate
	}
	return nil
...
func (x *InventoryNodes) GetFrom() int32 {
	if x != nil {
		return x.From
	}
	return 0
...
var file_interservice_cfgmgmt_request_inventory_nodes_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x72, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xdc, 0x02, 0x0a, 0x0e, 0x49,
	...
	0x72, 0x74, 0x69, 0x6e, 0x67, 0x12, 0x12, 0x0a, 0x04, 0x66, 0x72, 0x6f, 0x6d, 0x18, 0x08, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x04, 0x66, 0x72, 0x6f, 0x6d, 0x42, 0x3b, 0x5a, 0x39, 0x67, 0x69, 0x74,
