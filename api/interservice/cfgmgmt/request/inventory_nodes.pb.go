...
func (*InventoryNodes) Descriptor() ([]byte, []int) {
	return fileDescriptor_2b777b83f495f88a, []int{0}
}
...
func init() {
	proto.RegisterFile("api/interservice/cfgmgmt/request/inventory_nodes.proto", fileDescriptor_2b777b83f495f88a)
}

var fileDescriptor_2b777b83f495f88a = []byte{
