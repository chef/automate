...
func (*AuthenticateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_authenticate_1bfa90f99d653332, []int{0}
}
...
func (*AuthenticateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_authenticate_1bfa90f99d653332, []int{1}
}
...
func init() {
	proto.RegisterFile("api/interservice/authn/authenticate.proto", fileDescriptor_authenticate_1bfa90f99d653332)
}

var fileDescriptor_authenticate_1bfa90f99d653332 = []byte{
