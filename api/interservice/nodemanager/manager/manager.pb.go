...
const file_interservice_nodemanager_manager_manager_proto_rawDesc = "" +
	"\n" +
	".interservice/nodemanager/manager/manager.proto\x12(chef.automate.domain.nodemanager.manager\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a+interservice/compliance/common/common.proto\x1a*interservice/nodemanager/nodes/nodes.proto\"\x14\n" +
	"\x02Id\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"E\n" +
	"\x03Ids\x12>\n" +
	"\x03ids\x18\x01 \x03(\v2,.chef.automate.domain.nodemanager.manager.IdR\x03ids\"\x19\n" +
	"\x17ChangeNodeStateResponse\"\x15\n" +
	"\x13ProcessNodeResponse\"\xac\x01\n" +
	"\tNodeState\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12O\n" +
	"\x05state\x18\x02 \x01(\x0e29.chef.automate.domain.nodemanager.manager.NodeState.StateR\x05state\">\n" +
	"\x05State\x12\v\n" +
	"\aRUNNING\x10\x00\x12\v\n" +
	"\aSTOPPED\x10\x01\x12\x0e\n" +
	"\n" +
	"TERMINATED\x10\x02\x12\v\n" +
	"\aMISSING\x10\x03\"\x8a\x02\n" +
	"\x05Query\x12M\n" +
	"\n" +
	"filter_map\x18\x19 \x03(\v2..chef.automate.domain.compliance.common.FilterR\tfilterMap\x12O\n" +
	"\x05order\x18\x15 \x01(\x0e29.chef.automate.domain.nodemanager.manager.Query.OrderTypeR\x05order\x12\x12\n" +
	...
	"\x04DESC\x10\x01\"\xf1\x05\n" +
	"\fNodeMetadata\x12\x12\n" +
	"\x04uuid\x18\x01 \x01(\tR\x04uuid\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12#\n" +
	"\rplatform_name\x18\x03 \x01(\tR\fplatformName\x12)\n" +
	"\x10platform_release\x18\x04 \x01(\tR\x0fplatformRelease\x12\x19\n" +
	"\bjob_uuid\x18\x05 \x01(\tR\ajobUuid\x12=\n" +
	"\flast_contact\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\vlastContact\x12\x1b\n" +
	"\tsource_id\x18\a \x01(\tR\bsourceId\x12#\n" +
	"\rsource_region\x18\b \x01(\tR\fsourceRegion\x12*\n" +
	"\x11source_account_id\x18\t \x01(\tR\x0fsourceAccountId\x12>\n" +
	"\x04tags\x18\n" +
	" \x03(\v2*.chef.automate.domain.compliance.common.KvR\x04tags\x12R\n" +
	"\brun_data\x18\v \x01(\v27.chef.automate.domain.nodemanager.nodes.LastContactDataR\arunData\x12T\n" +
	"\tscan_data\x18\f \x01(\v27.chef.automate.domain.nodemanager.nodes.LastContactDataR\bscanData\x12Y\n" +
	"\rprojects_data\x18\r \x03(\v24.chef.automate.domain.nodemanager.nodes.ProjectsDataR\fprojectsData\x12\x1a\n" +
	"\bprojects\x18\x0e \x03(\tR\bprojects\x12\x1d\n" +
	"\n" +
	"manager_id\x18\x0f \x01(\tR\tmanagerId\x12!\n" +
	"\fmanager_type\x18\x10 \x01(\tR\vmanagerType\" \n" +
	"\x06Fields\x12\x16\n" +
	"\x06fields\x18\x01 \x03(\tR\x06fields\"\x91\x01\n" +
	"\n" +
	"FieldQuery\x12E\n" +
	"\x05query\x18\x14 \x01(\v2/.chef.automate.domain.nodemanager.manager.QueryR\x05query\x12\x14\n" +
	"\x05field\x18\x15 \x01(\tR\x05field\x12&\n" +
	"\x0fnode_manager_id\x18\x16 \x01(\tR\rnodeManagerId\"3\n" +
	"\x05Nodes\x12\x14\n" +
	"\x05nodes\x18\x01 \x03(\tR\x05nodes\x12\x14\n" +
	"\x05total\x18\x14 \x01(\x05R\x05total\"z\n" +
	"\tNodeQuery\x12E\n" +
	"\x05query\x18\x14 \x01(\v2/.chef.automate.domain.nodemanager.manager.QueryR\x05query\x12&\n" +
	"\x0fnode_manager_id\x18\x15 \x01(\tR\rnodeManagerId\"/\n" +
	"\vCredentials\x12 \n" +
	"\vcredentials\x18\x14 \x01(\tR\vcredentials\"\xc6\x03\n" +
	"\vNodeManager\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x12\n" +
	"\x04type\x18\x03 \x01(\tR\x04type\x12#\n" +
	"\rcredential_id\x18\x14 \x01(\tR\fcredentialId\x12n\n" +
	"\x14instance_credentials\x18\x15 \x03(\v2;.chef.automate.domain.nodemanager.manager.CredentialsByTagsR\x13instanceCredentials\x12\x16\n" +
	"\x06status\x18\x16 \x01(\tR\x06status\x12\x1d\n" +
	"\n" +
	"account_id\x18\x18 \x01(\tR\taccountId\x129\n" +
	"\n" +
	"date_added\x18\x19 \x01(\v2\x1a.google.protobuf.TimestampR\tdateAdded\x12S\n" +
	"\x0fcredential_data\x18\x1a \x03(\v2*.chef.automate.domain.compliance.common.KvR\x0ecredentialData\x12#\n" +
	"\raccount_alias\x18\x1b \x01(\tR\faccountAlias\"p\n" +
	"\x11CredentialsByTags\x12\x17\n" +
	"\atag_key\x18\x14 \x01(\tR\x06tagKey\x12\x1b\n" +
	"\ttag_value\x18\x15 \x01(\tR\btagValue\x12%\n" +
	"\x0ecredential_ids\x18\x16 \x03(\tR\rcredentialIds\"w\n" +
	"\fNodeManagers\x12Q\n" +
	"\bmanagers\x18\x01 \x03(\v25.chef.automate.domain.nodemanager.manager.NodeManagerR\bmanagers\x12\x14\n" +
	"\x05total\x18\x14 \x01(\x05R\x05total\"[\n" +
	"\fManagerNodes\x12K\n" +
	"\x05nodes\x18\x01 \x03(\v25.chef.automate.domain.nodemanager.manager.ManagerNodeR\x05nodes\"\xc1\x02\n" +
	"\vManagerNode\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04host\x18\x02 \x01(\tR\x04host\x12\x1b\n" +
	"\tpublic_ip\x18\x03 \x01(\tR\bpublicIp\x12>\n" +
	"\x04tags\x18\x04 \x03(\v2*.chef.automate.domain.compliance.common.KvR\x04tags\x12\x1a\n" +
	"\bplatform\x18\x05 \x01(\tR\bplatform\x12\x16\n" +
	"\x06region\x18\x06 \x01(\tR\x06region\x12\x12\n" +
	"\x04name\x18\a \x01(\tR\x04name\x12\x10\n" +
	"\x03ssm\x18\b \x01(\tR\x03ssm\x12\x12\n" +
	"\x04uuid\x18\t \x01(\tR\x04uuid\x12-\n" +
	"\x12machine_identifier\x18\n" +
	" \x01(\tR\x11machineIdentifier\x12\x14\n" +
	"\x05group\x18\v \x01(\tR\x05group2\x92\x0e\n" +
	"\x12NodeManagerService\x12p\n" +
	"\x06Create\x125.chef.automate.domain.nodemanager.manager.NodeManager\x1a-.chef.automate.domain.nodemanager.manager.Ids\"\x00\x12m\n" +
	"\x04Read\x12,.chef.automate.domain.nodemanager.manager.Id\x1a5.chef.automate.domain.nodemanager.manager.NodeManager\"\x00\x12Y\n" +
	"\x06Update\x125.chef.automate.domain.nodemanager.manager.NodeManager\x1a\x16.google.protobuf.Empty\"\x00\x12P\n" +
	"\x06Delete\x12,.chef.automate.domain.nodemanager.manager.Id\x1a\x16.google.protobuf.Empty\"\x00\x12p\n" +
	"\x0fDeleteWithNodes\x12,.chef.automate.domain.nodemanager.manager.Id\x1a-.chef.automate.domain.nodemanager.manager.Ids\"\x00\x12d\n" +
	"\x1aDeleteWithNodeStateStopped\x12,.chef.automate.domain.nodemanager.manager.Id\x1a\x16.google.protobuf.Empty\"\x00\x12g\n" +
	"\x1dDeleteWithNodeStateTerminated\x12,.chef.automate.domain.nodemanager.manager.Id\x1a\x16.google.protobuf.Empty\"\x00\x12q\n" +
	"\x04List\x12/.chef.automate.domain.nodemanager.manager.Query\x1a6.chef.automate.domain.nodemanager.manager.NodeManagers\"\x00\x12Z\n" +
	"\aConnect\x125.chef.automate.domain.nodemanager.manager.NodeManager\x1a\x16.google.protobuf.Empty\"\x00\x12X\n" +
	"\x0eConnectManager\x12,.chef.automate.domain.nodemanager.manager.Id\x1a\x16.google.protobuf.Empty\"\x00\x12|\n" +
	"\x10SearchNodeFields\x124.chef.automate.domain.nodemanager.manager.FieldQuery\x1a0.chef.automate.domain.nodemanager.manager.Fields\"\x00\x12u\n" +
	"\vSearchNodes\x123.chef.automate.domain.nodemanager.manager.NodeQuery\x1a/.chef.automate.domain.nodemanager.manager.Nodes\"\x00\x12\x86\x01\n" +
	"\vProcessNode\x126.chef.automate.domain.nodemanager.manager.NodeMetadata\x1a=.chef.automate.domain.nodemanager.manager.ProcessNodeResponse\"\x00\x12\x8b\x01\n" +
	"\x0fChangeNodeState\x123.chef.automate.domain.nodemanager.manager.NodeState\x1aA.chef.automate.domain.nodemanager.manager.ChangeNodeStateResponse\"\x00\x12r\n" +
	"\x12GetNodeWithSecrets\x12,.chef.automate.domain.nodemanager.manager.Id\x1a,.chef.automate.domain.nodemanager.nodes.Node\"\x00\x12\x83\x01\n" +
	"\x12SearchManagerNodes\x123.chef.automate.domain.nodemanager.manager.NodeQuery\x1a6.chef.automate.domain.nodemanager.manager.ManagerNodes\"\x00B?Z=github.com/chef/automate/api/interservice/nodemanager/managerb\x06proto3"

var (
	file_interservice_nodemanager_manager_manager_proto_rawDescOnce sync.Once
	file_interservice_nodemanager_manager_manager_proto_rawDescData []byte
)
...
func file_interservice_nodemanager_manager_manager_proto_rawDescGZIP() []byte {
	file_interservice_nodemanager_manager_manager_proto_rawDescOnce.Do(func() {
		file_interservice_nodemanager_manager_manager_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_interservice_nodemanager_manager_manager_proto_rawDesc), len(file_interservice_nodemanager_manager_manager_proto_rawDesc)))
	})
...
func file_interservice_nodemanager_manager_manager_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_interservice_nodemanager_manager_manager_proto_rawDesc), len(file_interservice_nodemanager_manager_manager_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   17,
			NumExtensions: 0,
			NumServices:   1,
