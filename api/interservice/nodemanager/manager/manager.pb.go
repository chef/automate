...
func (x *NodeMetadata) GetLastContact() *timestamp.Timestamp {
	if x != nil {
...
func (*UnimplementedNodeManagerServiceServer) Connect(context.Context, *NodeManager) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Connect not implemented")
}
func (*UnimplementedNodeManagerServiceServer) ConnectManager(context.Context, *Id) (*empty.Empty, error) {
