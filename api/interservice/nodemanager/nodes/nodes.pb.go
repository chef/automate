...
func (x *NodeDetectJobInfo) GetJobEndTime() *timestamp.Timestamp {
	if x != nil {
		return x.JobEndTime
	}
	return nil
...
func (*UnimplementedNodesServiceServer) UpdateNodeDetectInfo(context.Context, *NodeDetectJobInfo) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateNodeDetectInfo not implemented")
}
func (*UnimplementedNodesServiceServer) UpdateNodeConnectionError(context.Context, *NodeError) (*empty.Empty, error) {
