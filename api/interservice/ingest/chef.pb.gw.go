...
func request_ChefIngesterService_InsertDummy_0(ctx context.Context, marshaler runtime.Marshaler, client ChefIngesterServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_ChefIngesterService_InsertDummy_0(ctx context.Context, marshaler runtime.Marshaler, server ChefIngesterServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.InsertRequest
	var metadata runtime.ServerMetadata
...
func request_ChefIngesterService_InsertDummyDetails_0(ctx context.Context, marshaler runtime.Marshaler, client ChefIngesterServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_ChefIngesterService_InsertDummyDetails_0(ctx context.Context, marshaler runtime.Marshaler, server ChefIngesterServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq request.InsertRequestDetails
	var metadata runtime.ServerMetadata
...
func RegisterChefIngesterServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ChefIngesterServiceServer) error {
	...
	mux.Handle("POST", pattern_ChefIngesterService_InsertDummy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_ChefIngesterService_InsertDummy_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_ChefIngesterService_InsertDummy_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_ChefIngesterService_InsertDummyDetails_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_ChefIngesterService_InsertDummyDetails_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_ChefIngesterService_InsertDummyDetails_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterChefIngesterServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ChefIngesterServiceClient) error {
	...
	mux.Handle("POST", pattern_ChefIngesterService_InsertDummy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ChefIngesterService_InsertDummy_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_ChefIngesterService_InsertDummyDetails_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ChefIngesterService_InsertDummyDetails_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_ChefIngesterService_InsertDummy_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"api", "v0", "ingest", "events", "chef", "insert_request"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ChefIngesterService_InsertDummyDetails_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"api", "v0", "ingest", "events", "chef", "insert_request_details"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	...
	forward_ChefIngesterService_InsertDummy_0 = runtime.ForwardResponseMessage

	forward_ChefIngesterService_InsertDummyDetails_0 = runtime.ForwardResponseMessage
)
