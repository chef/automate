...
func (*ProjectUpdateStatusReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_automate_event_a88289a723b4de2e, []int{0}
}
...
func (*ProjectUpdateStatusResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_automate_event_a88289a723b4de2e, []int{1}
}
...
func init() {
	proto.RegisterFile("api/interservice/ingest/automate_event.proto", fileDescriptor_automate_event_a88289a723b4de2e)
}

var fileDescriptor_automate_event_a88289a723b4de2e = []byte{
