...
var file_interservice_deployment_automate_deployment_proto_rawDesc = []byte{
	...
	0x32, 0xbe, 0x2e, 0x0a, 0x0a, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x12,
...
var file_interservice_deployment_automate_deployment_proto_depIdxs = []int32{
	...
	44,  // 106: chef.automate.domain.deployment.Deployment.SetLogLevel:input_type -> chef.automate.domain.deployment.SetLogLevelRequest
	20,  // 107: chef.automate.domain.deployment.Deployment.GenerateAdminToken:input_type -> chef.automate.domain.deployment.GenerateAdminTokenRequest
	32,  // 108: chef.automate.domain.deployment.Deployment.DeployID:input_type -> chef.automate.domain.deployment.DeployIDRequest
	107, // 109: chef.automate.domain.deployment.Deployment.CurrentReleaseManifest:input_type -> chef.automate.domain.deployment.CurrentReleaseManifestRequest
	109, // 110: chef.automate.domain.deployment.Deployment.A1UpgradeStatus:input_type -> chef.automate.domain.deployment.A1UpgradeStatusRequest
	12,  // 111: chef.automate.domain.deployment.Deployment.NodeInventory:input_type -> chef.automate.domain.deployment.NodeInventoryRequest
	14,  // 112: chef.automate.domain.deployment.Deployment.InfrastructureNodeDelete:input_type -> chef.automate.domain.deployment.InfrastructureNodeDeleteRequest
	17,  // 113: chef.automate.domain.deployment.Deployment.Usage:input_type -> chef.automate.domain.deployment.UsageRequest
	10,  // 114: chef.automate.domain.deployment.Deployment.GetCLIExecutable:input_type -> chef.automate.domain.deployment.GetCLIExecutableRequest
	8,   // 115: chef.automate.domain.deployment.Deployment.BootstrapBundle:input_type -> chef.automate.domain.deployment.BootstrapBundleRequest
	26,  // 116: chef.automate.domain.deployment.Deployment.Deploy:output_type -> chef.automate.domain.deployment.DeployResponse
	26,  // 117: chef.automate.domain.deployment.Deployment.DeployDataServices:output_type -> chef.automate.domain.deployment.DeployResponse
	26,  // 118: chef.automate.domain.deployment.Deployment.DeploySome:output_type -> chef.automate.domain.deployment.DeployResponse
	51,  // 119: chef.automate.domain.deployment.Deployment.DeployStatus:output_type -> chef.automate.domain.deployment.DeployEvent
	26,  // 120: chef.automate.domain.deployment.Deployment.Preload:output_type -> chef.automate.domain.deployment.DeployResponse
	33,  // 121: chef.automate.domain.deployment.Deployment.RemoveSome:output_type -> chef.automate.domain.deployment.RemoveResponse
	26,  // 122: chef.automate.domain.deployment.Deployment.StartNonDataServices:output_type -> chef.automate.domain.deployment.DeployResponse
	49,  // 123: chef.automate.domain.deployment.Deployment.NewDeployment:output_type -> chef.automate.domain.deployment.DeploymentID
	24,  // 124: chef.automate.domain.deployment.Deployment.ConfigureDeployment:output_type -> chef.automate.domain.deployment.ConfigureDeploymentResponse
	31,  // 125: chef.automate.domain.deployment.Deployment.Ping:output_type -> chef.automate.domain.deployment.PingResponse
	55,  // 126: chef.automate.domain.deployment.Deployment.Status:output_type -> chef.automate.domain.deployment.StatusResponse
	56,  // 127: chef.automate.domain.deployment.Deployment.ServiceVersions:output_type -> chef.automate.domain.deployment.ServiceVersionsResponse
	59,  // 128: chef.automate.domain.deployment.Deployment.LicenseStatus:output_type -> chef.automate.domain.deployment.LicenseStatusResponse
	61,  // 129: chef.automate.domain.deployment.Deployment.LicenseApply:output_type -> chef.automate.domain.deployment.LicenseApplyResponse
	35,  // 130: chef.automate.domain.deployment.Deployment.Stop:output_type -> chef.automate.domain.deployment.StopResponse
	52,  // 131: chef.automate.domain.deployment.Deployment.SystemLogs:output_type -> chef.automate.domain.deployment.LogLine
	65,  // 132: chef.automate.domain.deployment.Deployment.GatherLogs:output_type -> chef.automate.domain.deployment.GatherLogsResponse
	67,  // 133: chef.automate.domain.deployment.Deployment.GatherLogsDownload:output_type -> chef.automate.domain.deployment.GatherLogsDownloadResponse
	37,  // 134: chef.automate.domain.deployment.Deployment.StopConverge:output_type -> chef.automate.domain.deployment.StopConvergeResponse
	39,  // 135: chef.automate.domain.deployment.Deployment.StartConverge:output_type -> chef.automate.domain.deployment.StartConvergeResponse
	43,  // 136: chef.automate.domain.deployment.Deployment.UpgradeStatus:output_type -> chef.automate.domain.deployment.UpgradeStatusResponse
	69,  // 137: chef.automate.domain.deployment.Deployment.RestartServices:output_type -> chef.automate.domain.deployment.RestartServicesResponse
	71,  // 138: chef.automate.domain.deployment.Deployment.GetAutomateConfig:output_type -> chef.automate.domain.deployment.GetAutomateConfigResponse
	73,  // 139: chef.automate.domain.deployment.Deployment.PatchAutomateConfig:output_type -> chef.automate.domain.deployment.PatchAutomateConfigResponse
	75,  // 140: chef.automate.domain.deployment.Deployment.SetAutomateConfig:output_type -> chef.automate.domain.deployment.SetAutomateConfigResponse
	77,  // 141: chef.automate.domain.deployment.Deployment.DumpDB:output_type -> chef.automate.domain.deployment.DumpDBResponse
	78,  // 142: chef.automate.domain.deployment.Deployment.ManifestVersion:output_type -> chef.automate.domain.deployment.ManifestVersionResponse
	87,  // 143: chef.automate.domain.deployment.Deployment.CreateBackup:output_type -> chef.automate.domain.deployment.CreateBackupResponse
	89,  // 144: chef.automate.domain.deployment.Deployment.ListBackups:output_type -> chef.automate.domain.deployment.ListBackupsResponse
	91,  // 145: chef.automate.domain.deployment.Deployment.ShowBackup:output_type -> chef.automate.domain.deployment.ShowBackupResponse
	93,  // 146: chef.automate.domain.deployment.Deployment.DeleteBackups:output_type -> chef.automate.domain.deployment.DeleteBackupsResponse
	100, // 147: chef.automate.domain.deployment.Deployment.RestoreBackup:output_type -> chef.automate.domain.deployment.RestoreBackupResponse
	102, // 148: chef.automate.domain.deployment.Deployment.BackupStatus:output_type -> chef.automate.domain.deployment.BackupStatusResponse
	104, // 149: chef.automate.domain.deployment.Deployment.CancelBackup:output_type -> chef.automate.domain.deployment.CancelBackupResponse
	95,  // 150: chef.automate.domain.deployment.Deployment.BackupIntegrityShow:output_type -> chef.automate.domain.deployment.BackupIntegrityShowResponse
	98,  // 151: chef.automate.domain.deployment.Deployment.ValidateBackupIntegrity:output_type -> chef.automate.domain.deployment.ValidateBackupIntegrityResponse
	106, // 152: chef.automate.domain.deployment.Deployment.Upgrade:output_type -> chef.automate.domain.deployment.UpgradeResponse
	45,  // 153: chef.automate.domain.deployment.Deployment.SetLogLevel:output_type -> chef.automate.domain.deployment.SetLogLevelResponse
	21,  // 154: chef.automate.domain.deployment.Deployment.GenerateAdminToken:output_type -> chef.automate.domain.deployment.GenerateAdminTokenResponse
	79,  // 155: chef.automate.domain.deployment.Deployment.DeployID:output_type -> chef.automate.domain.deployment.DeployIDResponse
	108, // 156: chef.automate.domain.deployment.Deployment.CurrentReleaseManifest:output_type -> chef.automate.domain.deployment.ReleaseManifest
	110, // 157: chef.automate.domain.deployment.Deployment.A1UpgradeStatus:output_type -> chef.automate.domain.deployment.A1UpgradeStatusResponse
	13,  // 158: chef.automate.domain.deployment.Deployment.NodeInventory:output_type -> chef.automate.domain.deployment.NodeInventoryResponse
	15,  // 159: chef.automate.domain.deployment.Deployment.InfrastructureNodeDelete:output_type -> chef.automate.domain.deployment.InfrastructureNodeDeleteResponse
	18,  // 160: chef.automate.domain.deployment.Deployment.Usage:output_type -> chef.automate.domain.deployment.UsageResponse
	11,  // 161: chef.automate.domain.deployment.Deployment.GetCLIExecutable:output_type -> chef.automate.domain.deployment.GetCLIExecutableResponse
	9,   // 162: chef.automate.domain.deployment.Deployment.BootstrapBundle:output_type -> chef.automate.domain.deployment.BootstrapBundleResponse
