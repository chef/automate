...
func (*RootCertRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_certificate_authority_0e29c45e0b2886d5, []int{0}
}
...
func (dst *RootCertRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RootCertRequest.Merge(dst, src)
}
...
func (*RootCertResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_certificate_authority_0e29c45e0b2886d5, []int{1}
}
...
func (dst *RootCertResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RootCertResponse.Merge(dst, src)
}
...
func (*RegenerateRootRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_certificate_authority_0e29c45e0b2886d5, []int{2}
}
...
func (dst *RegenerateRootRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RegenerateRootRequest.Merge(dst, src)
}
...
func (*RegenerateRootResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_certificate_authority_0e29c45e0b2886d5, []int{3}
}
...
func (dst *RegenerateRootResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RegenerateRootResponse.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("api/interservice/deployment/certificate_authority.proto", fileDescriptor_certificate_authority_0e29c45e0b2886d5)
}

var fileDescriptor_certificate_authority_0e29c45e0b2886d5 = []byte{
