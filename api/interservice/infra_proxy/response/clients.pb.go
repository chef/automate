...
const file_interservice_infra_proxy_response_clients_proto_rawDesc = "" +
	"\n" +
	"/interservice/infra_proxy/response/clients.proto\x12)chef.automate.domain.infra_proxy.response\"\x88\x01\n" +
	"\aClients\x12S\n" +
	"\aclients\x18\x01 \x03(\v29.chef.automate.domain.infra_proxy.response.ClientListItemR\aclients\x12\x12\n" +
	"\x04page\x18\x02 \x01(\x05R\x04page\x12\x14\n" +
	"\x05total\x18\x03 \x01(\x05R\x05total\"B\n" +
	"\x0eClientListItem\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1c\n" +
	"\tvalidator\x18\x02 \x01(\bR\tvalidator\"\x8d\x02\n" +
	"\x06Client\x12\x12\n" +
	...
	"\tchef_type\x18\x06 \x01(\tR\bchefType\x12Y\n" +
	"\n" +
	"client_key\x18\a \x01(\v2:.chef.automate.domain.infra_proxy.response.ClientAccessKeyR\tclientKey\"w\n" +
	"\fCreateClient\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12S\n" +
	"\n" +
	"client_key\x18\x02 \x01(\v24.chef.automate.domain.infra_proxy.response.ClientKeyR\tclientKey\"v\n" +
	"\vResetClient\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12S\n" +
	"\n" +
	"client_key\x18\x02 \x01(\v24.chef.automate.domain.infra_proxy.response.ClientKeyR\tclientKey\"\x88\x01\n" +
	"\tClientKey\x12\x12\n" +
	...
	"\n" +
	"public_key\x18\x02 \x01(\tR\tpublicKey\x12'\n" +
	"\x0fexpiration_date\x18\x03 \x01(\tR\x0eexpirationDateB@Z>github.com/chef/automate/api/interservice/infra_proxy/responseb\x06proto3"

var (
	file_interservice_infra_proxy_response_clients_proto_rawDescOnce sync.Once
	file_interservice_infra_proxy_response_clients_proto_rawDescData []byte
)
...
func file_interservice_infra_proxy_response_clients_proto_rawDescGZIP() []byte {
	file_interservice_infra_proxy_response_clients_proto_rawDescOnce.Do(func() {
		file_interservice_infra_proxy_response_clients_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_interservice_infra_proxy_response_clients_proto_rawDesc), len(file_interservice_infra_proxy_response_clients_proto_rawDesc)))
	})
...
func file_interservice_infra_proxy_response_clients_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_interservice_infra_proxy_response_clients_proto_rawDesc), len(file_interservice_infra_proxy_response_clients_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
