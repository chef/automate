...
const file_interservice_infra_proxy_response_cookbooks_proto_rawDesc = "" +
	"\n" +
	"1interservice/infra_proxy/response/cookbooks.proto\x12)chef.automate.domain.infra_proxy.response\"e\n" +
	"\tCookbooks\x12X\n" +
	"\tcookbooks\x18\x01 \x03(\v2:.chef.automate.domain.infra_proxy.response.CookbookVersionR\tcookbooks\"B\n" +
	...
	"\aversion\x18\x02 \x01(\tR\aversion\"\xe3\b\n" +
	"\bCookbook\x12#\n" +
	...
	"\n" +
	"json_class\x18\x06 \x01(\tR\tjsonClass\x12M\n" +
	"\x05files\x18\a \x03(\v27.chef.automate.domain.infra_proxy.response.CookbookItemR\x05files\x12U\n" +
	"\ttemplates\x18\b \x03(\v27.chef.automate.domain.infra_proxy.response.CookbookItemR\ttemplates\x12W\n" +
	"\n" +
	"attributes\x18\t \x03(\v27.chef.automate.domain.infra_proxy.response.CookbookItemR\n" +
	"attributes\x12Q\n" +
	"\arecipes\x18\n" +
	" \x03(\v27.chef.automate.domain.infra_proxy.response.CookbookItemR\arecipes\x12Y\n" +
	"\vdefinitions\x18\v \x03(\v27.chef.automate.domain.infra_proxy.response.CookbookItemR\vdefinitions\x12U\n" +
	"\tlibraries\x18\f \x03(\v27.chef.automate.domain.infra_proxy.response.CookbookItemR\tlibraries\x12U\n" +
	"\tproviders\x18\r \x03(\v27.chef.automate.domain.infra_proxy.response.CookbookItemR\tproviders\x12U\n" +
	"\tresources\x18\x0e \x03(\v27.chef.automate.domain.infra_proxy.response.CookbookItemR\tresources\x12V\n" +
	"\n" +
	"root_files\x18\x0f \x03(\v27.chef.automate.domain.infra_proxy.response.CookbookItemR\trootFiles\x12S\n" +
	"\bmetadata\x18\x10 \x01(\v27.chef.automate.domain.infra_proxy.response.CookbookMetaR\bmetadata\x12Q\n" +
	"\x06access\x18\x11 \x01(\v29.chef.automate.domain.infra_proxy.response.CookbookAccessR\x06access\"\x86\x01\n" +
	...
	"\x06delete\x18\x05 \x01(\bR\x06deleteB@Z>github.com/chef/automate/api/interservice/infra_proxy/responseb\x06proto3"

var (
	file_interservice_infra_proxy_response_cookbooks_proto_rawDescOnce sync.Once
	file_interservice_infra_proxy_response_cookbooks_proto_rawDescData []byte
)
...
func file_interservice_infra_proxy_response_cookbooks_proto_rawDescGZIP() []byte {
	file_interservice_infra_proxy_response_cookbooks_proto_rawDescOnce.Do(func() {
		file_interservice_infra_proxy_response_cookbooks_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_interservice_infra_proxy_response_cookbooks_proto_rawDesc), len(file_interservice_infra_proxy_response_cookbooks_proto_rawDesc)))
	})
...
func file_interservice_infra_proxy_response_cookbooks_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_interservice_infra_proxy_response_cookbooks_proto_rawDesc), len(file_interservice_infra_proxy_response_cookbooks_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
