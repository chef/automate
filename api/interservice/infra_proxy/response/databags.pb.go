...
const file_interservice_infra_proxy_response_databags_proto_rawDesc = "" +
	"\n" +
	"0interservice/infra_proxy/response/databags.proto\x12)chef.automate.domain.infra_proxy.response\"c\n" +
	"\bDataBags\x12W\n" +
	"\tdata_bags\x18\x01 \x03(\v2:.chef.automate.domain.infra_proxy.response.DataBagListItemR\bdataBags\"\x9e\x01\n" +
	"\fDataBagItems\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12P\n" +
	"\x05items\x18\x02 \x03(\v2:.chef.automate.domain.infra_proxy.response.DataBagListItemR\x05items\x12\x12\n" +
	...
	"\aitem_id\x18\x02 \x01(\tR\x06itemIdB@Z>github.com/chef/automate/api/interservice/infra_proxy/responseb\x06proto3"

var (
	file_interservice_infra_proxy_response_databags_proto_rawDescOnce sync.Once
	file_interservice_infra_proxy_response_databags_proto_rawDescData []byte
)
...
func file_interservice_infra_proxy_response_databags_proto_rawDescGZIP() []byte {
	file_interservice_infra_proxy_response_databags_proto_rawDescOnce.Do(func() {
		file_interservice_infra_proxy_response_databags_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_interservice_infra_proxy_response_databags_proto_rawDesc), len(file_interservice_infra_proxy_response_databags_proto_rawDesc)))
	})
...
func file_interservice_infra_proxy_response_databags_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_interservice_infra_proxy_response_databags_proto_rawDesc), len(file_interservice_infra_proxy_response_databags_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
