...
func file_interservice_infra_proxy_response_roles_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_interservice_infra_proxy_response_roles_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Roles); i {
			case 0:
				return &v.state
			case 1:
		...
		file_interservice_infra_proxy_response_roles_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_interservice_infra_proxy_response_roles_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Role); i {
			case 0:
				return &v.state
			case 1:
		...
		file_interservice_infra_proxy_response_roles_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_interservice_infra_proxy_response_roles_proto_msgTypes[4].Exporter = func(v any, i int) any {
