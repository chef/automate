...
const file_interservice_infra_proxy_response_roles_proto_rawDesc = "" +
	"\n" +
	"-interservice/infra_proxy/response/roles.proto\x12)chef.automate.domain.infra_proxy.response\x1a.interservice/infra_proxy/response/common.proto\"\x80\x01\n" +
	"\x05Roles\x12M\n" +
	"\x05roles\x18\x01 \x03(\v27.chef.automate.domain.infra_proxy.response.RoleListItemR\x05roles\x12\x12\n" +
	"\x04page\x18\x02 \x01(\x05R\x04page\x12\x14\n" +
	"\x05total\x18\x03 \x01(\x05R\x05total\"h\n" +
	"\fRoleListItem\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12\"\n" +
	"\fenvironments\x18\x03 \x03(\tR\fenvironments\"\xf3\x01\n" +
	"\x04Role\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1b\n" +
	"\tchef_type\x18\x02 \x01(\tR\bchefType\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12-\n" +
	"\x12default_attributes\x18\x04 \x01(\tR\x11defaultAttributes\x12/\n" +
	"\x13override_attributes\x18\x05 \x01(\tR\x12overrideAttributes\x12\x1d\n" +
	"\n" +
	"json_class\x18\x06 \x01(\tR\tjsonClass\x12\x19\n" +
	"\brun_list\x18\a \x03(\tR\arunList\"p\n" +
	"\x0fExpandedRunList\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12M\n" +
	"\brun_list\x18\x02 \x03(\v22.chef.automate.domain.infra_proxy.response.RunListR\arunList\"6\n" +
	"\x10RoleEnvironments\x12\"\n" +
	"\fenvironments\x18\x01 \x03(\tR\fenvironmentsB@Z>github.com/chef/automate/api/interservice/infra_proxy/responseb\x06proto3"

var (
	file_interservice_infra_proxy_response_roles_proto_rawDescOnce sync.Once
	file_interservice_infra_proxy_response_roles_proto_rawDescData []byte
)
...
func file_interservice_infra_proxy_response_roles_proto_rawDescGZIP() []byte {
	file_interservice_infra_proxy_response_roles_proto_rawDescOnce.Do(func() {
		file_interservice_infra_proxy_response_roles_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_interservice_infra_proxy_response_roles_proto_rawDesc), len(file_interservice_infra_proxy_response_roles_proto_rawDesc)))
	})
...
func file_interservice_infra_proxy_response_roles_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_interservice_infra_proxy_response_roles_proto_rawDesc), len(file_interservice_infra_proxy_response_roles_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
