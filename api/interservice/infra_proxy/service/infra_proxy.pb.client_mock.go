...
// Source: infra_proxy/service/infra_proxy.pb.go
...
// GetAutomateInfraServerOrgs mocks base method
func (m *MockInfraProxyServiceClient) GetAutomateInfraServerOrgs(ctx context.Context, in *request.AutomateInfraServerOrgs, opts ...grpc.CallOption) (*response.AutomateInfraServerOrgs, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "GetAutomateInfraServerOrgs", varargs...)
	ret0, _ := ret[0].(*response.AutomateInfraServerOrgs)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAutomateInfraServerOrgs indicates an expected call of GetAutomateInfraServerOrgs
func (mr *MockInfraProxyServiceClientMockRecorder) GetAutomateInfraServerOrgs(ctx, in interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, in}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAutomateInfraServerOrgs", reflect.TypeOf((*MockInfraProxyServiceClient)(nil).GetAutomateInfraServerOrgs), varargs...)
}
...
// GetAutomateInfraServerOrgs mocks base method
func (m *MockInfraProxyServiceServer) GetAutomateInfraServerOrgs(arg0 context.Context, arg1 *request.AutomateInfraServerOrgs) (*response.AutomateInfraServerOrgs, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAutomateInfraServerOrgs", arg0, arg1)
	ret0, _ := ret[0].(*response.AutomateInfraServerOrgs)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// GetAutomateInfraServerOrgs indicates an expected call of GetAutomateInfraServerOrgs
func (mr *MockInfraProxyServiceServerMockRecorder) GetAutomateInfraServerOrgs(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAutomateInfraServerOrgs", reflect.TypeOf((*MockInfraProxyServiceServer)(nil).GetAutomateInfraServerOrgs), arg0, arg1)
}
