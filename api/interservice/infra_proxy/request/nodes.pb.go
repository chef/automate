...
var file_interservice_infra_proxy_request_nodes_proto_rawDesc = []byte{
	...
	0x72, 0x49, 0x64, 0x22, 0x8e, 0x01, 0x0a, 0x0d, 0x41, 0x66, 0x66, 0x65, 0x63, 0x74, 0x65, 0x64,
...
var file_interservice_infra_proxy_request_nodes_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_interservice_infra_proxy_request_nodes_proto_goTypes = []interface{}{
	...
	(*AffectedNodes)(nil),  // 1: chef.automate.domain.infra_proxy.request.AffectedNodes
	(*DeleteNode)(nil),     // 2: chef.automate.domain.infra_proxy.request.DeleteNode
	(*UpdateNode)(nil),     // 3: chef.automate.domain.infra_proxy.request.UpdateNode
	(*_struct.Struct)(nil), // 4: google.protobuf.Struct
}
var file_interservice_infra_proxy_request_nodes_proto_depIdxs = []int32{
	4, // 0: chef.automate.domain.infra_proxy.request.UpdateNode.automatic_attributes:type_name -> google.protobuf.Struct
	4, // 1: chef.automate.domain.infra_proxy.request.UpdateNode.default_attributes:type_name -> google.protobuf.Struct
	4, // 2: chef.automate.domain.infra_proxy.request.UpdateNode.normal_attributes:type_name -> google.protobuf.Struct
	4, // 3: chef.automate.domain.infra_proxy.request.UpdateNode.override_attributes:type_name -> google.protobuf.Struct
