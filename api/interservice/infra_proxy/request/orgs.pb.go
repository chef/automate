...
var file_interservice_infra_proxy_request_orgs_proto_rawDesc = []byte{
	...
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x4b, 0x65, 0x79, 0x42,
...
func file_interservice_infra_proxy_request_orgs_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_interservice_infra_proxy_request_orgs_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_interservice_infra_proxy_request_orgs_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_interservice_infra_proxy_request_orgs_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_interservice_infra_proxy_request_orgs_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_interservice_infra_proxy_request_orgs_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*GetOrg); i {
			case 0:
				return &v.state
			case 1:
		...
		file_interservice_infra_proxy_request_orgs_proto_msgTypes[5].Exporter = func(v any, i int) any {
