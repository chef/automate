...
func (x *Cookbooks) Reset() {
	*x = Cookbooks{}
	if protoimpl.UnsafeEnabled {
		mi := &file_interservice_infra_proxy_request_cookbooks_proto_msgTypes[0]
...
func (*Cookbooks) Descriptor() ([]byte, []int) {
	return file_interservice_infra_proxy_request_cookbooks_proto_rawDescGZIP(), []int{0}
}
...
func (x *CookbookVersions) Reset() {
	*x = CookbookVersions{}
	if protoimpl.UnsafeEnabled {
		mi := &file_interservice_infra_proxy_request_cookbooks_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CookbookVersions) Descriptor() ([]byte, []int) {
	return file_interservice_infra_proxy_request_cookbooks_proto_rawDescGZIP(), []int{1}
}
...
func (x *Cookbook) Reset() {
	*x = Cookbook{}
	if protoimpl.UnsafeEnabled {
		mi := &file_interservice_infra_proxy_request_cookbooks_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Cookbook) Descriptor() ([]byte, []int) {
	return file_interservice_infra_proxy_request_cookbooks_proto_rawDescGZIP(), []int{2}
}
...
func (x *CookbookFileContent) Reset() {
	*x = CookbookFileContent{}
	if protoimpl.UnsafeEnabled {
		mi := &file_interservice_infra_proxy_request_cookbooks_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CookbookFileContent) Descriptor() ([]byte, []int) {
	return file_interservice_infra_proxy_request_cookbooks_proto_rawDescGZIP(), []int{3}
}
...
var file_interservice_infra_proxy_request_cookbooks_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x2f, 0x63, 0x6f, 0x6f, 0x6b, 0x62, 0x6f, 0x6f, 0x6b, 0x73, 0x2e, 0x70, 0x72, 0x6f,
	...
	0x72, 0x6f, 0x78, 0x79, 0x2e, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x3f, 0x0a, 0x09,
	0x43, 0x6f, 0x6f, 0x6b, 0x62, 0x6f, 0x6f, 0x6b, 0x73, 0x12, 0x15, 0x0a, 0x06, 0x6f, 0x72, 0x67,
	...
	0x10, 0x43, 0x6f, 0x6f, 0x6b, 0x62, 0x6f, 0x6f, 0x6b, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e,
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x6c, 0x0a, 0x08, 0x43, 0x6f, 0x6f,
	0x6b, 0x62, 0x6f, 0x6f, 0x6b, 0x12, 0x15, 0x0a, 0x06, 0x6f, 0x72, 0x67, 0x5f, 0x69, 0x64, 0x18,
	...
	0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x89, 0x01, 0x0a, 0x13, 0x43, 0x6f, 0x6f, 0x6b,
	...
	0x75, 0x72, 0x6c, 0x42, 0x3f, 0x5a, 0x3d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var (
	file_interservice_infra_proxy_request_cookbooks_proto_rawDescOnce sync.Once
	file_interservice_infra_proxy_request_cookbooks_proto_rawDescData = file_interservice_infra_proxy_request_cookbooks_proto_rawDesc
)

func file_interservice_infra_proxy_request_cookbooks_proto_rawDescGZIP() []byte {
	file_interservice_infra_proxy_request_cookbooks_proto_rawDescOnce.Do(func() {
		file_interservice_infra_proxy_request_cookbooks_proto_rawDescData = protoimpl.X.CompressGZIP(file_interservice_infra_proxy_request_cookbooks_proto_rawDescData)
	})
	return file_interservice_infra_proxy_request_cookbooks_proto_rawDescData
}

var file_interservice_infra_proxy_request_cookbooks_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_interservice_infra_proxy_request_cookbooks_proto_goTypes = []interface{}{
	(*Cookbooks)(nil),           // 0: chef.automate.domain.infra_proxy.request.Cookbooks
	(*CookbookVersions)(nil),    // 1: chef.automate.domain.infra_proxy.request.CookbookVersions
	(*Cookbook)(nil),            // 2: chef.automate.domain.infra_proxy.request.Cookbook
	(*CookbookFileContent)(nil), // 3: chef.automate.domain.infra_proxy.request.CookbookFileContent
}
var file_interservice_infra_proxy_request_cookbooks_proto_depIdxs = []int32{
...
func init() { file_interservice_infra_proxy_request_cookbooks_proto_init() }
func file_interservice_infra_proxy_request_cookbooks_proto_init() {
	if File_interservice_infra_proxy_request_cookbooks_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_interservice_infra_proxy_request_cookbooks_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_interservice_infra_proxy_request_cookbooks_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_interservice_infra_proxy_request_cookbooks_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_interservice_infra_proxy_request_cookbooks_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_interservice_infra_proxy_request_cookbooks_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_interservice_infra_proxy_request_cookbooks_proto_goTypes,
		DependencyIndexes: file_interservice_infra_proxy_request_cookbooks_proto_depIdxs,
		MessageInfos:      file_interservice_infra_proxy_request_cookbooks_proto_msgTypes,
	}.Build()
	File_interservice_infra_proxy_request_cookbooks_proto = out.File
	file_interservice_infra_proxy_request_cookbooks_proto_rawDesc = nil
	file_interservice_infra_proxy_request_cookbooks_proto_goTypes = nil
	file_interservice_infra_proxy_request_cookbooks_proto_depIdxs = nil
}
