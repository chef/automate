...
var file_interservice_infra_proxy_request_cookbooks_proto_goTypes = []any{
...
func file_interservice_infra_proxy_request_cookbooks_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_interservice_infra_proxy_request_cookbooks_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_interservice_infra_proxy_request_cookbooks_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_interservice_infra_proxy_request_cookbooks_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_interservice_infra_proxy_request_cookbooks_proto_msgTypes[3].Exporter = func(v any, i int) any {
