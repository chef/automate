...
const file_interservice_infra_proxy_request_roles_proto_rawDesc = "" +
	"\n" +
	",interservice/infra_proxy/request/roles.proto\x12(chef.automate.domain.infra_proxy.request\x1a\x1cgoogle/protobuf/struct.proto\x1a-interservice/infra_proxy/request/common.proto\"\x95\x01\n" +
	"\x05Roles\x12\x15\n" +
	...
	"\x04name\x18\x03 \x01(\tR\x04name\"\xfd\x02\n" +
	"\n" +
	"CreateRole\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x12\x1b\n" +
	"\tserver_id\x18\x02 \x01(\tR\bserverId\x12\x12\n" +
	...
	"\brun_list\x18\a \x03(\tR\arunList\x12X\n" +
	"\renv_run_lists\x18\b \x03(\v24.chef.automate.domain.infra_proxy.request.EnvRunListR\venvRunLists\"\xfd\x02\n" +
	"\n" +
	"UpdateRole\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x12\x1b\n" +
	"\tserver_id\x18\x02 \x01(\tR\bserverId\x12\x12\n" +
	...
	"\x13override_attributes\x18\x06 \x01(\v2\x17.google.protobuf.StructR\x12overrideAttributes\x12\x19\n" +
	"\brun_list\x18\a \x03(\tR\arunList\x12X\n" +
	"\renv_run_lists\x18\b \x03(\v24.chef.automate.domain.infra_proxy.request.EnvRunListR\venvRunLists\";\n" +
	"\n" +
	"EnvRunList\x12\x12\n" +
...
var (
	...
	file_interservice_infra_proxy_request_roles_proto_rawDescData []byte
)
...
func file_interservice_infra_proxy_request_roles_proto_rawDescGZIP() []byte {
	file_interservice_infra_proxy_request_roles_proto_rawDescOnce.Do(func() {
		file_interservice_infra_proxy_request_roles_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_interservice_infra_proxy_request_roles_proto_rawDesc), len(file_interservice_infra_proxy_request_roles_proto_rawDesc)))
	})
...
var file_interservice_infra_proxy_request_roles_proto_goTypes = []any{
...
func file_interservice_infra_proxy_request_roles_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_interservice_infra_proxy_request_roles_proto_rawDesc), len(file_interservice_infra_proxy_request_roles_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
