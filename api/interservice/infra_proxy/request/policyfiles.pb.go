...
const file_interservice_infra_proxy_request_policyfiles_proto_rawDesc = "" +
	"\n" +
	"2interservice/infra_proxy/request/policyfiles.proto\x12(chef.automate.domain.infra_proxy.request\x1a,protoc-gen-swagger/options/annotations.proto\"A\n" +
	...
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x12\x1b\n" +
	"\tserver_id\x18\x02 \x01(\tR\bserverId\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04nameB?Z=github.com/chef/automate/api/interservice/infra_proxy/requestb\x06proto3"

var (
	file_interservice_infra_proxy_request_policyfiles_proto_rawDescOnce sync.Once
	file_interservice_infra_proxy_request_policyfiles_proto_rawDescData []byte
)
...
func file_interservice_infra_proxy_request_policyfiles_proto_rawDescGZIP() []byte {
	file_interservice_infra_proxy_request_policyfiles_proto_rawDescOnce.Do(func() {
		file_interservice_infra_proxy_request_policyfiles_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_interservice_infra_proxy_request_policyfiles_proto_rawDesc), len(file_interservice_infra_proxy_request_policyfiles_proto_rawDesc)))
	})
...
func file_interservice_infra_proxy_request_policyfiles_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_interservice_infra_proxy_request_policyfiles_proto_rawDesc), len(file_interservice_infra_proxy_request_policyfiles_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
