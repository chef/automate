...
var file_interservice_infra_proxy_migrations_service_migrations_proto_rawDesc = []byte{
	...
	0x04, 0x0a, 0x14, 0x4d, 0x69, 0x67, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x61, 0x74, 0x61,
	...
	,
	...
	0x75, 0x73, 0x1a, 0x48, 0x2e, 0x63, 0x68, 0x65, 0x66, 0x2e, 0x61, 0x75, 0x74, 0x6f, 0x6d, 0x61,
	...
	0x2e, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x47, 0x65, 0x74, 0x4d, 0x69, 0x67,
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x00, 0x12, 0xaf,
	0x01, 0x0a, 0x0f, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x4d, 0x69, 0x67, 0x72, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x12, 0x4b, 0x2e, 0x63, 0x68, 0x65, 0x66, 0x2e, 0x61, 0x75, 0x74, 0x6f, 0x6d, 0x61,
	0x74, 0x65, 0x2e, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x2e, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x5f,
	0x70, 0x72, 0x6f, 0x78, 0x79, 0x2e, 0x6d, 0x69, 0x67, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	...
	0x4d, 0x2e, 0x63, 0x68, 0x65, 0x66, 0x2e, 0x61, 0x75, 0x74, 0x6f, 0x6d, 0x61, 0x74, 0x65, 0x2e,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x4d, 0x69, 0x67,
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x63, 0x65, 0x22, 0x00,
	...
	0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}

var file_interservice_infra_proxy_migrations_service_migrations_proto_goTypes = []interface{}{
	(*request.UploadZipFileRequest)(nil),     // 0: chef.automate.domain.infra_proxy.migrations.request.UploadZipFileRequest
	(*request.GetMigrationStatus)(nil),       // 1: chef.automate.domain.infra_proxy.migrations.request.GetMigrationStatus
	(*request.CancelMigrationRequest)(nil),   // 2: chef.automate.domain.infra_proxy.migrations.request.CancelMigrationRequest
	(*response.UploadZipFileResponse)(nil),   // 3: chef.automate.domain.infra_proxy.migrations.response.UploadZipFileResponse
	(*response.GetMigrationStatus)(nil),      // 4: chef.automate.domain.infra_proxy.migrations.response.GetMigrationStatus
	(*response.CancelMigrationResponce)(nil), // 5: chef.automate.domain.infra_proxy.migrations.response.CancelMigrationResponce
}
var file_interservice_infra_proxy_migrations_service_migrations_proto_depIdxs = []int32{
	...
	1, // 1: chef.automate.domain.infra_proxy.migrations.service.MigrationDataService.GetMigrationStatus:input_type -> chef.automate.domain.infra_proxy.migrations.request.GetMigrationStatus
	...
	3, // 3: chef.automate.domain.infra_proxy.migrations.service.MigrationDataService.UploadFile:output_type -> chef.automate.domain.infra_proxy.migrations.response.UploadZipFileResponse
	4, // 4: chef.automate.domain.infra_proxy.migrations.service.MigrationDataService.GetMigrationStatus:output_type -> chef.automate.domain.infra_proxy.migrations.response.GetMigrationStatus
	5, // 5: chef.automate.domain.infra_proxy.migrations.service.MigrationDataService.CancelMigration:output_type -> chef.automate.domain.infra_proxy.migrations.response.CancelMigrationResponce
...
type MigrationDataService_UploadFileClient interface {
	Send(*request.UploadZipFileRequest) error
	CloseAndRecv() (*response.UploadZipFileResponse, error)
	grpc.ClientStream
}
...
func (x *migrationDataServiceUploadFileClient) Send(m *request.UploadZipFileRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *migrationDataServiceUploadFileClient) CloseAndRecv() (*response.UploadZipFileResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(response.UploadZipFileResponse)
...
func (c *migrationDataServiceClient) GetMigrationStatus(ctx context.Context, in *request.GetMigrationStatus, opts ...grpc.CallOption) (*response.GetMigrationStatus, error) {
...
func (c *migrationDataServiceClient) CancelMigration(ctx context.Context, in *request.CancelMigrationRequest, opts ...grpc.CallOption) (*response.CancelMigrationResponce, error) {
...
func (*UnimplementedMigrationDataServiceServer) GetMigrationStatus(context.Context, *request.GetMigrationStatus) (*response.GetMigrationStatus, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMigrationStatus not implemented")
}
func (*UnimplementedMigrationDataServiceServer) CancelMigration(context.Context, *request.CancelMigrationRequest) (*response.CancelMigrationResponce, error) {
...
type MigrationDataService_UploadFileServer interface {
	SendAndClose(*response.UploadZipFileResponse) error
	Recv() (*request.UploadZipFileRequest, error)
	grpc.ServerStream
}
...
func (x *migrationDataServiceUploadFileServer) SendAndClose(m *response.UploadZipFileResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *migrationDataServiceUploadFileServer) Recv() (*request.UploadZipFileRequest, error) {
...
func _MigrationDataService_GetMigrationStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MigrationDataServiceServer).GetMigrationStatus(ctx, req.(*request.GetMigrationStatus))
	}
