...
const file_interservice_es_sidecar_service_proto_rawDesc = "" +
	"\n" +
	"%interservice/es_sidecar/service.proto\x12\x1echef.automate.infra.es_sidecar\x1a\x1bgoogle/protobuf/empty.proto\"\xc2\x01\n" +
	"\fPurgeRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05index\x18\x02 \x01(\tR\x05index\x12&\n" +
	"\x0folder_than_days\x18\x03 \x01(\x05R\rolderThanDays\x126\n" +
	"\x18purge_when_not_in_backup\x18\x04 \x01(\bR\x14purgeWhenNotInBackup\x12,\n" +
	"\x12custom_purge_field\x18\x05 \x01(\tR\x10customPurgeField\"\xc5\x01\n" +
	"\rPurgeResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12Q\n" +
	"\bfailures\x18\x03 \x03(\v25.chef.automate.infra.es_sidecar.PurgeResponse.FailureR\bfailures\x1a-\n" +
	"\aFailure\x12\x0e\n" +
	...
	"\x18CreateRepositoryResponse\"F\n" +
	"!ConvergeRepositorySettingsRequest\x12!\n" +
	"\fservice_name\x18\x01 \x01(\tR\vserviceName\"$\n" +
	"\"ConvergeRepositorySettingsResponse\"<\n" +
	"\x17RemoveRepositoryRequest\x12!\n" +
	"\fservice_name\x18\x01 \x01(\tR\vserviceName\"\x1a\n" +
	"\x18RemoveRepositoryResponse\"\x93\x01\n" +
	"\x15CreateSnapshotRequest\x12!\n" +
	"\fservice_name\x18\x01 \x01(\tR\vserviceName\x12:\n" +
	"\x19multi_index_specification\x18\x02 \x01(\tR\x17multiIndexSpecification\x12\x1b\n" +
	"\tbackup_id\x18\x03 \x01(\tR\bbackupId\"\x18\n" +
	"\x16CreateSnapshotResponse\"]\n" +
	"\x1bCreateSnapshotStatusRequest\x12!\n" +
	"\fservice_name\x18\x01 \x01(\tR\vserviceName\x12\x1b\n" +
	"\tbackup_id\x18\x02 \x01(\tR\bbackupId\"\xbf\x01\n" +
	"\x1cCreateSnapshotStatusResponse\x12T\n" +
	"\x0esnapshot_state\x18\x01 \x01(\x0e2-.chef.automate.infra.es_sidecar.SnapshotStateR\rsnapshotState\x12/\n" +
	...
	"\fservice_name\x18\x01 \x01(\tR\vserviceName\x12\x1b\n" +
	"\tbackup_id\x18\x02 \x01(\tR\bbackupId\"\x19\n" +
	"\x17RestoreSnapshotResponse\"^\n" +
	"\x1cRestoreSnapshotStatusRequest\x12!\n" +
	"\fservice_name\x18\x01 \x01(\tR\vserviceName\x12\x1b\n" +
	"\tbackup_id\x18\x02 \x01(\tR\bbackupId\"\xc0\x01\n" +
	"\x1dRestoreSnapshotStatusResponse\x12T\n" +
	"\x0esnapshot_state\x18\x01 \x01(\x0e2-.chef.automate.infra.es_sidecar.SnapshotStateR\rsnapshotState\x12/\n" +
	"\x13progress_percentage\x18\x02 \x01(\x01R\x12progressPercentage\x12\x18\n" +
	"\amessage\x18\x03 \x01(\tR\amessage\"W\n" +
	"\x15DeleteSnapshotRequest\x12!\n" +
	"\fservice_name\x18\x01 \x01(\tR\vserviceName\x12\x1b\n" +
	"\tbackup_id\x18\x02 \x01(\tR\bbackupId\"\x18\n" +
	"\x16DeleteSnapshotResponse*F\n" +
	"\rSnapshotState\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\v\n" +
	"\aSUCCESS\x10\x01\x12\x0f\n" +
	"\vIN_PROGRESS\x10\x02\x12\n" +
	"\n" +
	"\x06FAILED\x10\x032\xc7\v\n" +
	"\x10EsSidecarService\x12z\n" +
	"\x1bPurgeTimeSeriesIndicesByAge\x12,.chef.automate.infra.es_sidecar.PurgeRequest\x1a-.chef.automate.infra.es_sidecar.PurgeResponse\x12{\n" +
	"\x1cPurgeDocumentsFromIndexByAge\x12,.chef.automate.infra.es_sidecar.PurgeRequest\x1a-.chef.automate.infra.es_sidecar.PurgeResponse\x12\x85\x01\n" +
	"\x10CreateRepository\x127.chef.automate.infra.es_sidecar.CreateRepositoryRequest\x1a8.chef.automate.infra.es_sidecar.CreateRepositoryResponse\x12\xa3\x01\n" +
	"\x1aConvergeRepositorySettings\x12A.chef.automate.infra.es_sidecar.ConvergeRepositorySettingsRequest\x1aB.chef.automate.infra.es_sidecar.ConvergeRepositorySettingsResponse\x12\x85\x01\n" +
	"\x10RemoveRepository\x127.chef.automate.infra.es_sidecar.RemoveRepositoryRequest\x1a8.chef.automate.infra.es_sidecar.RemoveRepositoryResponse\x12\x7f\n" +
	"\x0eCreateSnapshot\x125.chef.automate.infra.es_sidecar.CreateSnapshotRequest\x1a6.chef.automate.infra.es_sidecar.CreateSnapshotResponse\x12\x91\x01\n" +
	"\x14CreateSnapshotStatus\x12;.chef.automate.infra.es_sidecar.CreateSnapshotStatusRequest\x1a<.chef.automate.infra.es_sidecar.CreateSnapshotStatusResponse\x12\x82\x01\n" +
	"\x0fRestoreSnapshot\x126.chef.automate.infra.es_sidecar.RestoreSnapshotRequest\x1a7.chef.automate.infra.es_sidecar.RestoreSnapshotResponse\x12\x94\x01\n" +
	"\x15RestoreSnapshotStatus\x12<.chef.automate.infra.es_sidecar.RestoreSnapshotStatusRequest\x1a=.chef.automate.infra.es_sidecar.RestoreSnapshotStatusResponse\x12\x7f\n" +
	"\x0eDeleteSnapshot\x125.chef.automate.infra.es_sidecar.DeleteSnapshotRequest\x1a6.chef.automate.infra.es_sidecar.DeleteSnapshotResponse\x12R\n" +
	"\aVersion\x12\x16.google.protobuf.Empty\x1a/.chef.automate.infra.es_sidecar.VersionResponseB6Z4github.com/chef/automate/api/interservice/es_sidecarb\x06proto3"

var (
	file_interservice_es_sidecar_service_proto_rawDescOnce sync.Once
	file_interservice_es_sidecar_service_proto_rawDescData []byte
)
...
func file_interservice_es_sidecar_service_proto_rawDescGZIP() []byte {
	file_interservice_es_sidecar_service_proto_rawDescOnce.Do(func() {
		file_interservice_es_sidecar_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_interservice_es_sidecar_service_proto_rawDesc), len(file_interservice_es_sidecar_service_proto_rawDesc)))
	})
...
func file_interservice_es_sidecar_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_interservice_es_sidecar_service_proto_rawDesc), len(file_interservice_es_sidecar_service_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   20,
			NumExtensions: 0,
			NumServices:   1,
