...
type Policy struct {
	...
	Rules         map[string]string      `protobuf:"bytes,4,rep,name=rules,proto3" json:"rules,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value" toml:"rules,omitempty" mapstructure:"rules,omitempty"`
...
const file_interservice_license_control_license_control_proto_rawDesc = "" +
	"\n" +
	"2interservice/license_control/license_control.proto\x12$chef.automate.domain.license_control\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x15license/license.proto\"\x10\n" +
	"\x0eLicenseRequest\"=\n" +
	"\x0fLicenseResponse\x12*\n" +
	"\alicense\x18\x01 \x01(\v2\x10.license.LicenseR\alicense\"\x0f\n" +
	"\rPolicyRequest\"V\n" +
	"\x0ePolicyResponse\x12D\n" +
	"\x06policy\x18\x01 \x01(\v2,.chef.automate.domain.license_control.PolicyR\x06policy\"\xdd\x02\n" +
	"\x06Policy\x12\x1d\n" +
	"\n" +
	"license_id\x18\x01 \x01(\tR\tlicenseId\x12\x14\n" +
	"\x05valid\x18\x02 \x01(\bR\x05valid\x12T\n" +
	"\fcapabilities\x18\x03 \x03(\v20.chef.automate.domain.license_control.CapabilityR\fcapabilities\x12M\n" +
	"\x05rules\x18\x04 \x03(\v27.chef.automate.domain.license_control.Policy.RulesEntryR\x05rules\x12?\n" +
	"\rconfigured_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\fconfiguredAt\x1a8\n" +
	"\n" +
	"RulesEntry\x12\x10\n" +
	...
	"\x03end\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x03end\"\x0f\n" +
	"\rStatusRequest\"\xc4\x03\n" +
	"\x0eStatusResponse\x12\x1d\n" +
	"\n" +
	"license_id\x18\x01 \x01(\tR\tlicenseId\x12?\n" +
	"\rconfigured_at\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\fconfiguredAt\x12X\n" +
	"\x0flicensed_period\x18\x03 \x01(\v2/.chef.automate.domain.license_control.DateRangeR\x0elicensedPeriod\x12#\n" +
	...
	"\fgrace_period\x18\t \x01(\bR\vgracePeriod\"k\n" +
	"\tDateRange\x120\n" +
	"\x05start\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\x05start\x12,\n" +
	"\x03end\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\x03end\"H\n" +
	"\rUpdateRequest\x12!\n" +
	"\flicense_data\x18\x01 \x01(\tR\vlicenseData\x12\x14\n" +
	...
	"\x10TelemetryRequest\"e\n" +
	"\x11TelemetryResponse\x12+\n" +
	"\x11telemetry_enabled\x18\x01 \x01(\bR\x10telemetryEnabled\x12#\n" +
	"\rtelemetry_url\x18\x02 \x01(\tR\ftelemetryUrl\"\x18\n" +
	"\x16GetDeploymentIDRequest\"\xa8\x01\n" +
	"\x17GetDeploymentIDResponse\x12#\n" +
	"\rdeployment_id\x18\x01 \x01(\tR\fdeploymentId\x12'\n" +
	"\x0fdeployment_type\x18\x02 \x01(\tR\x0edeploymentType\x12?\n" +
	"\rdeployment_at\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\fdeploymentAt2\xfd\x05\n" +
	"\x15LicenseControlService\x12v\n" +
	"\aLicense\x124.chef.automate.domain.license_control.LicenseRequest\x1a5.chef.automate.domain.license_control.LicenseResponse\x12s\n" +
	"\x06Policy\x123.chef.automate.domain.license_control.PolicyRequest\x1a4.chef.automate.domain.license_control.PolicyResponse\x12s\n" +
	"\x06Status\x123.chef.automate.domain.license_control.StatusRequest\x1a4.chef.automate.domain.license_control.StatusResponse\x12s\n" +
	"\x06Update\x123.chef.automate.domain.license_control.UpdateRequest\x1a4.chef.automate.domain.license_control.UpdateResponse\x12|\n" +
	"\tTelemetry\x126.chef.automate.domain.license_control.TelemetryRequest\x1a7.chef.automate.domain.license_control.TelemetryResponse\x12\x8e\x01\n" +
	"\x0fGetDeploymentID\x12<.chef.automate.domain.license_control.GetDeploymentIDRequest\x1a=.chef.automate.domain.license_control.GetDeploymentIDResponseB;Z9github.com/chef/automate/api/interservice/license_controlb\x06proto3"

var (
	file_interservice_license_control_license_control_proto_rawDescOnce sync.Once
	file_interservice_license_control_license_control_proto_rawDescData []byte
)
...
func file_interservice_license_control_license_control_proto_rawDescGZIP() []byte {
	file_interservice_license_control_license_control_proto_rawDescOnce.Do(func() {
		file_interservice_license_control_license_control_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_interservice_license_control_license_control_proto_rawDesc), len(file_interservice_license_control_license_control_proto_rawDesc)))
	})
...
func file_interservice_license_control_license_control_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_interservice_license_control_license_control_proto_rawDesc), len(file_interservice_license_control_license_control_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   16,
			NumExtensions: 0,
			NumServices:   1,
