...
func (c *complianceStatusServiceClient) GetMigrationStatus(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*MigrationStatus, error) {
...
func (*UnimplementedComplianceStatusServiceServer) GetMigrationStatus(context.Context, *empty.Empty) (*MigrationStatus, error) {
...
func _ComplianceStatusService_GetMigrationStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ComplianceStatusServiceServer).GetMigrationStatus(ctx, req.(*empty.Empty))
	}
