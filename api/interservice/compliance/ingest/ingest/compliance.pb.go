...
func (x *complianceIngesterServiceProcessComplianceReportClient) CloseAndRecv() (*empty.Empty, error) {
...
func (x *complianceIngesterServiceProcessComplianceReportServer) SendAndClose(m *empty.Empty) error {
