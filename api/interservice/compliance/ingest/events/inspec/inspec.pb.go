...
const file_interservice_compliance_ingest_events_inspec_inspec_proto_rawDesc = "" +
	"\n" +
	"9interservice/compliance/ingest/events/inspec/inspec.proto\x124chef.automate.domain.compliance.ingest.events.inspec\x1a\x1cgoogle/protobuf/struct.proto\"\x9d\x03\n" +
	"\x06Report\x12\x18\n" +
	"\aversion\x18\x01 \x01(\tR\aversion\x12Z\n" +
	"\bplatform\x18\x02 \x01(\v2>.chef.automate.domain.compliance.ingest.events.inspec.PlatformR\bplatform\x12`\n" +
	"\n" +
	"statistics\x18\x03 \x01(\v2@.chef.automate.domain.compliance.ingest.events.inspec.StatisticsR\n" +
	"statistics\x12!\n" +
	"\fother_checks\x18\x04 \x03(\tR\votherChecks\x12\x16\n" +
	"\x06status\x18\x05 \x01(\tR\x06status\x12%\n" +
	"\x0estatus_message\x18\x06 \x01(\tR\rstatusMessage\x12Y\n" +
	"\bprofiles\x18\x14 \x03(\v2=.chef.automate.domain.compliance.ingest.events.inspec.ProfileR\bprofiles\"8\n" +
	"\bPlatform\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x18\n" +
	"\arelease\x18\x02 \x01(\tR\arelease\"(\n" +
	"\n" +
	"Statistics\x12\x1a\n" +
	"\bduration\x18\x01 \x01(\x02R\bduration\"\xd1\x06\n" +
	"\aProfile\x12\x12\n" +
	"\x04name\x18\x14 \x01(\tR\x04name\x12\x14\n" +
	"\x05title\x18\x15 \x01(\tR\x05title\x12\x18\n" +
	"\aversion\x18\x16 \x01(\tR\aversion\x12\x18\n" +
	"\asummary\x18\x17 \x01(\tR\asummary\x12\x1e\n" +
	"\n" +
	"maintainer\x18\x18 \x01(\tR\n" +
	"maintainer\x12\x18\n" +
	"\alicense\x18\x19 \x01(\tR\alicense\x12\x1c\n" +
	"\tcopyright\x18\x1a \x01(\tR\tcopyright\x12'\n" +
	"\x0fcopyright_email\x18\x1b \x01(\tR\x0ecopyrightEmail\x12\x16\n" +
	"\x06sha256\x18\x1c \x01(\tR\x06sha256\x12Y\n" +
	"\bcontrols\x18\x1d \x03(\v2=.chef.automate.domain.compliance.ingest.events.inspec.ControlR\bcontrols\x12Y\n" +
	"\bsupports\x18\x1e \x03(\v2=.chef.automate.domain.compliance.ingest.events.inspec.SupportR\bsupports\x12_\n" +
	"\n" +
	"attributes\x18\x1f \x03(\v2?.chef.automate.domain.compliance.ingest.events.inspec.AttributeR\n" +
	"attributes\x12Z\n" +
	"\adepends\x18  \x03(\v2@.chef.automate.domain.compliance.ingest.events.inspec.DependencyR\adepends\x12S\n" +
	"\x06groups\x18! \x03(\v2;.chef.automate.domain.compliance.ingest.events.inspec.GroupR\x06groups\x12%\n" +
	"\x0eparent_profile\x18\" \x01(\tR\rparentProfile\x12\x16\n" +
	"\x06status\x18# \x01(\tR\x06status\x12!\n" +
	"\fskip_message\x18$ \x01(\tR\vskipMessage\x12%\n" +
	"\x0estatus_message\x18% \x01(\tR\rstatusMessage\"\xf6\x04\n" +
	"\aControl\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x16\n" +
	"\x06impact\x18\x02 \x01(\x02R\x06impact\x12\x14\n" +
	"\x05title\x18\x03 \x01(\tR\x05title\x12\x12\n" +
	"\x04code\x18\x14 \x01(\tR\x04code\x12\x12\n" +
	"\x04desc\x18\x15 \x01(\tR\x04desc\x12m\n" +
	"\x0fsource_location\x18\x16 \x01(\v2D.chef.automate.domain.compliance.ingest.events.inspec.SourceLocationR\x0esourceLocation\x12+\n" +
	"\x04refs\x18\x17 \x03(\v2\x17.google.protobuf.StructR\x04refs\x12+\n" +
	"\x04tags\x18\x18 \x01(\v2\x17.google.protobuf.StructR\x04tags\x12V\n" +
	"\aresults\x18\x19 \x03(\v2<.chef.automate.domain.compliance.ingest.events.inspec.ResultR\aresults\x12a\n" +
	"\vwaiver_data\x18\x1a \x01(\v2@.chef.automate.domain.compliance.ingest.events.inspec.WaiverDataR\n" +
	"waiverData\x12\x80\x01\n" +
	"\x16removed_results_counts\x18\x1b \x01(\v2J.chef.automate.domain.compliance.ingest.events.inspec.RemovedResultsCountsR\x14removedResultsCounts\"\xba\x01\n" +
	"\n" +
	"WaiverData\x12'\n" +
	...
	"\x06passed\x18\x03 \x01(\x05R\x06passed\"\xd0\x01\n" +
	"\x06Result\x12\x16\n" +
	...
	"\fskip_message\x18\x15 \x01(\tR\vskipMessage\"6\n" +
	"\x0eSourceLocation\x12\x10\n" +
	"\x03ref\x18\x01 \x01(\tR\x03ref\x12\x12\n" +
	"\x04line\x18\x02 \x01(\x05R\x04line\"\xdf\x01\n" +
	"\aSupport\x12\x16\n" +
	"\x06inspec\x18\x01 \x01(\tR\x06inspec\x12\x18\n" +
	"\aos_name\x18\x02 \x01(\tR\aos-name\x12\x1c\n" +
	"\tos_family\x18\x03 \x01(\tR\tos-family\x12\x18\n" +
	...
	"\bplatform\x18\a \x01(\tR\bplatform\"R\n" +
	"\tAttribute\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x121\n" +
	"\aoptions\x18\x14 \x01(\v2\x17.google.protobuf.StructR\aoptions\"\xb1\x02\n" +
	"\n" +
	"Dependency\x12\x12\n" +
	"\x04name\x18\x15 \x01(\tR\x04name\x12\x10\n" +
	"\x03url\x18\x16 \x01(\tR\x03url\x12\x12\n" +
	"\x04path\x18\x17 \x01(\tR\x04path\x12\x10\n" +
	"\x03git\x18\x18 \x01(\tR\x03git\x12\x16\n" +
	"\x06branch\x18\x19 \x01(\tR\x06branch\x12\x10\n" +
	"\x03tag\x18\x1a \x01(\tR\x03tag\x12\x16\n" +
	"\x06commit\x18\x1b \x01(\tR\x06commit\x12\x18\n" +
	"\aversion\x18\x1c \x01(\tR\aversion\x12 \n" +
	"\vsupermarket\x18\x1d \x01(\tR\vsupermarket\x12\x1e\n" +
	"\n" +
	"compliance\x18\x1e \x01(\tR\n" +
	"compliance\x12\x16\n" +
	"\x06status\x18\x1f \x01(\tR\x06status\x12!\n" +
	"\fskip_message\x18  \x01(\tR\vskipMessage\"I\n" +
	"\x05Group\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12\x1a\n" +
	"\bcontrols\x18\x15 \x03(\tR\bcontrolsBKZIgithub.com/chef/automate/api/interservice/compliance/ingest/events/inspecb\x06proto3"

var (
	file_interservice_compliance_ingest_events_inspec_inspec_proto_rawDescOnce sync.Once
	file_interservice_compliance_ingest_events_inspec_inspec_proto_rawDescData []byte
)
...
func file_interservice_compliance_ingest_events_inspec_inspec_proto_rawDescGZIP() []byte {
	file_interservice_compliance_ingest_events_inspec_inspec_proto_rawDescOnce.Do(func() {
		file_interservice_compliance_ingest_events_inspec_inspec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_interservice_compliance_ingest_events_inspec_inspec_proto_rawDesc), len(file_interservice_compliance_ingest_events_inspec_inspec_proto_rawDesc)))
	})
...
func file_interservice_compliance_ingest_events_inspec_inspec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_interservice_compliance_ingest_events_inspec_inspec_proto_rawDesc), len(file_interservice_compliance_ingest_events_inspec_inspec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   13,
			NumExtensions: 0,
			NumServices:   0,
