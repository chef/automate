...
const file_interservice_compliance_profiles_profiles_proto_rawDesc = "" +
	"\n" +
	"/interservice/compliance/profiles/profiles.proto\x12(chef.automate.domain.compliance.profiles\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\" \n" +
	"\x06Sha256\x12\x16\n" +
	"\x06sha256\x18\x01 \x03(\tR\x06sha256\"0\n" +
	"\aMissing\x12%\n" +
	"\x0emissing_sha256\x18\x01 \x03(\tR\rmissingSha256\"\xb9\x01\n" +
	"\x12ProfilePostRequest\x12\x14\n" +
	"\x05owner\x18\x05 \x01(\tR\x05owner\x12E\n" +
	"\x05chunk\x18\x02 \x01(\v2/.chef.automate.domain.compliance.profiles.ChunkR\x05chunk\x12F\n" +
	"\x04meta\x18\x03 \x01(\v22.chef.automate.domain.compliance.profiles.MetadataR\x04meta\"Z\n" +
	"\bMetadata\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x18\n" +
	"\aversion\x18\x03 \x01(\tR\aversion\x12 \n" +
	"\vcontentType\x18\x04 \x01(\tR\vcontentType\"7\n" +
	"\x05Chunk\x12\x12\n" +
	"\x04data\x18\x01 \x01(\fR\x04data\x12\x1a\n" +
	"\bposition\x18\x02 \x01(\x03R\bposition\"e\n" +
	...
	"\bProfiles\x12M\n" +
	"\bprofiles\x18\x01 \x03(\v21.chef.automate.domain.compliance.profiles.ProfileR\bprofiles\x12\x14\n" +
	"\x05total\x18\x14 \x01(\x05R\x05total\"\xc9\x05\n" +
	"\aProfile\x12\x12\n" +
	...
	"\x05owner\x18\t \x01(\tR\x05owner\x12M\n" +
	"\bsupports\x18\x10 \x03(\v21.chef.automate.domain.compliance.profiles.SupportR\bsupports\x12N\n" +
	"\adepends\x18\x11 \x03(\v24.chef.automate.domain.compliance.profiles.DependencyR\adepends\x12\x16\n" +
	"\x06sha256\x18\x12 \x01(\tR\x06sha256\x12G\n" +
	"\x06groups\x18\x13 \x03(\v2/.chef.automate.domain.compliance.profiles.GroupR\x06groups\x12M\n" +
	"\bcontrols\x18\x14 \x03(\v21.chef.automate.domain.compliance.profiles.ControlR\bcontrols\x12S\n" +
	"\n" +
	"attributes\x18\x15 \x03(\v23.chef.automate.domain.compliance.profiles.AttributeR\n" +
	"attributes\x12%\n" +
	"\x0elatest_version\x18\x16 \x01(\tR\rlatestVersion\"I\n" +
	"\x05Group\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12\x1a\n" +
	"\bcontrols\x18\x03 \x03(\tR\bcontrols\"\xeb\x03\n" +
	"\aControl\x12\x0e\n" +
	...
	"\x0fsource_location\x18\x06 \x01(\v28.chef.automate.domain.compliance.profiles.SourceLocationR\x0esourceLocation\x12J\n" +
	"\aresults\x18\a \x03(\v20.chef.automate.domain.compliance.profiles.ResultR\aresults\x12A\n" +
	"\x04refs\x18\b \x03(\v2-.chef.automate.domain.compliance.profiles.RefR\x04refs\x12O\n" +
	"\x04tags\x18\t \x03(\v2;.chef.automate.domain.compliance.profiles.Control.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	...
	"\x04line\x18\x02 \x01(\x05R\x04line\"k\n" +
	"\tAttribute\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12J\n" +
	"\aoptions\x18\x02 \x01(\v20.chef.automate.domain.compliance.profiles.OptionR\aoptions\"D\n" +
	"\x06Option\x12 \n" +
	...
	"\bplatform\x18\x05 \x01(\tR\bplatform\"\x8e\x02\n" +
	"\n" +
	"Dependency\x12\x12\n" +
	...
	"compliance\"T\n" +
	"\x0eProfileDetails\x12\x14\n" +
	"\x05owner\x18\x01 \x01(\tR\x05owner\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x18\n" +
	"\aversion\x18\x03 \x01(\tR\aversion\"\x84\x02\n" +
	"\vCheckResult\x12Q\n" +
	"\asummary\x18\x01 \x01(\v27.chef.automate.domain.compliance.profiles.ResultSummaryR\asummary\x12N\n" +
	"\x06errors\x18\x02 \x03(\v26.chef.automate.domain.compliance.profiles.CheckMessageR\x06errors\x12R\n" +
	"\bwarnings\x18\x03 \x03(\v26.chef.automate.domain.compliance.profiles.CheckMessageR\bwarnings\"{\n" +
	...
	"\bcontrols\x18\x04 \x01(\x05R\bcontrols\"\x7f\n" +
	"\fCheckMessage\x12\x12\n" +
	...
	"\n" +
	"control_id\x18\x04 \x01(\tR\tcontrolId\x12\x10\n" +
	"\x03msg\x18\x05 \x01(\tR\x03msg\"8\n" +
	"\n" +
	"ListFilter\x12\x16\n" +
	"\x06values\x18\x14 \x03(\tR\x06values\x12\x12\n" +
	"\x04type\x18\x15 \x01(\tR\x04type\"\xcf\x02\n" +
	"\x05Query\x12N\n" +
	"\afilters\x18\x14 \x03(\v24.chef.automate.domain.compliance.profiles.ListFilterR\afilters\x12O\n" +
	"\x05order\x18\x15 \x01(\x0e29.chef.automate.domain.compliance.profiles.Query.OrderTypeR\x05order\x12\x12\n" +
	"\x04sort\x18\x16 \x01(\tR\x04sort\x12\x12\n" +
	"\x04page\x18\x17 \x01(\x05R\x04page\x12\x19\n" +
	"\bper_page\x18\x18 \x01(\x05R\aperPage\x12\x14\n" +
	"\x05owner\x18\x19 \x01(\tR\x05owner\x12\x12\n" +
	"\x04name\x18\x1a \x01(\tR\x04name\x12\x18\n" +
	"\aversion\x18\x1b \x01(\tR\aversion\"\x1e\n" +
	"\tOrderType\x12\a\n" +
	"\x03ASC\x10\x00\x12\b\n" +
	"\x04DESC\x10\x012\xce\x05\n" +
	"\x0fProfilesService\x12\x81\x01\n" +
	"\x06Create\x12<.chef.automate.domain.compliance.profiles.ProfilePostRequest\x1a5.chef.automate.domain.compliance.profiles.CheckResult\"\x00(\x01\x12u\n" +
	"\x04Read\x128.chef.automate.domain.compliance.profiles.ProfileDetails\x1a1.chef.automate.domain.compliance.profiles.Profile\"\x00\x12~\n" +
	"\aReadTar\x128.chef.automate.domain.compliance.profiles.ProfileDetails\x1a5.chef.automate.domain.compliance.profiles.ProfileData\"\x000\x01\x12\\\n" +
	"\x06Delete\x128.chef.automate.domain.compliance.profiles.ProfileDetails\x1a\x16.google.protobuf.Empty\"\x00\x12m\n" +
	"\x04List\x12/.chef.automate.domain.compliance.profiles.Query\x1a2.chef.automate.domain.compliance.profiles.Profiles\"\x00\x12s\n" +
	"\n" +
	"MetaSearch\x120.chef.automate.domain.compliance.profiles.Sha256\x1a1.chef.automate.domain.compliance.profiles.Missing\"\x002\xa8\x01\n" +
	"\x14ProfilesAdminService\x12G\n" +
	"\x13RebuildElasticCache\x12\x16.google.protobuf.Empty\x1a\x16.google.protobuf.Empty\"\x00\x12G\n" +
	"\x13MigrateDiskProfiles\x12\x16.google.protobuf.Empty\x1a\x16.google.protobuf.Empty\"\x00B?Z=github.com/chef/automate/api/interservice/compliance/profilesb\x06proto3"

var (
	file_interservice_compliance_profiles_profiles_proto_rawDescOnce sync.Once
	file_interservice_compliance_profiles_profiles_proto_rawDescData []byte
)
...
func file_interservice_compliance_profiles_profiles_proto_rawDescGZIP() []byte {
	file_interservice_compliance_profiles_profiles_proto_rawDescOnce.Do(func() {
		file_interservice_compliance_profiles_profiles_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_interservice_compliance_profiles_profiles_proto_rawDesc), len(file_interservice_compliance_profiles_profiles_proto_rawDesc)))
	})
...
func file_interservice_compliance_profiles_profiles_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_interservice_compliance_profiles_profiles_proto_rawDesc), len(file_interservice_compliance_profiles_profiles_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   24,
			NumExtensions: 0,
			NumServices:   2,
