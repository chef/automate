...
func (*UnimplementedProfilesServiceServer) Delete(context.Context, *ProfileDetails) (*empty.Empty, error) {
...
func (*UnimplementedProfilesAdminServiceServer) RebuildElasticCache(context.Context, *empty.Empty) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RebuildElasticCache not implemented")
}
func (*UnimplementedProfilesAdminServiceServer) MigrateDiskProfiles(context.Context, *empty.Empty) (*empty.Empty, error) {
