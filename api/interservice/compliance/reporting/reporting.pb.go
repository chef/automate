...
type Control struct {
	...
	StringTags           map[string]*TagValues  `protobuf:"bytes,10,rep,name=string_tags,json=stringTags,proto3" json:"string_tags,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value" toml:"string_tags,omitempty" mapstructure:"string_tags,omitempty"`
...
const file_interservice_compliance_reporting_reporting_proto_rawDesc = "" +
	"\n" +
	"1interservice/compliance/reporting/reporting.proto\x12)chef.automate.domain.compliance.reporting\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"w\n" +
	"\x14ReportContentRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12O\n" +
	"\afilters\x18\x02 \x03(\v25.chef.automate.domain.compliance.reporting.ListFilterR\afilters\"1\n" +
	...
	"\afilters\x18\x14 \x03(\v25.chef.automate.domain.compliance.reporting.ListFilterR\afilters\x12P\n" +
	"\x05order\x18\x15 \x01(\x0e2:.chef.automate.domain.compliance.reporting.Query.OrderTypeR\x05order\x12\x12\n" +
	...
	"\x04type\x18\x15 \x01(\tR\x04type\"^\n" +
	"\vListFilters\x12O\n" +
	"\afilters\x18\x01 \x03(\v25.chef.automate.domain.compliance.reporting.ListFilterR\afilters\"\x1d\n" +
	"\x05Total\x12\x14\n" +
	...
	"\x06passed\x18\x02 \x01(\v20.chef.automate.domain.compliance.reporting.TotalR\x06passed\x12J\n" +
	"\askipped\x18\x03 \x01(\v20.chef.automate.domain.compliance.reporting.TotalR\askipped\x12I\n" +
	"\x06failed\x18\x04 \x01(\v21.chef.automate.domain.compliance.reporting.FailedR\x06failed\x12H\n" +
	"\x06waived\x18\x05 \x01(\v20.chef.automate.domain.compliance.reporting.TotalR\x06waived\"\xae\x01\n" +
	"\x12ControlItemRequest\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text\x12\x12\n" +
	"\x04size\x18\x02 \x01(\x05R\x04size\x12\x1f\n" +
	"\vpage_number\x18\x03 \x01(\x05R\n" +
	"pageNumber\x12O\n" +
	"\afilters\x18\x04 \x03(\v25.chef.automate.domain.compliance.reporting.ListFilterR\afilters\"\xdc\x01\n" +
	"\n" +
	"WaiverData\x12\x1d\n" +
	"\n" +
	...
	"\x0ewaiver_summary\x18\x04 \x01(\v29.chef.automate.domain.compliance.reporting.ControlSummaryR\rwaiverSummary\"\x88\x03\n" +
	"\vControlItem\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12O\n" +
	"\aprofile\x18\x03 \x01(\v25.chef.automate.domain.compliance.reporting.ProfileMinR\aprofile\x12\x16\n" +
	"\x06impact\x18\x04 \x01(\x02R\x06impact\x125\n" +
	"\bend_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\aendTime\x12b\n" +
	"\x0fcontrol_summary\x18\x06 \x01(\v29.chef.automate.domain.compliance.reporting.ControlSummaryR\x0econtrolSummary\x12O\n" +
	"\awaivers\x18\a \x03(\v25.chef.automate.domain.compliance.reporting.WaiverDataR\awaivers\"\xdc\x01\n" +
	"\fControlItems\x12[\n" +
	"\rcontrol_items\x18\x01 \x03(\v26.chef.automate.domain.compliance.reporting.ControlItemR\fcontrolItems\x12o\n" +
	"\x16control_summary_totals\x18\x02 \x01(\v29.chef.automate.domain.compliance.reporting.ControlSummaryR\x14controlSummaryTotals\"\x8a\x01\n" +
	"\x16ReportsSummaryLevelOne\x12Z\n" +
	"\areports\x18\x01 \x03(\v2@.chef.automate.domain.compliance.reporting.ReportSummaryLevelOneR\areports\x12\x14\n" +
	...
	"\bcontrols\x18\x06 \x01(\v29.chef.automate.domain.compliance.reporting.ControlSummaryR\bcontrols\x12\x1c\n" +
	"\tipaddress\x18\a \x01(\tR\tipaddress\"l\n" +
	"\aReports\x12K\n" +
	"\areports\x18\x01 \x03(\v21.chef.automate.domain.compliance.reporting.ReportR\areports\x12\x14\n" +
	...
	"\bend_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\aendTime\x12\x16\n" +
	"\x06status\x18\x05 \x01(\tR\x06status\x12U\n" +
	"\bcontrols\x18\x06 \x01(\v29.chef.automate.domain.compliance.reporting.ControlSummaryR\bcontrols\x12 \n" +
	"\venvironment\x18\a \x01(\tR\venvironment\x12\x18\n" +
	"\aversion\x18\b \x01(\tR\aversion\x12O\n" +
	"\bplatform\x18\t \x01(\v23.chef.automate.domain.compliance.reporting.PlatformR\bplatform\x12U\n" +
	"\n" +
	"statistics\x18\n" +
	" \x01(\v25.chef.automate.domain.compliance.reporting.StatisticsR\n" +
	"statistics\x12N\n" +
	"\bprofiles\x18\v \x03(\v22.chef.automate.domain.compliance.reporting.ProfileR\bprofiles\x12\x15\n" +
	...
	"\bplatform\x18\a \x01(\v23.chef.automate.domain.compliance.reporting.PlatformR\bplatform\x12\\\n" +
	"\bprofiles\x18\b \x03(\v2@.chef.automate.domain.compliance.reporting.NodeHeaderProfileInfoR\bprofiles\x12\x14\n" +
	"\x05roles\x18\t \x03(\tR\x05roles\x12%\n" +
	"\x0estatus_message\x18\n" +
	" \x01(\tR\rstatusMessage\"u\n" +
	"\tReportIds\x12\x10\n" +
	"\x03ids\x18\x01 \x03(\tR\x03ids\x12V\n" +
	"\vreport_data\x18\x02 \x03(\v25.chef.automate.domain.compliance.reporting.ReportDataR\n" +
	"reportData\"S\n" +
	"\n" +
	"ReportData\x12\x0e\n" +
	...
	"\x04full\x18\n" +
	" \x01(\tR\x04full\x12N\n" +
	"\bsupports\x18\x10 \x03(\v22.chef.automate.domain.compliance.reporting.SupportR\bsupports\x12O\n" +
	"\adepends\x18\x11 \x03(\v25.chef.automate.domain.compliance.reporting.DependencyR\adepends\x12\x16\n" +
	"\x06sha256\x18\x12 \x01(\tR\x06sha256\x12H\n" +
	"\x06groups\x18\x13 \x03(\v20.chef.automate.domain.compliance.reporting.GroupR\x06groups\x12N\n" +
	"\bcontrols\x18\x14 \x03(\v22.chef.automate.domain.compliance.reporting.ControlR\bcontrols\x12T\n" +
	"\n" +
	"attributes\x18\x15 \x03(\v24.chef.automate.domain.compliance.reporting.AttributeR\n" +
	"attributes\x12%\n" +
	...
	"\bcontrols\x18\x03 \x03(\tR\bcontrols\"\xc4\x06\n" +
	"\aControl\x12\x0e\n" +
	...
	"\x0fsource_location\x18\x06 \x01(\v29.chef.automate.domain.compliance.reporting.SourceLocationR\x0esourceLocation\x12K\n" +
	"\aresults\x18\a \x03(\v21.chef.automate.domain.compliance.reporting.ResultR\aresults\x12B\n" +
	"\x04refs\x18\b \x03(\v2..chef.automate.domain.compliance.reporting.RefR\x04refs\x12\x12\n" +
	"\x04tags\x18\t \x01(\tR\x04tags\x12c\n" +
	"\vstring_tags\x18\n" +
	" \x03(\v2B.chef.automate.domain.compliance.reporting.Control.StringTagsEntryR\n" +
	"stringTags\x12\x1d\n" +
	"\n" +
	"waived_str\x18\v \x01(\tR\twaivedStr\x12Z\n" +
	"\vwaiver_data\x18\f \x01(\v29.chef.automate.domain.compliance.reporting.OrigWaiverDataR\n" +
	"waiverData\x12u\n" +
	"\x16removed_results_counts\x18\r \x01(\v2?.chef.automate.domain.compliance.reporting.RemovedResultsCountsR\x14removedResultsCounts\x1as\n" +
	"\x0fStringTagsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12J\n" +
	"\x05value\x18\x02 \x01(\v24.chef.automate.domain.compliance.reporting.TagValuesR\x05value:\x028\x01\"\xbe\x01\n" +
	...
	"\x06passed\x18\x03 \x01(\x05R\x06passed\"#\n" +
	"\tTagValues\x12\x16\n" +
	"\x06values\x18\x01 \x03(\tR\x06values\"l\n" +
	"\tAttribute\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12K\n" +
	"\aoptions\x18\x02 \x01(\v21.chef.automate.domain.compliance.reporting.OptionR\aoptions\"L\n" +
	"\bPlatform\x12\x12\n" +
	...
	"\afilters\x18\x04 \x03(\v25.chef.automate.domain.compliance.reporting.ListFilterR\afilters\x12\x19\n" +
	...
	"\vSuggestions\x12W\n" +
	"\vsuggestions\x18\x01 \x03(\v25.chef.automate.domain.compliance.reporting.SuggestionR\vsuggestions\"\xb2\x01\n" +
	"\vProfileMins\x12Q\n" +
	"\bprofiles\x18\x01 \x03(\v25.chef.automate.domain.compliance.reporting.ProfileMinR\bprofiles\x12P\n" +
	"\x06counts\x18\x02 \x01(\v28.chef.automate.domain.compliance.reporting.ProfileCountsR\x06counts\"\x87\x01\n" +
	...
	"\bplatform\x18\x03 \x01(\v23.chef.automate.domain.compliance.reporting.PlatformR\bplatform\x12 \n" +
	"\venvironment\x18\x04 \x01(\tR\venvironment\x12c\n" +
	"\rlatest_report\x18\b \x01(\v2>.chef.automate.domain.compliance.reporting.LatestReportSummaryR\flatestReport\x12A\n" +
	"\x04tags\x18\t \x03(\v2-.chef.automate.domain.compliance.reporting.KvR\x04tags\x12R\n" +
	"\bprofiles\x18\n" +
	" \x03(\v26.chef.automate.domain.compliance.reporting.ProfileMetaR\bprofiles\"\xf2\x01\n" +
	"\x05Nodes\x12E\n" +
	"\x05nodes\x18\x01 \x03(\v2/.chef.automate.domain.compliance.reporting.NodeR\x05nodes\x12\x14\n" +
	...
	"\bcontrols\x18\x04 \x01(\v29.chef.automate.domain.compliance.reporting.ControlSummaryR\bcontrols\"w\n" +
	...
	"\x10control_elements\x18\x01 \x03(\v29.chef.automate.domain.compliance.reporting.ControlElementR\x0fcontrolElements\"E\n" +
	"\x14CustomReportResponse\x12-\n" +
	"\x12acknowledgement_id\x18\x01 \x01(\tR\x11acknowledgementId\"y\n" +
	"\"ReportListForReportManagerResponse\x12S\n" +
	"\areports\x18\x01 \x03(\v29.chef.automate.domain.compliance.reporting.ReportResponseR\areports\"\x85\x01\n" +
	"\x0eReportResponse\x12\x1b\n" +
	"\treport_id\x18\x01 \x01(\tR\breportId\x12V\n" +
	"\bprofiles\x18\x02 \x03(\v2:.chef.automate.domain.compliance.reporting.ProfileResponseR\bprofiles\"L\n" +
	"\x0fProfileResponse\x12\x1d\n" +
	"\n" +
	"profile_id\x18\x01 \x01(\tR\tprofileId\x12\x1a\n" +
	"\bcontrols\x18\x02 \x03(\tR\bcontrols\"\xdf\x01\n" +
	"\fAssetSummary\x12!\n" +
	"\ftotal_assets\x18\x01 \x01(\x05R\vtotalAssets\x12R\n" +
	"\tcollected\x18\x02 \x01(\v24.chef.automate.domain.compliance.reporting.CollectedR\tcollected\x12X\n" +
	"\vuncollected\x18\x03 \x01(\v26.chef.automate.domain.compliance.reporting.UncollectedR\vuncollected\"m\n" +
	"\tCollected\x12\x16\n" +
	...
	"\blast_run\x18\x04 \x01(\tR\alastRun\"\xc0\x01\n" +
	"\x10AssetListRequest\x12O\n" +
	"\afilters\x18\x01 \x03(\v25.chef.automate.domain.compliance.reporting.ListFilterR\afilters\x12\x12\n" +
	...
	"\x06assets\x18\x01 \x03(\v21.chef.automate.domain.compliance.reporting.AssetsR\x06assets\"/\n" +
	...
	"\x15GetAssetConfigRequest2\x99\x15\n" +
	"\x10ReportingService\x12\x84\x01\n" +
	"\vListReports\x120.chef.automate.domain.compliance.reporting.Query\x1aA.chef.automate.domain.compliance.reporting.ReportsSummaryLevelOne\"\x00\x12y\n" +
	"\rListReportIds\x120.chef.automate.domain.compliance.reporting.Query\x1a4.chef.automate.domain.compliance.reporting.ReportIds\"\x00\x12s\n" +
	"\n" +
	"ReadReport\x120.chef.automate.domain.compliance.reporting.Query\x1a1.chef.automate.domain.compliance.reporting.Report\"\x00\x12\x89\x01\n" +
	"\x0fListSuggestions\x12<.chef.automate.domain.compliance.reporting.SuggestionRequest\x1a6.chef.automate.domain.compliance.reporting.Suggestions\"\x00\x12z\n" +
	"\fListProfiles\x120.chef.automate.domain.compliance.reporting.Query\x1a6.chef.automate.domain.compliance.reporting.ProfileMins\"\x00\x12u\n" +
	"\x06Export\x120.chef.automate.domain.compliance.reporting.Query\x1a5.chef.automate.domain.compliance.reporting.ExportData\"\x000\x01\x12y\n" +
	"\n" +
	"ExportNode\x120.chef.automate.domain.compliance.reporting.Query\x1a5.chef.automate.domain.compliance.reporting.ExportData\"\x000\x01\x12\x8a\x01\n" +
	"\x13ExportReportManager\x120.chef.automate.domain.compliance.reporting.Query\x1a?.chef.automate.domain.compliance.reporting.CustomReportResponse\"\x00\x12l\n" +
	"\bReadNode\x12-.chef.automate.domain.compliance.reporting.Id\x1a/.chef.automate.domain.compliance.reporting.Node\"\x00\x12q\n" +
	"\tListNodes\x120.chef.automate.domain.compliance.reporting.Query\x1a0.chef.automate.domain.compliance.reporting.Nodes\"\x00\x12\x8c\x01\n" +
	"\x10ListControlItems\x12=.chef.automate.domain.compliance.reporting.ControlItemRequest\x1a7.chef.automate.domain.compliance.reporting.ControlItems\"\x00\x12\x7f\n" +
	"\x0eReadNodeHeader\x120.chef.automate.domain.compliance.reporting.Query\x1a9.chef.automate.domain.compliance.reporting.NodeHeaderInfo\"\x00\x12\x81\x01\n" +
	"\x0fListControlInfo\x120.chef.automate.domain.compliance.reporting.Query\x1a:.chef.automate.domain.compliance.reporting.ControlElements\"\x00\x12\x97\x01\n" +
	"\x10GetReportContent\x12?.chef.automate.domain.compliance.reporting.ReportContentRequest\x1a@.chef.automate.domain.compliance.reporting.ReportContentResponse\"\x00\x12\x9d\x01\n" +
	"\x1dGetReportListForReportManager\x126.chef.automate.domain.compliance.reporting.ListFilters\x1a@.chef.automate.domain.compliance.reporting.ReportContentResponse\"\x000\x01\x12\x7f\n" +
	"\n" +
	"AssetCount\x126.chef.automate.domain.compliance.reporting.ListFilters\x1a7.chef.automate.domain.compliance.reporting.AssetSummary\"\x00\x12\x88\x01\n" +
	"\tListAsset\x12;.chef.automate.domain.compliance.reporting.AssetListRequest\x1a<.chef.automate.domain.compliance.reporting.AssetListResponse\"\x00\x12\x9b\x01\n" +
	"\x0eSetAssetConfig\x12B.chef.automate.domain.compliance.reporting.ComplianceConfigRequest\x1aC.chef.automate.domain.compliance.reporting.ComplianceConfigResponse\"\x00\x12\x99\x01\n" +
	"\x0eGetAssetConfig\x12@.chef.automate.domain.compliance.reporting.GetAssetConfigRequest\x1aC.chef.automate.domain.compliance.reporting.ComplianceConfigResponse\"\x00\x12\x91\x01\n" +
	"\x15ListControlItemsRange\x12=.chef.automate.domain.compliance.reporting.ControlItemRequest\x1a7.chef.automate.domain.compliance.reporting.ControlItems\"\x00B@Z>github.com/chef/automate/api/interservice/compliance/reportingb\x06proto3"

var (
	file_interservice_compliance_reporting_reporting_proto_rawDescOnce sync.Once
	file_interservice_compliance_reporting_reporting_proto_rawDescData []byte
)
...
func file_interservice_compliance_reporting_reporting_proto_rawDescGZIP() []byte {
	file_interservice_compliance_reporting_reporting_proto_rawDescOnce.Do(func() {
		file_interservice_compliance_reporting_reporting_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_interservice_compliance_reporting_reporting_proto_rawDesc), len(file_interservice_compliance_reporting_reporting_proto_rawDesc)))
	})
...
func file_interservice_compliance_reporting_reporting_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_interservice_compliance_reporting_reporting_proto_rawDesc), len(file_interservice_compliance_reporting_reporting_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   64,
			NumExtensions: 0,
			NumServices:   1,
